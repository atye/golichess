...
// checks if the TopUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TopUser{}

// TopUser struct for TopUser
type TopUser struct {
	Id string `json:"id"`
...
func (o *TopUser) GetPerfs() map[string]TopUserPerfsValue {
	if o == nil || IsNil(o.Perfs) {
		var ret map[string]TopUserPerfsValue
		return ret
	}
	return o.Perfs
}
...
func (o *TopUser) GetPerfsOk() (map[string]TopUserPerfsValue, bool) {
	if o == nil || IsNil(o.Perfs) {
		return map[string]TopUserPerfsValue{}, false
	}
	return o.Perfs, true
}
...
// SetPerfs gets a reference to the given map[string]TopUserPerfsValue and assigns it to the Perfs field.
...
func (o TopUser) MarshalJSON() ([]byte, error) {
...
func (o TopUser) ToMap() (map[string]interface{}, error) {
...
func (o *TopUser) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varTopUser)

	if err != nil {
		return err
	}

	*o = TopUser(varTopUser)

	return err
}

type NullableTopUser struct {
	value *TopUser
	isSet bool
}

func (v NullableTopUser) Get() *TopUser {
	return v.value
}

func (v *NullableTopUser) Set(val *TopUser) {
	v.value = val
	v.isSet = true
}

func (v NullableTopUser) IsSet() bool {
	return v.isSet
}

func (v *NullableTopUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTopUser(val *TopUser) *NullableTopUser {
	return &NullableTopUser{value: val, isSet: true}
}

func (v NullableTopUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTopUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
