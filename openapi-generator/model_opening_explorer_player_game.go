...
// checks if the OpeningExplorerPlayerGame type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerPlayerGame{}

// OpeningExplorerPlayerGame struct for OpeningExplorerPlayerGame
...
type _OpeningExplorerPlayerGame OpeningExplorerPlayerGame
...
func NewOpeningExplorerPlayerGame(id string, winner NullableGameColor, speed Speed, mode string, white OpeningExplorerGamePlayer, black OpeningExplorerGamePlayer, year int32, month string) *OpeningExplorerPlayerGame {
	this := OpeningExplorerPlayerGame{}
	this.Id = id
	this.Winner = winner
	this.Speed = speed
	this.Mode = mode
...
func (o OpeningExplorerPlayerGame) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerPlayerGame) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerPlayerGame) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerPlayerGame := _OpeningExplorerPlayerGame{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerPlayerGame)

	if err != nil {
		return err
	}

	*o = OpeningExplorerPlayerGame(varOpeningExplorerPlayerGame)

	return err
}

type NullableOpeningExplorerPlayerGame struct {
	value *OpeningExplorerPlayerGame
	isSet bool
}

func (v NullableOpeningExplorerPlayerGame) Get() *OpeningExplorerPlayerGame {
	return v.value
}

func (v *NullableOpeningExplorerPlayerGame) Set(val *OpeningExplorerPlayerGame) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerPlayerGame) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerPlayerGame) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerPlayerGame(val *OpeningExplorerPlayerGame) *NullableOpeningExplorerPlayerGame {
	return &NullableOpeningExplorerPlayerGame{value: val, isSet: true}
}

func (v NullableOpeningExplorerPlayerGame) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerPlayerGame) UnmarshalJSON(src []byte) error {
	v.isSet = true
