...
// checks if the TeamUpdatesPager type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamUpdatesPager{}

// TeamUpdatesPager struct for TeamUpdatesPager
...
type _TeamUpdatesPager TeamUpdatesPager
...
func (o TeamUpdatesPager) MarshalJSON() ([]byte, error) {
...
func (o TeamUpdatesPager) ToMap() (map[string]interface{}, error) {
...
func (o *TeamUpdatesPager) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamUpdatesPager := _TeamUpdatesPager{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTeamUpdatesPager)

	if err != nil {
		return err
	}

	*o = TeamUpdatesPager(varTeamUpdatesPager)

	return err
}

type NullableTeamUpdatesPager struct {
	value *TeamUpdatesPager
	isSet bool
}

func (v NullableTeamUpdatesPager) Get() *TeamUpdatesPager {
	return v.value
}

func (v *NullableTeamUpdatesPager) Set(val *TeamUpdatesPager) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamUpdatesPager) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamUpdatesPager) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamUpdatesPager(val *TeamUpdatesPager) *NullableTeamUpdatesPager {
	return &NullableTeamUpdatesPager{value: val, isSet: true}
}

func (v NullableTeamUpdatesPager) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamUpdatesPager) UnmarshalJSON(src []byte) error {
	v.isSet = true
