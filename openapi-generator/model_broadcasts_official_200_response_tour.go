...
// checks if the BroadcastsOfficial200ResponseTour type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastsOfficial200ResponseTour{}

// BroadcastsOfficial200ResponseTour struct for BroadcastsOfficial200ResponseTour
type BroadcastsOfficial200ResponseTour struct {
	Id string `json:"id"`
	...
	Info *BroadcastsOfficial200ResponseTourInfo `json:"info,omitempty"`
	...
	Url string `json:"url"`
	CommunityOwner *ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId `json:"communityOwner,omitempty"`
}

type _BroadcastsOfficial200ResponseTour BroadcastsOfficial200ResponseTour
...
func NewBroadcastsOfficial200ResponseTour(id string, name string, slug string, createdAt int32, url string) *BroadcastsOfficial200ResponseTour {
	this := BroadcastsOfficial200ResponseTour{}
	this.Id = id
	this.Name = name
	this.Slug = slug
...
func (o *BroadcastsOfficial200ResponseTour) GetInfo() BroadcastsOfficial200ResponseTourInfo {
	if o == nil || IsNil(o.Info) {
		var ret BroadcastsOfficial200ResponseTourInfo
		return ret
	}
	return *o.Info
}
...
// SetInfo gets a reference to the given BroadcastsOfficial200ResponseTourInfo and assigns it to the Info field.
...
// SetCommunityOwner gets a reference to the given ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId and assigns it to the CommunityOwner field.
func (o *BroadcastsOfficial200ResponseTour) SetCommunityOwner(v ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId) {
	o.CommunityOwner = &v
}

func (o BroadcastsOfficial200ResponseTour) MarshalJSON() ([]byte, error) {
...
func (o BroadcastsOfficial200ResponseTour) ToMap() (map[string]interface{}, error) {
...
func (o *BroadcastsOfficial200ResponseTour) UnmarshalJSON(data []byte) (err error) {
	...
	varBroadcastsOfficial200ResponseTour := _BroadcastsOfficial200ResponseTour{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBroadcastsOfficial200ResponseTour)

	if err != nil {
		return err
	}

	*o = BroadcastsOfficial200ResponseTour(varBroadcastsOfficial200ResponseTour)

	return err
}

type NullableBroadcastsOfficial200ResponseTour struct {
	value *BroadcastsOfficial200ResponseTour
	isSet bool
}

func (v NullableBroadcastsOfficial200ResponseTour) Get() *BroadcastsOfficial200ResponseTour {
	return v.value
}

func (v *NullableBroadcastsOfficial200ResponseTour) Set(val *BroadcastsOfficial200ResponseTour) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastsOfficial200ResponseTour) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastsOfficial200ResponseTour) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastsOfficial200ResponseTour(val *BroadcastsOfficial200ResponseTour) *NullableBroadcastsOfficial200ResponseTour {
	return &NullableBroadcastsOfficial200ResponseTour{value: val, isSet: true}
}

func (v NullableBroadcastsOfficial200ResponseTour) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastsOfficial200ResponseTour) UnmarshalJSON(src []byte) error {
	v.isSet = true
