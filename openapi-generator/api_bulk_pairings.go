...
Canceling a bulk pairing does not refund the rate limit cost of that bulk pairing.
	...
	*/
	...
	//  @return BulkPairingList200Response
	BulkPairingListExecute(r BulkPairingsAPIBulkPairingListRequest) (*BulkPairingList200Response, *http.Response, error)
...
func (r BulkPairingsAPIBulkPairingListRequest) Execute() (*BulkPairingList200Response, *http.Response, error) {
...
// Execute executes the request
//  @return BulkPairingList200Response
func (a *BulkPairingsAPIService) BulkPairingListExecute(r BulkPairingsAPIBulkPairingListRequest) (*BulkPairingList200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BulkPairingList200Response
	)
