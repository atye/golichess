...
// checks if the ApiExternalEngineAnalyseRequestWorkOneOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiExternalEngineAnalyseRequestWorkOneOf2{}

// ApiExternalEngineAnalyseRequestWorkOneOf2 struct for ApiExternalEngineAnalyseRequestWorkOneOf2
type ApiExternalEngineAnalyseRequestWorkOneOf2 struct {
...
type _ApiExternalEngineAnalyseRequestWorkOneOf2 ApiExternalEngineAnalyseRequestWorkOneOf2
...
func NewApiExternalEngineAnalyseRequestWorkOneOf2(nodes int32, sessionId string, threads int32, hash int32, multiPv int32, variant string, initialFen string, moves []string) *ApiExternalEngineAnalyseRequestWorkOneOf2 {
	this := ApiExternalEngineAnalyseRequestWorkOneOf2{}
	this.Nodes = nodes
...
func (o ApiExternalEngineAnalyseRequestWorkOneOf2) MarshalJSON() ([]byte, error) {
...
func (o ApiExternalEngineAnalyseRequestWorkOneOf2) ToMap() (map[string]interface{}, error) {
...
func (o *ApiExternalEngineAnalyseRequestWorkOneOf2) UnmarshalJSON(data []byte) (err error) {
	...
	varApiExternalEngineAnalyseRequestWorkOneOf2 := _ApiExternalEngineAnalyseRequestWorkOneOf2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiExternalEngineAnalyseRequestWorkOneOf2)

	if err != nil {
		return err
	}

	*o = ApiExternalEngineAnalyseRequestWorkOneOf2(varApiExternalEngineAnalyseRequestWorkOneOf2)

	return err
}

type NullableApiExternalEngineAnalyseRequestWorkOneOf2 struct {
	value *ApiExternalEngineAnalyseRequestWorkOneOf2
	isSet bool
}

func (v NullableApiExternalEngineAnalyseRequestWorkOneOf2) Get() *ApiExternalEngineAnalyseRequestWorkOneOf2 {
	return v.value
}

func (v *NullableApiExternalEngineAnalyseRequestWorkOneOf2) Set(val *ApiExternalEngineAnalyseRequestWorkOneOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableApiExternalEngineAnalyseRequestWorkOneOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableApiExternalEngineAnalyseRequestWorkOneOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiExternalEngineAnalyseRequestWorkOneOf2(val *ApiExternalEngineAnalyseRequestWorkOneOf2) *NullableApiExternalEngineAnalyseRequestWorkOneOf2 {
	return &NullableApiExternalEngineAnalyseRequestWorkOneOf2{value: val, isSet: true}
}

func (v NullableApiExternalEngineAnalyseRequestWorkOneOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiExternalEngineAnalyseRequestWorkOneOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
