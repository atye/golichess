...
// checks if the TeamUpdateMsg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamUpdateMsg{}

// TeamUpdateMsg struct for TeamUpdateMsg
...
type _TeamUpdateMsg TeamUpdateMsg
...
// SetTeam gets a reference to the given LightTeam and assigns it to the Team field.
...
func (o TeamUpdateMsg) MarshalJSON() ([]byte, error) {
...
func (o TeamUpdateMsg) ToMap() (map[string]interface{}, error) {
...
func (o *TeamUpdateMsg) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamUpdateMsg := _TeamUpdateMsg{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTeamUpdateMsg)

	if err != nil {
		return err
	}

	*o = TeamUpdateMsg(varTeamUpdateMsg)

	return err
}

type NullableTeamUpdateMsg struct {
	value *TeamUpdateMsg
	isSet bool
}

func (v NullableTeamUpdateMsg) Get() *TeamUpdateMsg {
	return v.value
}

func (v *NullableTeamUpdateMsg) Set(val *TeamUpdateMsg) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamUpdateMsg) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamUpdateMsg) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamUpdateMsg(val *TeamUpdateMsg) *NullableTeamUpdateMsg {
	return &NullableTeamUpdateMsg{value: val, isSet: true}
}

func (v NullableTeamUpdateMsg) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamUpdateMsg) UnmarshalJSON(src []byte) error {
	v.isSet = true
