...
// checks if the PuzzleRaceResults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PuzzleRaceResults{}

// PuzzleRaceResults struct for PuzzleRaceResults
type PuzzleRaceResults struct {
	...
	Players []PuzzleRaceResultsPlayersInner `json:"players"`
	// List of puzzles in the race
	Puzzles []PuzzleRaceResultsPuzzlesInner `json:"puzzles"`
...
type _PuzzleRaceResults PuzzleRaceResults
...
func (o *PuzzleRaceResults) GetPlayers() []PuzzleRaceResultsPlayersInner {
	if o == nil {
		var ret []PuzzleRaceResultsPlayersInner
		return ret
	}
...
func (o *PuzzleRaceResults) GetPuzzles() []PuzzleRaceResultsPuzzlesInner {
	if o == nil {
		var ret []PuzzleRaceResultsPuzzlesInner
		return ret
	}
...
func (o PuzzleRaceResults) MarshalJSON() ([]byte, error) {
...
func (o PuzzleRaceResults) ToMap() (map[string]interface{}, error) {
...
func (o *PuzzleRaceResults) UnmarshalJSON(data []byte) (err error) {
	...
	varPuzzleRaceResults := _PuzzleRaceResults{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPuzzleRaceResults)

	if err != nil {
		return err
	}

	*o = PuzzleRaceResults(varPuzzleRaceResults)

	return err
}

type NullablePuzzleRaceResults struct {
	value *PuzzleRaceResults
	isSet bool
}

func (v NullablePuzzleRaceResults) Get() *PuzzleRaceResults {
	return v.value
}

func (v *NullablePuzzleRaceResults) Set(val *PuzzleRaceResults) {
	v.value = val
	v.isSet = true
}

func (v NullablePuzzleRaceResults) IsSet() bool {
	return v.isSet
}

func (v *NullablePuzzleRaceResults) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePuzzleRaceResults(val *PuzzleRaceResults) *NullablePuzzleRaceResults {
	return &NullablePuzzleRaceResults{value: val, isSet: true}
}

func (v NullablePuzzleRaceResults) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePuzzleRaceResults) UnmarshalJSON(src []byte) error {
	v.isSet = true
