...
// checks if the ApiSimul200ResponsePendingInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiSimul200ResponsePendingInner{}

// ApiSimul200ResponsePendingInner struct for ApiSimul200ResponsePendingInner
type ApiSimul200ResponsePendingInner struct {
	Id string `json:"id"`
	Host ApiSimul200ResponsePendingInnerHost `json:"host"`
	Name string `json:"name"`
	FullName string `json:"fullName"`
	Variants []ApiSimul200ResponsePendingInnerVariantsInner `json:"variants"`
...
type _ApiSimul200ResponsePendingInner ApiSimul200ResponsePendingInner
...
func NewApiSimul200ResponsePendingInner(id string, host ApiSimul200ResponsePendingInnerHost, name string, fullName string, variants []ApiSimul200ResponsePendingInnerVariantsInner, isCreated bool, isFinished bool, isRunning bool, nbApplicants int32, nbPairings int32) *ApiSimul200ResponsePendingInner {
	this := ApiSimul200ResponsePendingInner{}
	this.Id = id
	this.Host = host
	this.Name = name
...
func (o *ApiSimul200ResponsePendingInner) GetHost() ApiSimul200ResponsePendingInnerHost {
	if o == nil {
		var ret ApiSimul200ResponsePendingInnerHost
		return ret
	}
...
func (o *ApiSimul200ResponsePendingInner) GetVariants() []ApiSimul200ResponsePendingInnerVariantsInner {
	if o == nil {
		var ret []ApiSimul200ResponsePendingInnerVariantsInner
		return ret
	}
...
func (o ApiSimul200ResponsePendingInner) MarshalJSON() ([]byte, error) {
...
func (o ApiSimul200ResponsePendingInner) ToMap() (map[string]interface{}, error) {
...
func (o *ApiSimul200ResponsePendingInner) UnmarshalJSON(data []byte) (err error) {
	...
	varApiSimul200ResponsePendingInner := _ApiSimul200ResponsePendingInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiSimul200ResponsePendingInner)

	if err != nil {
		return err
	}

	*o = ApiSimul200ResponsePendingInner(varApiSimul200ResponsePendingInner)

	return err
}

type NullableApiSimul200ResponsePendingInner struct {
	value *ApiSimul200ResponsePendingInner
	isSet bool
}

func (v NullableApiSimul200ResponsePendingInner) Get() *ApiSimul200ResponsePendingInner {
	return v.value
}

func (v *NullableApiSimul200ResponsePendingInner) Set(val *ApiSimul200ResponsePendingInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiSimul200ResponsePendingInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiSimul200ResponsePendingInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiSimul200ResponsePendingInner(val *ApiSimul200ResponsePendingInner) *NullableApiSimul200ResponsePendingInner {
	return &NullableApiSimul200ResponsePendingInner{value: val, isSet: true}
}

func (v NullableApiSimul200ResponsePendingInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiSimul200ResponsePendingInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
