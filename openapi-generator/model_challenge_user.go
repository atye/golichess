...
// checks if the ChallengeUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChallengeUser{}
...
type _ChallengeUser ChallengeUser
...
func (o ChallengeUser) ToMap() (map[string]interface{}, error) {
...
func (o *ChallengeUser) UnmarshalJSON(data []byte) (err error) {
	...
	varChallengeUser := _ChallengeUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChallengeUser)

	if err != nil {
		return err
	}

	*o = ChallengeUser(varChallengeUser)
