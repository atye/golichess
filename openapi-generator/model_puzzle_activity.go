...
// checks if the PuzzleActivity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PuzzleActivity{}

// PuzzleActivity struct for PuzzleActivity
...
type _PuzzleActivity PuzzleActivity
...
func (o PuzzleActivity) MarshalJSON() ([]byte, error) {
...
func (o PuzzleActivity) ToMap() (map[string]interface{}, error) {
...
func (o *PuzzleActivity) UnmarshalJSON(data []byte) (err error) {
	...
	varPuzzleActivity := _PuzzleActivity{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPuzzleActivity)

	if err != nil {
		return err
	}

	*o = PuzzleActivity(varPuzzleActivity)

	return err
}

type NullablePuzzleActivity struct {
	value *PuzzleActivity
	isSet bool
}

func (v NullablePuzzleActivity) Get() *PuzzleActivity {
	return v.value
}

func (v *NullablePuzzleActivity) Set(val *PuzzleActivity) {
	v.value = val
	v.isSet = true
}

func (v NullablePuzzleActivity) IsSet() bool {
	return v.isSet
}

func (v *NullablePuzzleActivity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePuzzleActivity(val *PuzzleActivity) *NullablePuzzleActivity {
	return &NullablePuzzleActivity{value: val, isSet: true}
}

func (v NullablePuzzleActivity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePuzzleActivity) UnmarshalJSON(src []byte) error {
	v.isSet = true
