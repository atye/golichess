...
// checks if the BroadcastPhotosValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastPhotosValue{}

// BroadcastPhotosValue struct for BroadcastPhotosValue
...
type _BroadcastPhotosValue BroadcastPhotosValue
...
func (o BroadcastPhotosValue) MarshalJSON() ([]byte, error) {
...
func (o BroadcastPhotosValue) ToMap() (map[string]interface{}, error) {
...
func (o *BroadcastPhotosValue) UnmarshalJSON(data []byte) (err error) {
	...
	varBroadcastPhotosValue := _BroadcastPhotosValue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBroadcastPhotosValue)

	if err != nil {
		return err
	}

	*o = BroadcastPhotosValue(varBroadcastPhotosValue)

	return err
}

type NullableBroadcastPhotosValue struct {
	value *BroadcastPhotosValue
	isSet bool
}

func (v NullableBroadcastPhotosValue) Get() *BroadcastPhotosValue {
	return v.value
}

func (v *NullableBroadcastPhotosValue) Set(val *BroadcastPhotosValue) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastPhotosValue) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastPhotosValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastPhotosValue(val *BroadcastPhotosValue) *NullableBroadcastPhotosValue {
	return &NullableBroadcastPhotosValue{value: val, isSet: true}
}

func (v NullableBroadcastPhotosValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastPhotosValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
