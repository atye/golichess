...
Teams that hide their player list are only included if you also belong to the team.
	...
	*/
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return TeamsAPITeamUpdatesRequest
	*/
	TeamUpdates(ctx context.Context) TeamsAPITeamUpdatesRequest

	// TeamUpdatesExecute executes the request
	//  @return TeamUpdates
	TeamUpdatesExecute(r TeamsAPITeamUpdatesRequest) (*TeamUpdates, *http.Response, error)
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param teamId
	@return TeamsAPITeamUpdatesByTeamIdRequest
	*/
	TeamUpdatesByTeamId(ctx context.Context, teamId string) TeamsAPITeamUpdatesByTeamIdRequest

	// TeamUpdatesByTeamIdExecute executes the request
	//  @return TeamUpdatesOfTeam
	TeamUpdatesByTeamIdExecute(r TeamsAPITeamUpdatesByTeamIdRequest) (*TeamUpdatesOfTeam, *http.Response, error)
}
...
type TeamsAPITeamUpdatesRequest struct {
	ctx context.Context
	ApiService TeamsAPI
	page *int32
}

func (r TeamsAPITeamUpdatesRequest) Page(page int32) TeamsAPITeamUpdatesRequest {
	r.page = &page
	return r
}

func (r TeamsAPITeamUpdatesRequest) Execute() (*TeamUpdates, *http.Response, error) {
	return r.ApiService.TeamUpdatesExecute(r)
}
...
Paginator of the most recent updates posted by team leaders of teams you have joined.
 ...
 @return TeamsAPITeamUpdatesRequest
*/
func (a *TeamsAPIService) TeamUpdates(ctx context.Context) TeamsAPITeamUpdatesRequest {
	return TeamsAPITeamUpdatesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return TeamUpdates
func (a *TeamsAPIService) TeamUpdatesExecute(r TeamsAPITeamUpdatesRequest) (*TeamUpdates, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TeamUpdates
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsAPIService.TeamUpdates")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/team/updates"
...
type TeamsAPITeamUpdatesByTeamIdRequest struct {
	ctx context.Context
	ApiService TeamsAPI
	teamId string
	page *int32
...
func (r TeamsAPITeamUpdatesByTeamIdRequest) Page(page int32) TeamsAPITeamUpdatesByTeamIdRequest {
	r.page = &page
	return r
}

func (r TeamsAPITeamUpdatesByTeamIdRequest) Execute() (*TeamUpdatesOfTeam, *http.Response, error) {
	return r.ApiService.TeamUpdatesByTeamIdExecute(r)
}
...
Paginator of the most recent updates posted by team leaders of a team you have joined.
 ...
 @return TeamsAPITeamUpdatesByTeamIdRequest
*/
func (a *TeamsAPIService) TeamUpdatesByTeamId(ctx context.Context, teamId string) TeamsAPITeamUpdatesByTeamIdRequest {
	return TeamsAPITeamUpdatesByTeamIdRequest{
		ApiService: a,
		ctx: ctx,
		teamId: teamId,
...
// Execute executes the request
//  @return TeamUpdatesOfTeam
func (a *TeamsAPIService) TeamUpdatesByTeamIdExecute(r TeamsAPITeamUpdatesByTeamIdRequest) (*TeamUpdatesOfTeam, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TeamUpdatesOfTeam
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsAPIService.TeamUpdatesByTeamId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/team/updates/{teamId}"
	localVarPath = strings.Replace(localVarPath, "{"+"teamId"+"}", url.PathEscape(parameterValueToString(r.teamId, "teamId")), -1)
