...
// checks if the FidePlayerSearch200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FidePlayerSearch200ResponseInner{}

// FidePlayerSearch200ResponseInner struct for FidePlayerSearch200ResponseInner
type FidePlayerSearch200ResponseInner struct {
	Id int32 `json:"id"`
...
type _FidePlayerSearch200ResponseInner FidePlayerSearch200ResponseInner
...
func NewFidePlayerSearch200ResponseInner(id int32, name string, federation string) *FidePlayerSearch200ResponseInner {
	this := FidePlayerSearch200ResponseInner{}
	this.Id = id
	this.Name = name
...
func (o *FidePlayerSearch200ResponseInner) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o FidePlayerSearch200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o FidePlayerSearch200ResponseInner) ToMap() (map[string]interface{}, error) {
...
func (o *FidePlayerSearch200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	varFidePlayerSearch200ResponseInner := _FidePlayerSearch200ResponseInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFidePlayerSearch200ResponseInner)

	if err != nil {
		return err
	}

	*o = FidePlayerSearch200ResponseInner(varFidePlayerSearch200ResponseInner)

	return err
}

type NullableFidePlayerSearch200ResponseInner struct {
	value *FidePlayerSearch200ResponseInner
	isSet bool
}

func (v NullableFidePlayerSearch200ResponseInner) Get() *FidePlayerSearch200ResponseInner {
	return v.value
}

func (v *NullableFidePlayerSearch200ResponseInner) Set(val *FidePlayerSearch200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFidePlayerSearch200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFidePlayerSearch200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFidePlayerSearch200ResponseInner(val *FidePlayerSearch200ResponseInner) *NullableFidePlayerSearch200ResponseInner {
	return &NullableFidePlayerSearch200ResponseInner{value: val, isSet: true}
}

func (v NullableFidePlayerSearch200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFidePlayerSearch200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
