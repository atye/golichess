...
// checks if the BroadcastsTop200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastsTop200Response{}

// BroadcastsTop200Response struct for BroadcastsTop200Response
type BroadcastsTop200Response struct {
	Active []BroadcastsTop200ResponseActiveInner `json:"active,omitempty"`
	// Deprecated
	Upcoming []BroadcastsTop200ResponseActiveInner `json:"upcoming,omitempty"`
	Past *BroadcastsTop200ResponsePast `json:"past,omitempty"`
}
...
// SetActive gets a reference to the given []BroadcastsTop200ResponseActiveInner and assigns it to the Active field.
...
// SetUpcoming gets a reference to the given []BroadcastsTop200ResponseActiveInner and assigns it to the Upcoming field.
// Deprecated
...
func (o *BroadcastsTop200Response) GetPast() BroadcastsTop200ResponsePast {
	if o == nil || IsNil(o.Past) {
		var ret BroadcastsTop200ResponsePast
		return ret
	}
	return *o.Past
}
...
// SetPast gets a reference to the given BroadcastsTop200ResponsePast and assigns it to the Past field.
func (o *BroadcastsTop200Response) SetPast(v BroadcastsTop200ResponsePast) {
	o.Past = &v
}

func (o BroadcastsTop200Response) MarshalJSON() ([]byte, error) {
...
func (o BroadcastsTop200Response) ToMap() (map[string]interface{}, error) {
...
type NullableBroadcastsTop200Response struct {
	value *BroadcastsTop200Response
	isSet bool
}

func (v NullableBroadcastsTop200Response) Get() *BroadcastsTop200Response {
	return v.value
}

func (v *NullableBroadcastsTop200Response) Set(val *BroadcastsTop200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastsTop200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastsTop200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastsTop200Response(val *BroadcastsTop200Response) *NullableBroadcastsTop200Response {
	return &NullableBroadcastsTop200Response{value: val, isSet: true}
}

func (v NullableBroadcastsTop200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastsTop200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
