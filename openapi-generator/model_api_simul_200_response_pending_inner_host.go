...
// checks if the ApiSimul200ResponsePendingInnerHost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiSimul200ResponsePendingInnerHost{}

// ApiSimul200ResponsePendingInnerHost struct for ApiSimul200ResponsePendingInnerHost
type ApiSimul200ResponsePendingInnerHost struct {
	Id string `json:"id"`
...
type _ApiSimul200ResponsePendingInnerHost ApiSimul200ResponsePendingInnerHost
...
func NewApiSimul200ResponsePendingInnerHost(id string, name string) *ApiSimul200ResponsePendingInnerHost {
	this := ApiSimul200ResponsePendingInnerHost{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o ApiSimul200ResponsePendingInnerHost) MarshalJSON() ([]byte, error) {
...
func (o ApiSimul200ResponsePendingInnerHost) ToMap() (map[string]interface{}, error) {
...
func (o *ApiSimul200ResponsePendingInnerHost) UnmarshalJSON(data []byte) (err error) {
	...
	varApiSimul200ResponsePendingInnerHost := _ApiSimul200ResponsePendingInnerHost{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiSimul200ResponsePendingInnerHost)

	if err != nil {
		return err
	}

	*o = ApiSimul200ResponsePendingInnerHost(varApiSimul200ResponsePendingInnerHost)

	return err
}

type NullableApiSimul200ResponsePendingInnerHost struct {
	value *ApiSimul200ResponsePendingInnerHost
	isSet bool
}

func (v NullableApiSimul200ResponsePendingInnerHost) Get() *ApiSimul200ResponsePendingInnerHost {
	return v.value
}

func (v *NullableApiSimul200ResponsePendingInnerHost) Set(val *ApiSimul200ResponsePendingInnerHost) {
	v.value = val
	v.isSet = true
}

func (v NullableApiSimul200ResponsePendingInnerHost) IsSet() bool {
	return v.isSet
}

func (v *NullableApiSimul200ResponsePendingInnerHost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiSimul200ResponsePendingInnerHost(val *ApiSimul200ResponsePendingInnerHost) *NullableApiSimul200ResponsePendingInnerHost {
	return &NullableApiSimul200ResponsePendingInnerHost{value: val, isSet: true}
}

func (v NullableApiSimul200ResponsePendingInnerHost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiSimul200ResponsePendingInnerHost) UnmarshalJSON(src []byte) error {
	v.isSet = true
