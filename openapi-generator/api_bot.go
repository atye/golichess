...
the `title` field should be set to `BOT`.
	...
	*/
	...
	BotGameChatGetExecute(r BotAPIBotGameChatGetRequest) ([]SpectatorGameChatLinesInner, *http.Response, error)
...
func (r BotAPIBotGameChatGetRequest) Execute() ([]SpectatorGameChatLinesInner, *http.Response, error) {
...
// Execute executes the request
//  @return []SpectatorGameChatLinesInner
func (a *BotAPIService) BotGameChatGetExecute(r BotAPIBotGameChatGetRequest) ([]SpectatorGameChatLinesInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
