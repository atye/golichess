...
// checks if the Clock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Clock{}
...
func (o Clock) ToMap() (map[string]interface{}, error) {
...
func (o *Clock) UnmarshalJSON(data []byte) (err error) {
