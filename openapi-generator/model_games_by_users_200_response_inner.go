...
// checks if the GamesByUsers200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GamesByUsers200ResponseInner{}

// GamesByUsers200ResponseInner struct for GamesByUsers200ResponseInner
type GamesByUsers200ResponseInner struct {
	Id string `json:"id"`
...
type _GamesByUsers200ResponseInner GamesByUsers200ResponseInner
...
func NewGamesByUsers200ResponseInner(id string) *GamesByUsers200ResponseInner {
	this := GamesByUsers200ResponseInner{}
	this.Id = id
...
func (o *GamesByUsers200ResponseInner) SetWinnerNil() {
	o.Winner.Set(nil)
}
...
func (o GamesByUsers200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o GamesByUsers200ResponseInner) ToMap() (map[string]interface{}, error) {
...
func (o *GamesByUsers200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGamesByUsers200ResponseInner := _GamesByUsers200ResponseInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGamesByUsers200ResponseInner)

	if err != nil {
		return err
	}

	*o = GamesByUsers200ResponseInner(varGamesByUsers200ResponseInner)

	return err
}

type NullableGamesByUsers200ResponseInner struct {
	value *GamesByUsers200ResponseInner
	isSet bool
}

func (v NullableGamesByUsers200ResponseInner) Get() *GamesByUsers200ResponseInner {
	return v.value
}

func (v *NullableGamesByUsers200ResponseInner) Set(val *GamesByUsers200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGamesByUsers200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGamesByUsers200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGamesByUsers200ResponseInner(val *GamesByUsers200ResponseInner) *NullableGamesByUsers200ResponseInner {
	return &NullableGamesByUsers200ResponseInner{value: val, isSet: true}
}

func (v NullableGamesByUsers200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGamesByUsers200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
