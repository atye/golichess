...
// checks if the ApiExternalEngineAcquire200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiExternalEngineAcquire200Response{}
...
func (o ApiExternalEngineAcquire200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ApiExternalEngineAcquire200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varApiExternalEngineAcquire200Response := _ApiExternalEngineAcquire200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiExternalEngineAcquire200Response)

	if err != nil {
		return err
	}

	*o = ApiExternalEngineAcquire200Response(varApiExternalEngineAcquire200Response)
