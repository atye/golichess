...
// SetFrom gets a reference to the given LightUser and assigns it to the From field.
...
// SetTo gets a reference to the given LightUser and assigns it to the To field.
...
func (o UserNote) ToMap() (map[string]interface{}, error) {
...
type NullableUserNote struct {
	value *UserNote
	isSet bool
}

func (v NullableUserNote) Get() *UserNote {
	return v.value
}

func (v *NullableUserNote) Set(val *UserNote) {
	v.value = val
	v.isSet = true
}

func (v NullableUserNote) IsSet() bool {
	return v.isSet
}

func (v *NullableUserNote) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserNote(val *UserNote) *NullableUserNote {
	return &NullableUserNote{value: val, isSet: true}
}

func (v NullableUserNote) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserNote) UnmarshalJSON(src []byte) error {
	v.isSet = true
