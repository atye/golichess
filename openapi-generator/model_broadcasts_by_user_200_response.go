...
// checks if the BroadcastsByUser200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastsByUser200Response{}

// BroadcastsByUser200Response struct for BroadcastsByUser200Response
...
type _BroadcastsByUser200Response BroadcastsByUser200Response
...
func (o BroadcastsByUser200Response) MarshalJSON() ([]byte, error) {
...
func (o BroadcastsByUser200Response) ToMap() (map[string]interface{}, error) {
...
func (o *BroadcastsByUser200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varBroadcastsByUser200Response := _BroadcastsByUser200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBroadcastsByUser200Response)

	if err != nil {
		return err
	}

	*o = BroadcastsByUser200Response(varBroadcastsByUser200Response)

	return err
}

type NullableBroadcastsByUser200Response struct {
	value *BroadcastsByUser200Response
	isSet bool
}

func (v NullableBroadcastsByUser200Response) Get() *BroadcastsByUser200Response {
	return v.value
}

func (v *NullableBroadcastsByUser200Response) Set(val *BroadcastsByUser200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastsByUser200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastsByUser200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastsByUser200Response(val *BroadcastsByUser200Response) *NullableBroadcastsByUser200Response {
	return &NullableBroadcastsByUser200Response{value: val, isSet: true}
}

func (v NullableBroadcastsByUser200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastsByUser200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
