...
// checks if the OpeningExplorerMastersTopGamesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerMastersTopGamesInner{}

// OpeningExplorerMastersTopGamesInner struct for OpeningExplorerMastersTopGamesInner
type OpeningExplorerMastersTopGamesInner struct {
	Id string `json:"id"`
...
type _OpeningExplorerMastersTopGamesInner OpeningExplorerMastersTopGamesInner
...
func NewOpeningExplorerMastersTopGamesInner(id string, winner GameColor, white OpeningExplorerGamePlayer, black OpeningExplorerGamePlayer, year int32, uci string) *OpeningExplorerMastersTopGamesInner {
	this := OpeningExplorerMastersTopGamesInner{}
	this.Id = id
	this.Winner = winner
	this.White = white
	this.Black = black
...
func (o OpeningExplorerMastersTopGamesInner) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerMastersTopGamesInner) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerMastersTopGamesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerMastersTopGamesInner := _OpeningExplorerMastersTopGamesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerMastersTopGamesInner)

	if err != nil {
		return err
	}

	*o = OpeningExplorerMastersTopGamesInner(varOpeningExplorerMastersTopGamesInner)

	return err
}

type NullableOpeningExplorerMastersTopGamesInner struct {
	value *OpeningExplorerMastersTopGamesInner
	isSet bool
}

func (v NullableOpeningExplorerMastersTopGamesInner) Get() *OpeningExplorerMastersTopGamesInner {
	return v.value
}

func (v *NullableOpeningExplorerMastersTopGamesInner) Set(val *OpeningExplorerMastersTopGamesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerMastersTopGamesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerMastersTopGamesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerMastersTopGamesInner(val *OpeningExplorerMastersTopGamesInner) *NullableOpeningExplorerMastersTopGamesInner {
	return &NullableOpeningExplorerMastersTopGamesInner{value: val, isSet: true}
}

func (v NullableOpeningExplorerMastersTopGamesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerMastersTopGamesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
