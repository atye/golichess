...
// checks if the ApiExternalEngineAnalyseRequestWorkOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiExternalEngineAnalyseRequestWorkOneOf{}

// ApiExternalEngineAnalyseRequestWorkOneOf struct for ApiExternalEngineAnalyseRequestWorkOneOf
type ApiExternalEngineAnalyseRequestWorkOneOf struct {
	// Amount of time to analyse the position, in milliseconds.
	Movetime int32 `json:"movetime"`
...
type _ApiExternalEngineAnalyseRequestWorkOneOf ApiExternalEngineAnalyseRequestWorkOneOf
...
func NewApiExternalEngineAnalyseRequestWorkOneOf(movetime int32, sessionId string, threads int32, hash int32, multiPv int32, variant string, initialFen string, moves []string) *ApiExternalEngineAnalyseRequestWorkOneOf {
	this := ApiExternalEngineAnalyseRequestWorkOneOf{}
...
func NewApiExternalEngineAnalyseRequestWorkOneOfWithDefaults() *ApiExternalEngineAnalyseRequestWorkOneOf {
	this := ApiExternalEngineAnalyseRequestWorkOneOf{}
	var variant string = "chess"
	this.Variant = variant
	return &this
}

// GetMovetime returns the Movetime field value
...
// GetMovetimeOk returns a tuple with the Movetime field value
...
func (o ApiExternalEngineAnalyseRequestWorkOneOf) MarshalJSON() ([]byte, error) {
...
func (o ApiExternalEngineAnalyseRequestWorkOneOf) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["movetime"] = o.Movetime
...
func (o *ApiExternalEngineAnalyseRequestWorkOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varApiExternalEngineAnalyseRequestWorkOneOf := _ApiExternalEngineAnalyseRequestWorkOneOf{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiExternalEngineAnalyseRequestWorkOneOf)

	if err != nil {
		return err
	}

	*o = ApiExternalEngineAnalyseRequestWorkOneOf(varApiExternalEngineAnalyseRequestWorkOneOf)

	return err
}

type NullableApiExternalEngineAnalyseRequestWorkOneOf struct {
	value *ApiExternalEngineAnalyseRequestWorkOneOf
	isSet bool
}

func (v NullableApiExternalEngineAnalyseRequestWorkOneOf) Get() *ApiExternalEngineAnalyseRequestWorkOneOf {
	return v.value
}

func (v *NullableApiExternalEngineAnalyseRequestWorkOneOf) Set(val *ApiExternalEngineAnalyseRequestWorkOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApiExternalEngineAnalyseRequestWorkOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApiExternalEngineAnalyseRequestWorkOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiExternalEngineAnalyseRequestWorkOneOf(val *ApiExternalEngineAnalyseRequestWorkOneOf) *NullableApiExternalEngineAnalyseRequestWorkOneOf {
	return &NullableApiExternalEngineAnalyseRequestWorkOneOf{value: val, isSet: true}
}

func (v NullableApiExternalEngineAnalyseRequestWorkOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiExternalEngineAnalyseRequestWorkOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
