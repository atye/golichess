...
// checks if the PerfStat type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PerfStat{}

// PerfStat struct for PerfStat
...
func (o PerfStat) MarshalJSON() ([]byte, error) {
...
func (o PerfStat) ToMap() (map[string]interface{}, error) {
...
func (o *PerfStat) UnmarshalJSON(data []byte) (err error) {
	...
	varPerfStat := _PerfStat{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPerfStat)

	if err != nil {
		return err
	}

	*o = PerfStat(varPerfStat)

	return err
}

type NullablePerfStat struct {
	value *PerfStat
	isSet bool
}

func (v NullablePerfStat) Get() *PerfStat {
	return v.value
}

func (v *NullablePerfStat) Set(val *PerfStat) {
	v.value = val
	v.isSet = true
}

func (v NullablePerfStat) IsSet() bool {
	return v.isSet
}

func (v *NullablePerfStat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePerfStat(val *PerfStat) *NullablePerfStat {
	return &NullablePerfStat{value: val, isSet: true}
}

func (v NullablePerfStat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePerfStat) UnmarshalJSON(src []byte) error {
	v.isSet = true
