...
// checks if the TeamUpdatesOfTeam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamUpdatesOfTeam{}

// TeamUpdatesOfTeam struct for TeamUpdatesOfTeam
type TeamUpdatesOfTeam struct {
	Team LightTeam `json:"team"`
	Subscribed bool `json:"subscribed"`
	Updates TeamUpdatesPager `json:"updates"`
	ByTeam []TeamUpdatesByTeamInner `json:"byTeam"`
}

type _TeamUpdatesOfTeam TeamUpdatesOfTeam
...
// GetByTeam returns the ByTeam field value
func (o *TeamUpdatesOfTeam) GetByTeam() []TeamUpdatesByTeamInner {
	if o == nil {
		var ret []TeamUpdatesByTeamInner
		return ret
	}
...
// GetByTeamOk returns a tuple with the ByTeam field value
// and a boolean to check if the value has been set.
func (o *TeamUpdatesOfTeam) GetByTeamOk() ([]TeamUpdatesByTeamInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.ByTeam, true
}

// SetByTeam sets field value
func (o *TeamUpdatesOfTeam) SetByTeam(v []TeamUpdatesByTeamInner) {
	o.ByTeam = v
}

func (o TeamUpdatesOfTeam) MarshalJSON() ([]byte, error) {
...
func (o TeamUpdatesOfTeam) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["team"] = o.Team
	toSerialize["subscribed"] = o.Subscribed
	toSerialize["updates"] = o.Updates
	toSerialize["byTeam"] = o.ByTeam
	return toSerialize, nil
}

func (o *TeamUpdatesOfTeam) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamUpdatesOfTeam := _TeamUpdatesOfTeam{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTeamUpdatesOfTeam)

	if err != nil {
		return err
	}

	*o = TeamUpdatesOfTeam(varTeamUpdatesOfTeam)

	return err
}

type NullableTeamUpdatesOfTeam struct {
	value *TeamUpdatesOfTeam
	isSet bool
}

func (v NullableTeamUpdatesOfTeam) Get() *TeamUpdatesOfTeam {
	return v.value
}

func (v *NullableTeamUpdatesOfTeam) Set(val *TeamUpdatesOfTeam) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamUpdatesOfTeam) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamUpdatesOfTeam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamUpdatesOfTeam(val *TeamUpdatesOfTeam) *NullableTeamUpdatesOfTeam {
	return &NullableTeamUpdatesOfTeam{value: val, isSet: true}
}

func (v NullableTeamUpdatesOfTeam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamUpdatesOfTeam) UnmarshalJSON(src []byte) error {
	v.isSet = true
