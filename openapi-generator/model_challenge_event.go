...
// checks if the ChallengeEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChallengeEvent{}
...
type _ChallengeEvent ChallengeEvent
...
func (o ChallengeEvent) ToMap() (map[string]interface{}, error) {
...
func (o *ChallengeEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varChallengeEvent := _ChallengeEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChallengeEvent)

	if err != nil {
		return err
	}

	*o = ChallengeEvent(varChallengeEvent)
