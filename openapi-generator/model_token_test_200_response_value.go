...
// checks if the TokenTest200ResponseValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenTest200ResponseValue{}
...
func NewTokenTest200ResponseValue() *TokenTest200ResponseValue {
	this := TokenTest200ResponseValue{}
	return &this
}
...
func (o *TokenTest200ResponseValue) SetExpiresNil() {
	o.Expires.Set(nil)
}
...
func (o TokenTest200ResponseValue) MarshalJSON() ([]byte, error) {
...
func (o TokenTest200ResponseValue) ToMap() (map[string]interface{}, error) {
