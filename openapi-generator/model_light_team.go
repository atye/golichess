...
// checks if the LightTeam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LightTeam{}

// LightTeam struct for LightTeam
...
func (o LightTeam) MarshalJSON() ([]byte, error) {
...
func (o LightTeam) ToMap() (map[string]interface{}, error) {
...
func (o *LightTeam) UnmarshalJSON(data []byte) (err error) {
	...
	varLightTeam := _LightTeam{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLightTeam)

	if err != nil {
		return err
	}

	*o = LightTeam(varLightTeam)

	return err
}

type NullableLightTeam struct {
	value *LightTeam
	isSet bool
}

func (v NullableLightTeam) Get() *LightTeam {
	return v.value
}

func (v *NullableLightTeam) Set(val *LightTeam) {
	v.value = val
	v.isSet = true
}

func (v NullableLightTeam) IsSet() bool {
	return v.isSet
}

func (v *NullableLightTeam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLightTeam(val *LightTeam) *NullableLightTeam {
	return &NullableLightTeam{value: val, isSet: true}
}

func (v NullableLightTeam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLightTeam) UnmarshalJSON(src []byte) error {
	v.isSet = true
