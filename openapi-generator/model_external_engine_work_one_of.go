...
// checks if the ExternalEngineWorkOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalEngineWorkOneOf{}

// ExternalEngineWorkOneOf struct for ExternalEngineWorkOneOf
type ExternalEngineWorkOneOf struct {
...
type _ExternalEngineWorkOneOf ExternalEngineWorkOneOf
...
func (o ExternalEngineWorkOneOf) MarshalJSON() ([]byte, error) {
...
func (o ExternalEngineWorkOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *ExternalEngineWorkOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varExternalEngineWorkOneOf := _ExternalEngineWorkOneOf{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExternalEngineWorkOneOf)

	if err != nil {
		return err
	}

	*o = ExternalEngineWorkOneOf(varExternalEngineWorkOneOf)

	return err
}

type NullableExternalEngineWorkOneOf struct {
	value *ExternalEngineWorkOneOf
	isSet bool
}

func (v NullableExternalEngineWorkOneOf) Get() *ExternalEngineWorkOneOf {
	return v.value
}

func (v *NullableExternalEngineWorkOneOf) Set(val *ExternalEngineWorkOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalEngineWorkOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalEngineWorkOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalEngineWorkOneOf(val *ExternalEngineWorkOneOf) *NullableExternalEngineWorkOneOf {
	return &NullableExternalEngineWorkOneOf{value: val, isSet: true}
}

func (v NullableExternalEngineWorkOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalEngineWorkOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
