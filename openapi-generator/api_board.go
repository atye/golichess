...
Games can also have a public spectator chat.
	...
	*/
	...
	//  @return []SpectatorGameChatLinesInner
	BoardGameChatGetExecute(r BoardAPIBoardGameChatGetRequest) ([]SpectatorGameChatLinesInner, *http.Response, error)
...
func (r BoardAPIBoardGameChatGetRequest) Execute() ([]SpectatorGameChatLinesInner, *http.Response, error) {
...
// Execute executes the request
//  @return []SpectatorGameChatLinesInner
func (a *BoardAPIService) BoardGameChatGetExecute(r BoardAPIBoardGameChatGetRequest) ([]SpectatorGameChatLinesInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []SpectatorGameChatLinesInner
	)
