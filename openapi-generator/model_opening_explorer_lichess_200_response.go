...
// checks if the OpeningExplorerLichess200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerLichess200Response{}

// OpeningExplorerLichess200Response struct for OpeningExplorerLichess200Response
type OpeningExplorerLichess200Response struct {
	Opening NullableOpeningExplorerMaster200ResponseOpening `json:"opening"`
	White int32 `json:"white"`
	Draws int32 `json:"draws"`
	Black int32 `json:"black"`
	Moves []OpeningExplorerLichess200ResponseMovesInner `json:"moves"`
	TopGames []OpeningExplorerLichess200ResponseTopGamesInner `json:"topGames"`
	RecentGames []OpeningExplorerLichess200ResponseTopGamesInner `json:"recentGames,omitempty"`
	History []OpeningExplorerLichess200ResponseHistoryInner `json:"history,omitempty"`
}

type _OpeningExplorerLichess200Response OpeningExplorerLichess200Response
...
func NewOpeningExplorerLichess200Response(opening NullableOpeningExplorerMaster200ResponseOpening, white int32, draws int32, black int32, moves []OpeningExplorerLichess200ResponseMovesInner, topGames []OpeningExplorerLichess200ResponseTopGamesInner) *OpeningExplorerLichess200Response {
	this := OpeningExplorerLichess200Response{}
...
func (o *OpeningExplorerLichess200Response) GetMoves() []OpeningExplorerLichess200ResponseMovesInner {
	if o == nil {
		var ret []OpeningExplorerLichess200ResponseMovesInner
		return ret
	}
...
func (o *OpeningExplorerLichess200Response) GetTopGames() []OpeningExplorerLichess200ResponseTopGamesInner {
	if o == nil {
		var ret []OpeningExplorerLichess200ResponseTopGamesInner
		return ret
	}
...
// GetRecentGames returns the RecentGames field value if set, zero value otherwise.
func (o *OpeningExplorerLichess200Response) GetRecentGames() []OpeningExplorerLichess200ResponseTopGamesInner {
	if o == nil || IsNil(o.RecentGames) {
		var ret []OpeningExplorerLichess200ResponseTopGamesInner
		return ret
	}
...
// GetRecentGamesOk returns a tuple with the RecentGames field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetRecentGames gets a reference to the given []OpeningExplorerLichess200ResponseTopGamesInner and assigns it to the RecentGames field.
...
func (o *OpeningExplorerLichess200Response) GetHistory() []OpeningExplorerLichess200ResponseHistoryInner {
	if o == nil || IsNil(o.History) {
		var ret []OpeningExplorerLichess200ResponseHistoryInner
		return ret
	}
	return o.History
}
...
// SetHistory gets a reference to the given []OpeningExplorerLichess200ResponseHistoryInner and assigns it to the History field.
func (o *OpeningExplorerLichess200Response) SetHistory(v []OpeningExplorerLichess200ResponseHistoryInner) {
	o.History = v
}

func (o OpeningExplorerLichess200Response) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerLichess200Response) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerLichess200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerLichess200Response := _OpeningExplorerLichess200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerLichess200Response)

	if err != nil {
		return err
	}

	*o = OpeningExplorerLichess200Response(varOpeningExplorerLichess200Response)

	return err
}

type NullableOpeningExplorerLichess200Response struct {
	value *OpeningExplorerLichess200Response
	isSet bool
}

func (v NullableOpeningExplorerLichess200Response) Get() *OpeningExplorerLichess200Response {
	return v.value
}

func (v *NullableOpeningExplorerLichess200Response) Set(val *OpeningExplorerLichess200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerLichess200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerLichess200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerLichess200Response(val *OpeningExplorerLichess200Response) *NullableOpeningExplorerLichess200Response {
	return &NullableOpeningExplorerLichess200Response{value: val, isSet: true}
}

func (v NullableOpeningExplorerLichess200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerLichess200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
