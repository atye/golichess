...
// checks if the GameJsonDivision type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameJsonDivision{}

// GameJsonDivision struct for GameJsonDivision
...
func (o GameJsonDivision) MarshalJSON() ([]byte, error) {
...
func (o GameJsonDivision) ToMap() (map[string]interface{}, error) {
...
type NullableGameJsonDivision struct {
	value *GameJsonDivision
	isSet bool
}

func (v NullableGameJsonDivision) Get() *GameJsonDivision {
	return v.value
}

func (v *NullableGameJsonDivision) Set(val *GameJsonDivision) {
	v.value = val
	v.isSet = true
}

func (v NullableGameJsonDivision) IsSet() bool {
	return v.isSet
}

func (v *NullableGameJsonDivision) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGameJsonDivision(val *GameJsonDivision) *NullableGameJsonDivision {
	return &NullableGameJsonDivision{value: val, isSet: true}
}

func (v NullableGameJsonDivision) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGameJsonDivision) UnmarshalJSON(src []byte) error {
	v.isSet = true
