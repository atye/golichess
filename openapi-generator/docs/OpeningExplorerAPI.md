...
> OpeningExplorerLichess200Response OpeningExplorerLichess(ctx).Variant(variant).Fen(fen).Play(play).Speeds(speeds).Ratings(ratings).Since(since).Until(until).Moves(moves).TopGames(topGames).RecentGames(recentGames).History(history).Execute()
...
func main() {
	...
	speeds := []string{"Speeds_example"} // []string | Comma separated list of game speeds to filter by (optional)
	...
	// response from `OpeningExplorerLichess`: OpeningExplorerLichess200Response
 ...
 **speeds** | **[]string** | Comma separated list of game speeds to filter by | 
...
[**OpeningExplorerLichess200Response**](OpeningExplorerLichess200Response.md)
...
> OpeningExplorerMaster200Response OpeningExplorerMaster(ctx).Fen(fen).Play(play).Since(since).Until(until).Moves(moves).TopGames(topGames).Execute()
...
func main() {
	...
	// response from `OpeningExplorerMaster`: OpeningExplorerMaster200Response
...
[**OpeningExplorerMaster200Response**](OpeningExplorerMaster200Response.md)
...
> OpeningExplorerPlayer200Response OpeningExplorerPlayer(ctx).Player(player).Color(color).Variant(variant).Fen(fen).Play(play).Speeds(speeds).Modes(modes).Since(since).Until(until).Moves(moves).RecentGames(recentGames).Execute()
...
func main() {
	...
	speeds := []string{"Speeds_example"} // []string | Comma separated list of game speeds to look for (optional)
	...
	// response from `OpeningExplorerPlayer`: OpeningExplorerPlayer200Response
 ...
 **fen** | **string** | X-FEN of the root position | 
 **play** | **string** | Comma separated sequence of legal moves in UCI notation. Play additional moves starting from &#x60;fen&#x60;. Required to find an opening name, if &#x60;fen&#x60; is not an exact match for a named position.  | [default to &quot;&quot;]
 **speeds** | **[]string** | Comma separated list of game speeds to look for | 
...
[**OpeningExplorerPlayer200Response**](OpeningExplorerPlayer200Response.md)
