...
`func (o *Correspondence) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *Correspondence) GetTypeOk() (*string, bool)`
...
`func (o *Correspondence) SetType(v string)`
...
`func (o *Correspondence) GetDaysPerTurn() int32`

GetDaysPerTurn returns the DaysPerTurn field if non-nil, zero value otherwise.

### GetDaysPerTurnOk

`func (o *Correspondence) GetDaysPerTurnOk() (*int32, bool)`
...
`func (o *Correspondence) SetDaysPerTurn(v int32)`

SetDaysPerTurn sets DaysPerTurn field to given value.

### HasDaysPerTurn

`func (o *Correspondence) HasDaysPerTurn() bool`
