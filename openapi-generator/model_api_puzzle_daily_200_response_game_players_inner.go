...
// checks if the ApiPuzzleDaily200ResponseGamePlayersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiPuzzleDaily200ResponseGamePlayersInner{}

// ApiPuzzleDaily200ResponseGamePlayersInner struct for ApiPuzzleDaily200ResponseGamePlayersInner
type ApiPuzzleDaily200ResponseGamePlayersInner struct {
...
type _ApiPuzzleDaily200ResponseGamePlayersInner ApiPuzzleDaily200ResponseGamePlayersInner
...
func NewApiPuzzleDaily200ResponseGamePlayersInner(color NullableString, id string, name string, rating int32) *ApiPuzzleDaily200ResponseGamePlayersInner {
	this := ApiPuzzleDaily200ResponseGamePlayersInner{}
	this.Color = color
	this.Id = id
	this.Name = name
	this.Rating = rating
...
func (o *ApiPuzzleDaily200ResponseGamePlayersInner) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o ApiPuzzleDaily200ResponseGamePlayersInner) MarshalJSON() ([]byte, error) {
...
func (o ApiPuzzleDaily200ResponseGamePlayersInner) ToMap() (map[string]interface{}, error) {
...
func (o *ApiPuzzleDaily200ResponseGamePlayersInner) UnmarshalJSON(data []byte) (err error) {
	...
	varApiPuzzleDaily200ResponseGamePlayersInner := _ApiPuzzleDaily200ResponseGamePlayersInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiPuzzleDaily200ResponseGamePlayersInner)

	if err != nil {
		return err
	}

	*o = ApiPuzzleDaily200ResponseGamePlayersInner(varApiPuzzleDaily200ResponseGamePlayersInner)

	return err
}

type NullableApiPuzzleDaily200ResponseGamePlayersInner struct {
	value *ApiPuzzleDaily200ResponseGamePlayersInner
	isSet bool
}

func (v NullableApiPuzzleDaily200ResponseGamePlayersInner) Get() *ApiPuzzleDaily200ResponseGamePlayersInner {
	return v.value
}

func (v *NullableApiPuzzleDaily200ResponseGamePlayersInner) Set(val *ApiPuzzleDaily200ResponseGamePlayersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiPuzzleDaily200ResponseGamePlayersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiPuzzleDaily200ResponseGamePlayersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiPuzzleDaily200ResponseGamePlayersInner(val *ApiPuzzleDaily200ResponseGamePlayersInner) *NullableApiPuzzleDaily200ResponseGamePlayersInner {
	return &NullableApiPuzzleDaily200ResponseGamePlayersInner{value: val, isSet: true}
}

func (v NullableApiPuzzleDaily200ResponseGamePlayersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiPuzzleDaily200ResponseGamePlayersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
