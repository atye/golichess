...
// checks if the ApiExternalEngineAnalyseRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiExternalEngineAnalyseRequest{}
...
func (o ApiExternalEngineAnalyseRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ApiExternalEngineAnalyseRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varApiExternalEngineAnalyseRequest := _ApiExternalEngineAnalyseRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiExternalEngineAnalyseRequest)

	if err != nil {
		return err
	}

	*o = ApiExternalEngineAnalyseRequest(varApiExternalEngineAnalyseRequest)
