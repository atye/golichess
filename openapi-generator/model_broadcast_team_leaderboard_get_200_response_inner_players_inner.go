...
// checks if the BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner{}

// BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner struct for BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner
type BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner struct {
	...
	RatingDiffs *BroadcastPlayersGet200ResponseInnerAllOfRatingDiffs `json:"ratingDiffs,omitempty"`
	RatingsMap *BroadcastPlayersGet200ResponseInnerAllOfRatingsMap `json:"ratingsMap,omitempty"`
	Performances *BroadcastPlayersGet200ResponseInnerAllOfPerformances `json:"performances,omitempty"`
	Tiebreaks []BroadcastPlayersGet200ResponseInnerAllOfTiebreaksInner `json:"tiebreaks,omitempty"`
	Rank *int32 `json:"rank,omitempty"`
}

type _BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner
...
func NewBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner(name string) *BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner {
	this := BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner{}
	this.Name = name
	return &this
}
...
func (o *BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) GetRatingDiffs() BroadcastPlayersGet200ResponseInnerAllOfRatingDiffs {
	if o == nil || IsNil(o.RatingDiffs) {
		var ret BroadcastPlayersGet200ResponseInnerAllOfRatingDiffs
		return ret
	}
...
// SetRatingDiffs gets a reference to the given BroadcastPlayersGet200ResponseInnerAllOfRatingDiffs and assigns it to the RatingDiffs field.
...
func (o *BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) GetRatingsMap() BroadcastPlayersGet200ResponseInnerAllOfRatingsMap {
	if o == nil || IsNil(o.RatingsMap) {
		var ret BroadcastPlayersGet200ResponseInnerAllOfRatingsMap
		return ret
	}
	return *o.RatingsMap
}
...
// SetRatingsMap gets a reference to the given BroadcastPlayersGet200ResponseInnerAllOfRatingsMap and assigns it to the RatingsMap field.
...
func (o *BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) GetPerformances() BroadcastPlayersGet200ResponseInnerAllOfPerformances {
	if o == nil || IsNil(o.Performances) {
		var ret BroadcastPlayersGet200ResponseInnerAllOfPerformances
		return ret
	}
...
// SetPerformances gets a reference to the given BroadcastPlayersGet200ResponseInnerAllOfPerformances and assigns it to the Performances field.
...
func (o *BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) GetTiebreaks() []BroadcastPlayersGet200ResponseInnerAllOfTiebreaksInner {
	if o == nil || IsNil(o.Tiebreaks) {
		var ret []BroadcastPlayersGet200ResponseInnerAllOfTiebreaksInner
		return ret
	}
	return o.Tiebreaks
}
...
// SetTiebreaks gets a reference to the given []BroadcastPlayersGet200ResponseInnerAllOfTiebreaksInner and assigns it to the Tiebreaks field.
...
func (o BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) MarshalJSON() ([]byte, error) {
...
func (o BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) ToMap() (map[string]interface{}, error) {
...
func (o *BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) UnmarshalJSON(data []byte) (err error) {
	...
	varBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner := _BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner)

	if err != nil {
		return err
	}

	*o = BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner(varBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner)

	return err
}

type NullableBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner struct {
	value *BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner
	isSet bool
}

func (v NullableBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) Get() *BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner {
	return v.value
}

func (v *NullableBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) Set(val *BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner(val *BroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) *NullableBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner {
	return &NullableBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner{value: val, isSet: true}
}

func (v NullableBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastTeamLeaderboardGet200ResponseInnerPlayersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
