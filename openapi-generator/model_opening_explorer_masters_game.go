...
// checks if the OpeningExplorerMastersGame type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerMastersGame{}

// OpeningExplorerMastersGame struct for OpeningExplorerMastersGame
...
type _OpeningExplorerMastersGame OpeningExplorerMastersGame
...
func NewOpeningExplorerMastersGame(id string, winner NullableGameColor, white OpeningExplorerGamePlayer, black OpeningExplorerGamePlayer, year int32) *OpeningExplorerMastersGame {
	this := OpeningExplorerMastersGame{}
	this.Id = id
	this.Winner = winner
	this.White = white
	this.Black = black
...
func (o OpeningExplorerMastersGame) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerMastersGame) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerMastersGame) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerMastersGame := _OpeningExplorerMastersGame{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerMastersGame)

	if err != nil {
		return err
	}

	*o = OpeningExplorerMastersGame(varOpeningExplorerMastersGame)

	return err
}

type NullableOpeningExplorerMastersGame struct {
	value *OpeningExplorerMastersGame
	isSet bool
}

func (v NullableOpeningExplorerMastersGame) Get() *OpeningExplorerMastersGame {
	return v.value
}

func (v *NullableOpeningExplorerMastersGame) Set(val *OpeningExplorerMastersGame) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerMastersGame) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerMastersGame) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerMastersGame(val *OpeningExplorerMastersGame) *NullableOpeningExplorerMastersGame {
	return &NullableOpeningExplorerMastersGame{value: val, isSet: true}
}

func (v NullableOpeningExplorerMastersGame) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerMastersGame) UnmarshalJSON(src []byte) error {
	v.isSet = true
