...
// checks if the TablebaseJson type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TablebaseJson{}
...
type _TablebaseJson TablebaseJson
...
func (o *TablebaseJson) SetDtzNil() {
	o.Dtz.Set(nil)
}
...
func (o *TablebaseJson) SetPreciseDtzNil() {
...
func (o *TablebaseJson) SetDtcNil() {
	o.Dtc.Set(nil)
}
...
func (o *TablebaseJson) SetDtmNil() {
	o.Dtm.Set(nil)
}
...
func (o *TablebaseJson) SetDtwNil() {
	o.Dtw.Set(nil)
}
...
func (o TablebaseJson) ToMap() (map[string]interface{}, error) {
...
func (o *TablebaseJson) UnmarshalJSON(data []byte) (err error) {
	...
	varTablebaseJson := _TablebaseJson{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTablebaseJson)

	if err != nil {
		return err
	}

	*o = TablebaseJson(varTablebaseJson)
