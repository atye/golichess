...
// checks if the GamePlayerUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GamePlayerUser{}

// GamePlayerUser struct for GamePlayerUser
...
type _GamePlayerUser GamePlayerUser
...
func (o *GamePlayerUser) GetAnalysis() GamePlayerUserAnalysis {
	if o == nil || IsNil(o.Analysis) {
		var ret GamePlayerUserAnalysis
		return ret
	}
	return *o.Analysis
}
...
// SetAnalysis gets a reference to the given GamePlayerUserAnalysis and assigns it to the Analysis field.
...
// SetBerserk gets a reference to the given bool and assigns it to the Berserk field.
func (o *GamePlayerUser) SetBerserk(v bool) {
	o.Berserk = &v
}

func (o GamePlayerUser) MarshalJSON() ([]byte, error) {
...
func (o GamePlayerUser) ToMap() (map[string]interface{}, error) {
...
func (o *GamePlayerUser) UnmarshalJSON(data []byte) (err error) {
	...
	varGamePlayerUser := _GamePlayerUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGamePlayerUser)

	if err != nil {
		return err
	}

	*o = GamePlayerUser(varGamePlayerUser)

	return err
}

type NullableGamePlayerUser struct {
	value *GamePlayerUser
	isSet bool
}

func (v NullableGamePlayerUser) Get() *GamePlayerUser {
	return v.value
}

func (v *NullableGamePlayerUser) Set(val *GamePlayerUser) {
	v.value = val
	v.isSet = true
}

func (v NullableGamePlayerUser) IsSet() bool {
	return v.isSet
}

func (v *NullableGamePlayerUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGamePlayerUser(val *GamePlayerUser) *NullableGamePlayerUser {
	return &NullableGamePlayerUser{value: val, isSet: true}
}

func (v NullableGamePlayerUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGamePlayerUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
