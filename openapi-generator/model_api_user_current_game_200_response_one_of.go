...
// checks if the ApiUserCurrentGame200ResponseOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiUserCurrentGame200ResponseOneOf{}

// ApiUserCurrentGame200ResponseOneOf struct for ApiUserCurrentGame200ResponseOneOf
type ApiUserCurrentGame200ResponseOneOf struct {
	Id string `json:"id"`
	...
	Players ApiUserCurrentGame200ResponseOneOfPlayers `json:"players"`
	InitialFen *string `json:"initialFen,omitempty"`
	Winner *string `json:"winner,omitempty"`
	Opening *GamePgn200ResponseOneOfOpening `json:"opening,omitempty"`
	Moves *string `json:"moves,omitempty"`
	Pgn *string `json:"pgn,omitempty"`
	DaysPerTurn *int32 `json:"daysPerTurn,omitempty"`
	Analysis []GamePgn200ResponseOneOfAnalysisInner `json:"analysis,omitempty"`
	Tournament *string `json:"tournament,omitempty"`
	Swiss *string `json:"swiss,omitempty"`
	Clock *GamePgn200ResponseOneOfClock `json:"clock,omitempty"`
	Clocks []int32 `json:"clocks,omitempty"`
	Division *GamePgn200ResponseOneOfDivision `json:"division,omitempty"`
}

type _ApiUserCurrentGame200ResponseOneOf ApiUserCurrentGame200ResponseOneOf
...
func NewApiUserCurrentGame200ResponseOneOf(id string, rated bool, variant string, speed string, perf string, createdAt int64, lastMoveAt int64, status string, players ApiUserCurrentGame200ResponseOneOfPlayers) *ApiUserCurrentGame200ResponseOneOf {
	this := ApiUserCurrentGame200ResponseOneOf{}
	this.Id = id
	this.Rated = rated
...
func (o *ApiUserCurrentGame200ResponseOneOf) GetPlayers() ApiUserCurrentGame200ResponseOneOfPlayers {
	if o == nil {
		var ret ApiUserCurrentGame200ResponseOneOfPlayers
		return ret
	}
...
func (o *ApiUserCurrentGame200ResponseOneOf) GetOpening() GamePgn200ResponseOneOfOpening {
	if o == nil || IsNil(o.Opening) {
		var ret GamePgn200ResponseOneOfOpening
		return ret
	}
	return *o.Opening
}
...
// SetOpening gets a reference to the given GamePgn200ResponseOneOfOpening and assigns it to the Opening field.
...
func (o *ApiUserCurrentGame200ResponseOneOf) GetAnalysis() []GamePgn200ResponseOneOfAnalysisInner {
	if o == nil || IsNil(o.Analysis) {
		var ret []GamePgn200ResponseOneOfAnalysisInner
		return ret
	}
	return o.Analysis
}
...
// SetAnalysis gets a reference to the given []GamePgn200ResponseOneOfAnalysisInner and assigns it to the Analysis field.
...
// GetSwiss returns the Swiss field value if set, zero value otherwise.
func (o *ApiUserCurrentGame200ResponseOneOf) GetSwiss() string {
	if o == nil || IsNil(o.Swiss) {
		var ret string
		return ret
	}
	return *o.Swiss
...
// SetSwiss gets a reference to the given string and assigns it to the Swiss field.
...
func (o *ApiUserCurrentGame200ResponseOneOf) GetClock() GamePgn200ResponseOneOfClock {
	if o == nil || IsNil(o.Clock) {
		var ret GamePgn200ResponseOneOfClock
		return ret
	}
	return *o.Clock
}
...
// SetClock gets a reference to the given GamePgn200ResponseOneOfClock and assigns it to the Clock field.
...
func (o *ApiUserCurrentGame200ResponseOneOf) GetDivision() GamePgn200ResponseOneOfDivision {
	if o == nil || IsNil(o.Division) {
		var ret GamePgn200ResponseOneOfDivision
		return ret
	}
	return *o.Division
}
...
// SetDivision gets a reference to the given GamePgn200ResponseOneOfDivision and assigns it to the Division field.
func (o *ApiUserCurrentGame200ResponseOneOf) SetDivision(v GamePgn200ResponseOneOfDivision) {
	o.Division = &v
}

func (o ApiUserCurrentGame200ResponseOneOf) MarshalJSON() ([]byte, error) {
...
func (o ApiUserCurrentGame200ResponseOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *ApiUserCurrentGame200ResponseOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varApiUserCurrentGame200ResponseOneOf := _ApiUserCurrentGame200ResponseOneOf{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiUserCurrentGame200ResponseOneOf)

	if err != nil {
		return err
	}

	*o = ApiUserCurrentGame200ResponseOneOf(varApiUserCurrentGame200ResponseOneOf)

	return err
}

type NullableApiUserCurrentGame200ResponseOneOf struct {
	value *ApiUserCurrentGame200ResponseOneOf
	isSet bool
}

func (v NullableApiUserCurrentGame200ResponseOneOf) Get() *ApiUserCurrentGame200ResponseOneOf {
	return v.value
}

func (v *NullableApiUserCurrentGame200ResponseOneOf) Set(val *ApiUserCurrentGame200ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApiUserCurrentGame200ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApiUserCurrentGame200ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiUserCurrentGame200ResponseOneOf(val *ApiUserCurrentGame200ResponseOneOf) *NullableApiUserCurrentGame200ResponseOneOf {
	return &NullableApiUserCurrentGame200ResponseOneOf{value: val, isSet: true}
}

func (v NullableApiUserCurrentGame200ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiUserCurrentGame200ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
