...
// checks if the ExternalEngineWorkOneOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalEngineWorkOneOf2{}

// ExternalEngineWorkOneOf2 struct for ExternalEngineWorkOneOf2
type ExternalEngineWorkOneOf2 struct {
...
type _ExternalEngineWorkOneOf2 ExternalEngineWorkOneOf2
...
func (o ExternalEngineWorkOneOf2) MarshalJSON() ([]byte, error) {
...
func (o ExternalEngineWorkOneOf2) ToMap() (map[string]interface{}, error) {
...
func (o *ExternalEngineWorkOneOf2) UnmarshalJSON(data []byte) (err error) {
	...
	varExternalEngineWorkOneOf2 := _ExternalEngineWorkOneOf2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExternalEngineWorkOneOf2)

	if err != nil {
		return err
	}

	*o = ExternalEngineWorkOneOf2(varExternalEngineWorkOneOf2)

	return err
}

type NullableExternalEngineWorkOneOf2 struct {
	value *ExternalEngineWorkOneOf2
	isSet bool
}

func (v NullableExternalEngineWorkOneOf2) Get() *ExternalEngineWorkOneOf2 {
	return v.value
}

func (v *NullableExternalEngineWorkOneOf2) Set(val *ExternalEngineWorkOneOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalEngineWorkOneOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalEngineWorkOneOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalEngineWorkOneOf2(val *ExternalEngineWorkOneOf2) *NullableExternalEngineWorkOneOf2 {
	return &NullableExternalEngineWorkOneOf2{value: val, isSet: true}
}

func (v NullableExternalEngineWorkOneOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalEngineWorkOneOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
