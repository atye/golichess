...
// checks if the ApiStreamEvent200ResponseOneOf2Challenge type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiStreamEvent200ResponseOneOf2Challenge{}

// ApiStreamEvent200ResponseOneOf2Challenge struct for ApiStreamEvent200ResponseOneOf2Challenge
type ApiStreamEvent200ResponseOneOf2Challenge struct {
	Id string `json:"id"`
	Url string `json:"url"`
	Status string `json:"status"`
	Challenger ApiStreamEvent200ResponseOneOf2ChallengeChallenger `json:"challenger"`
	...
	FinalColor NullableString `json:"finalColor,omitempty"`
...
type _ApiStreamEvent200ResponseOneOf2Challenge ApiStreamEvent200ResponseOneOf2Challenge
...
func NewApiStreamEvent200ResponseOneOf2Challenge(id string, url string, status string, challenger ApiStreamEvent200ResponseOneOf2ChallengeChallenger, destUser NullableApiStreamEvent200ResponseOneOf2ChallengeDestUser, variant ApiAccountPlaying200ResponseNowPlayingInnerVariant, rated bool, speed string, timeControl ApiStreamEvent200ResponseOneOf2ChallengeTimeControl, color string, perf ApiStreamEvent200ResponseOneOf2ChallengePerf) *ApiStreamEvent200ResponseOneOf2Challenge {
	this := ApiStreamEvent200ResponseOneOf2Challenge{}
	this.Id = id
	this.Url = url
	this.Status = status
...
func (o *ApiStreamEvent200ResponseOneOf2Challenge) GetChallenger() ApiStreamEvent200ResponseOneOf2ChallengeChallenger {
	if o == nil {
		var ret ApiStreamEvent200ResponseOneOf2ChallengeChallenger
		return ret
	}
...
// GetFinalColor returns the FinalColor field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ApiStreamEvent200ResponseOneOf2Challenge) GetFinalColor() string {
	if o == nil || IsNil(o.FinalColor.Get()) {
		var ret string
		return ret
	}
	return *o.FinalColor.Get()
}
...
func (o *ApiStreamEvent200ResponseOneOf2Challenge) GetFinalColorOk() (*string, bool) {
	...
	return o.FinalColor.Get(), o.FinalColor.IsSet()
}
...
// SetFinalColor gets a reference to the given NullableString and assigns it to the FinalColor field.
...
func (o *ApiStreamEvent200ResponseOneOf2Challenge) SetFinalColorNil() {
	o.FinalColor.Set(nil)
}
...
func (o ApiStreamEvent200ResponseOneOf2Challenge) MarshalJSON() ([]byte, error) {
...
func (o ApiStreamEvent200ResponseOneOf2Challenge) ToMap() (map[string]interface{}, error) {
	...
	if o.FinalColor.IsSet() {
		toSerialize["finalColor"] = o.FinalColor.Get()
	}
...
func (o *ApiStreamEvent200ResponseOneOf2Challenge) UnmarshalJSON(data []byte) (err error) {
	...
	varApiStreamEvent200ResponseOneOf2Challenge := _ApiStreamEvent200ResponseOneOf2Challenge{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiStreamEvent200ResponseOneOf2Challenge)

	if err != nil {
		return err
	}

	*o = ApiStreamEvent200ResponseOneOf2Challenge(varApiStreamEvent200ResponseOneOf2Challenge)

	return err
}

type NullableApiStreamEvent200ResponseOneOf2Challenge struct {
	value *ApiStreamEvent200ResponseOneOf2Challenge
	isSet bool
}

func (v NullableApiStreamEvent200ResponseOneOf2Challenge) Get() *ApiStreamEvent200ResponseOneOf2Challenge {
	return v.value
}

func (v *NullableApiStreamEvent200ResponseOneOf2Challenge) Set(val *ApiStreamEvent200ResponseOneOf2Challenge) {
	v.value = val
	v.isSet = true
}

func (v NullableApiStreamEvent200ResponseOneOf2Challenge) IsSet() bool {
	return v.isSet
}

func (v *NullableApiStreamEvent200ResponseOneOf2Challenge) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiStreamEvent200ResponseOneOf2Challenge(val *ApiStreamEvent200ResponseOneOf2Challenge) *NullableApiStreamEvent200ResponseOneOf2Challenge {
	return &NullableApiStreamEvent200ResponseOneOf2Challenge{value: val, isSet: true}
}

func (v NullableApiStreamEvent200ResponseOneOf2Challenge) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiStreamEvent200ResponseOneOf2Challenge) UnmarshalJSON(src []byte) error {
	v.isSet = true
