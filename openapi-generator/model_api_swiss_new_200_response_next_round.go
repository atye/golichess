...
// checks if the ApiSwissNew200ResponseNextRound type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiSwissNew200ResponseNextRound{}

// ApiSwissNew200ResponseNextRound struct for ApiSwissNew200ResponseNextRound
type ApiSwissNew200ResponseNextRound struct {
...
func NewApiSwissNew200ResponseNextRound() *ApiSwissNew200ResponseNextRound {
	this := ApiSwissNew200ResponseNextRound{}
	return &this
}
...
func (o ApiSwissNew200ResponseNextRound) MarshalJSON() ([]byte, error) {
...
func (o ApiSwissNew200ResponseNextRound) ToMap() (map[string]interface{}, error) {
...
type NullableApiSwissNew200ResponseNextRound struct {
	value *ApiSwissNew200ResponseNextRound
	isSet bool
}

func (v NullableApiSwissNew200ResponseNextRound) Get() *ApiSwissNew200ResponseNextRound {
	return v.value
}

func (v *NullableApiSwissNew200ResponseNextRound) Set(val *ApiSwissNew200ResponseNextRound) {
	v.value = val
	v.isSet = true
}

func (v NullableApiSwissNew200ResponseNextRound) IsSet() bool {
	return v.isSet
}

func (v *NullableApiSwissNew200ResponseNextRound) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiSwissNew200ResponseNextRound(val *ApiSwissNew200ResponseNextRound) *NullableApiSwissNew200ResponseNextRound {
	return &NullableApiSwissNew200ResponseNextRound{value: val, isSet: true}
}

func (v NullableApiSwissNew200ResponseNextRound) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiSwissNew200ResponseNextRound) UnmarshalJSON(src []byte) error {
	v.isSet = true
