...
Games also have a private players chat, which only the 2 players can see.
	...
	*/
	...
	//  @return SpectatorGameChat
	GameChatGetExecute(r GamesAPIGameChatGetRequest) (*SpectatorGameChat, *http.Response, error)
...
func (r GamesAPIGameChatGetRequest) Execute() (*SpectatorGameChat, *http.Response, error) {
...
// Execute executes the request
//  @return SpectatorGameChat
func (a *GamesAPIService) GameChatGetExecute(r GamesAPIGameChatGetRequest) (*SpectatorGameChat, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SpectatorGameChat
	)
