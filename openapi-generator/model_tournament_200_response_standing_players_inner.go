...
// checks if the Tournament200ResponseStandingPlayersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Tournament200ResponseStandingPlayersInner{}

// Tournament200ResponseStandingPlayersInner struct for Tournament200ResponseStandingPlayersInner
type Tournament200ResponseStandingPlayersInner struct {
...
func NewTournament200ResponseStandingPlayersInner() *Tournament200ResponseStandingPlayersInner {
	this := Tournament200ResponseStandingPlayersInner{}
	return &this
}
...
func (o Tournament200ResponseStandingPlayersInner) MarshalJSON() ([]byte, error) {
...
func (o Tournament200ResponseStandingPlayersInner) ToMap() (map[string]interface{}, error) {
...
type NullableTournament200ResponseStandingPlayersInner struct {
	value *Tournament200ResponseStandingPlayersInner
	isSet bool
}

func (v NullableTournament200ResponseStandingPlayersInner) Get() *Tournament200ResponseStandingPlayersInner {
	return v.value
}

func (v *NullableTournament200ResponseStandingPlayersInner) Set(val *Tournament200ResponseStandingPlayersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTournament200ResponseStandingPlayersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTournament200ResponseStandingPlayersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTournament200ResponseStandingPlayersInner(val *Tournament200ResponseStandingPlayersInner) *NullableTournament200ResponseStandingPlayersInner {
	return &NullableTournament200ResponseStandingPlayersInner{value: val, isSet: true}
}

func (v NullableTournament200ResponseStandingPlayersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTournament200ResponseStandingPlayersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
