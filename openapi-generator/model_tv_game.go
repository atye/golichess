...
// checks if the TvGame type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TvGame{}

// TvGame struct for TvGame
type TvGame struct {
...
func (o TvGame) MarshalJSON() ([]byte, error) {
...
func (o TvGame) ToMap() (map[string]interface{}, error) {
...
func (o *TvGame) UnmarshalJSON(data []byte) (err error) {
...
type NullableTvGame struct {
	value *TvGame
	isSet bool
}

func (v NullableTvGame) Get() *TvGame {
	return v.value
}

func (v *NullableTvGame) Set(val *TvGame) {
	v.value = val
	v.isSet = true
}

func (v NullableTvGame) IsSet() bool {
	return v.isSet
}

func (v *NullableTvGame) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTvGame(val *TvGame) *NullableTvGame {
	return &NullableTvGame{value: val, isSet: true}
}

func (v NullableTvGame) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTvGame) UnmarshalJSON(src []byte) error {
	v.isSet = true
