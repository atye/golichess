...
// checks if the TeamPaginatorJson type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamPaginatorJson{}

// TeamPaginatorJson struct for TeamPaginatorJson
...
type _TeamPaginatorJson TeamPaginatorJson
...
func (o TeamPaginatorJson) MarshalJSON() ([]byte, error) {
...
func (o TeamPaginatorJson) ToMap() (map[string]interface{}, error) {
...
func (o *TeamPaginatorJson) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamPaginatorJson := _TeamPaginatorJson{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTeamPaginatorJson)

	if err != nil {
		return err
	}

	*o = TeamPaginatorJson(varTeamPaginatorJson)

	return err
}

type NullableTeamPaginatorJson struct {
	value *TeamPaginatorJson
	isSet bool
}

func (v NullableTeamPaginatorJson) Get() *TeamPaginatorJson {
	return v.value
}

func (v *NullableTeamPaginatorJson) Set(val *TeamPaginatorJson) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamPaginatorJson) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamPaginatorJson) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamPaginatorJson(val *TeamPaginatorJson) *NullableTeamPaginatorJson {
	return &NullableTeamPaginatorJson{value: val, isSet: true}
}

func (v NullableTeamPaginatorJson) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamPaginatorJson) UnmarshalJSON(src []byte) error {
	v.isSet = true
