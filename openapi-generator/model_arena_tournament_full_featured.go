...
// checks if the ArenaTournamentFullFeatured type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArenaTournamentFullFeatured{}

// ArenaTournamentFullFeatured struct for ArenaTournamentFullFeatured
...
func NewArenaTournamentFullFeatured() *ArenaTournamentFullFeatured {
	this := ArenaTournamentFullFeatured{}
	return &this
}
...
func (o *ArenaTournamentFullFeatured) GetWhite() ArenaTournamentFullFeaturedWhite {
	if o == nil || IsNil(o.White) {
		var ret ArenaTournamentFullFeaturedWhite
		return ret
	}
	return *o.White
}
...
// SetWhite gets a reference to the given ArenaTournamentFullFeaturedWhite and assigns it to the White field.
...
// SetBlack gets a reference to the given ArenaTournamentFullFeaturedWhite and assigns it to the Black field.
...
func (o *ArenaTournamentFullFeatured) GetC() ArenaTournamentFullFeaturedC {
	if o == nil || IsNil(o.C) {
		var ret ArenaTournamentFullFeaturedC
		return ret
	}
	return *o.C
}
...
// SetC gets a reference to the given ArenaTournamentFullFeaturedC and assigns it to the C field.
func (o *ArenaTournamentFullFeatured) SetC(v ArenaTournamentFullFeaturedC) {
	o.C = &v
}

func (o ArenaTournamentFullFeatured) MarshalJSON() ([]byte, error) {
...
func (o ArenaTournamentFullFeatured) ToMap() (map[string]interface{}, error) {
...
type NullableArenaTournamentFullFeatured struct {
	value *ArenaTournamentFullFeatured
	isSet bool
}

func (v NullableArenaTournamentFullFeatured) Get() *ArenaTournamentFullFeatured {
	return v.value
}

func (v *NullableArenaTournamentFullFeatured) Set(val *ArenaTournamentFullFeatured) {
	v.value = val
	v.isSet = true
}

func (v NullableArenaTournamentFullFeatured) IsSet() bool {
	return v.isSet
}

func (v *NullableArenaTournamentFullFeatured) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArenaTournamentFullFeatured(val *ArenaTournamentFullFeatured) *NullableArenaTournamentFullFeatured {
	return &NullableArenaTournamentFullFeatured{value: val, isSet: true}
}

func (v NullableArenaTournamentFullFeatured) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArenaTournamentFullFeatured) UnmarshalJSON(src []byte) error {
	v.isSet = true
