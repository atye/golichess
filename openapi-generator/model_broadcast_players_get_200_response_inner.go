...
// checks if the BroadcastPlayersGet200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastPlayersGet200ResponseInner{}

// BroadcastPlayersGet200ResponseInner struct for BroadcastPlayersGet200ResponseInner
type BroadcastPlayersGet200ResponseInner struct {
...
type _BroadcastPlayersGet200ResponseInner BroadcastPlayersGet200ResponseInner
...
func NewBroadcastPlayersGet200ResponseInner(name string) *BroadcastPlayersGet200ResponseInner {
	this := BroadcastPlayersGet200ResponseInner{}
	this.Name = name
	return &this
}
...
func (o *BroadcastPlayersGet200ResponseInner) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o BroadcastPlayersGet200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o BroadcastPlayersGet200ResponseInner) ToMap() (map[string]interface{}, error) {
...
func (o *BroadcastPlayersGet200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	varBroadcastPlayersGet200ResponseInner := _BroadcastPlayersGet200ResponseInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBroadcastPlayersGet200ResponseInner)

	if err != nil {
		return err
	}

	*o = BroadcastPlayersGet200ResponseInner(varBroadcastPlayersGet200ResponseInner)

	return err
}

type NullableBroadcastPlayersGet200ResponseInner struct {
	value *BroadcastPlayersGet200ResponseInner
	isSet bool
}

func (v NullableBroadcastPlayersGet200ResponseInner) Get() *BroadcastPlayersGet200ResponseInner {
	return v.value
}

func (v *NullableBroadcastPlayersGet200ResponseInner) Set(val *BroadcastPlayersGet200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastPlayersGet200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastPlayersGet200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastPlayersGet200ResponseInner(val *BroadcastPlayersGet200ResponseInner) *NullableBroadcastPlayersGet200ResponseInner {
	return &NullableBroadcastPlayersGet200ResponseInner{value: val, isSet: true}
}

func (v NullableBroadcastPlayersGet200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastPlayersGet200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
