...
// checks if the GameStartEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameStartEvent{}
...
type _GameStartEvent GameStartEvent
...
func (o GameStartEvent) ToMap() (map[string]interface{}, error) {
...
func (o *GameStartEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varGameStartEvent := _GameStartEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameStartEvent)

	if err != nil {
		return err
	}

	*o = GameStartEvent(varGameStartEvent)
