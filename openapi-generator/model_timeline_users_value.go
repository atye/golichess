...
// checks if the TimelineUsersValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimelineUsersValue{}

// TimelineUsersValue struct for TimelineUsersValue
...
type _TimelineUsersValue TimelineUsersValue
...
func (o TimelineUsersValue) MarshalJSON() ([]byte, error) {
...
func (o TimelineUsersValue) ToMap() (map[string]interface{}, error) {
...
func (o *TimelineUsersValue) UnmarshalJSON(data []byte) (err error) {
	...
	varTimelineUsersValue := _TimelineUsersValue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTimelineUsersValue)

	if err != nil {
		return err
	}

	*o = TimelineUsersValue(varTimelineUsersValue)

	return err
}

type NullableTimelineUsersValue struct {
	value *TimelineUsersValue
	isSet bool
}

func (v NullableTimelineUsersValue) Get() *TimelineUsersValue {
	return v.value
}

func (v *NullableTimelineUsersValue) Set(val *TimelineUsersValue) {
	v.value = val
	v.isSet = true
}

func (v NullableTimelineUsersValue) IsSet() bool {
	return v.isSet
}

func (v *NullableTimelineUsersValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimelineUsersValue(val *TimelineUsersValue) *NullableTimelineUsersValue {
	return &NullableTimelineUsersValue{value: val, isSet: true}
}

func (v NullableTimelineUsersValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimelineUsersValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
