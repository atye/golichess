...
// checks if the ApiTournamentPost200ResponsePodiumInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiTournamentPost200ResponsePodiumInner{}

// ApiTournamentPost200ResponsePodiumInner struct for ApiTournamentPost200ResponsePodiumInner
type ApiTournamentPost200ResponsePodiumInner struct {
...
func NewApiTournamentPost200ResponsePodiumInner() *ApiTournamentPost200ResponsePodiumInner {
	this := ApiTournamentPost200ResponsePodiumInner{}
	return &this
}
...
func (o *ApiTournamentPost200ResponsePodiumInner) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o ApiTournamentPost200ResponsePodiumInner) MarshalJSON() ([]byte, error) {
...
func (o ApiTournamentPost200ResponsePodiumInner) ToMap() (map[string]interface{}, error) {
...
type NullableApiTournamentPost200ResponsePodiumInner struct {
	value *ApiTournamentPost200ResponsePodiumInner
	isSet bool
}

func (v NullableApiTournamentPost200ResponsePodiumInner) Get() *ApiTournamentPost200ResponsePodiumInner {
	return v.value
}

func (v *NullableApiTournamentPost200ResponsePodiumInner) Set(val *ApiTournamentPost200ResponsePodiumInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiTournamentPost200ResponsePodiumInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiTournamentPost200ResponsePodiumInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiTournamentPost200ResponsePodiumInner(val *ApiTournamentPost200ResponsePodiumInner) *NullableApiTournamentPost200ResponsePodiumInner {
	return &NullableApiTournamentPost200ResponsePodiumInner{value: val, isSet: true}
}

func (v NullableApiTournamentPost200ResponsePodiumInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiTournamentPost200ResponsePodiumInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
