...
// checks if the BroadcastRoundGame type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastRoundGame{}

// BroadcastRoundGame struct for BroadcastRoundGame
type BroadcastRoundGame struct {
	Id string `json:"id"`
	Name string `json:"name"`
	Fen *string `json:"fen,omitempty"`
	Players []BroadcastRoundGamePlayersInner `json:"players,omitempty"`
...
type _BroadcastRoundGame BroadcastRoundGame
...
func (o *BroadcastRoundGame) GetPlayers() []BroadcastRoundGamePlayersInner {
	if o == nil || IsNil(o.Players) {
		var ret []BroadcastRoundGamePlayersInner
		return ret
	}
	return o.Players
}
...
// SetPlayers gets a reference to the given []BroadcastRoundGamePlayersInner and assigns it to the Players field.
...
func (o BroadcastRoundGame) MarshalJSON() ([]byte, error) {
...
func (o BroadcastRoundGame) ToMap() (map[string]interface{}, error) {
...
func (o *BroadcastRoundGame) UnmarshalJSON(data []byte) (err error) {
	...
	varBroadcastRoundGame := _BroadcastRoundGame{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBroadcastRoundGame)

	if err != nil {
		return err
	}

	*o = BroadcastRoundGame(varBroadcastRoundGame)

	return err
}

type NullableBroadcastRoundGame struct {
	value *BroadcastRoundGame
	isSet bool
}

func (v NullableBroadcastRoundGame) Get() *BroadcastRoundGame {
	return v.value
}

func (v *NullableBroadcastRoundGame) Set(val *BroadcastRoundGame) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastRoundGame) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastRoundGame) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastRoundGame(val *BroadcastRoundGame) *NullableBroadcastRoundGame {
	return &NullableBroadcastRoundGame{value: val, isSet: true}
}

func (v NullableBroadcastRoundGame) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastRoundGame) UnmarshalJSON(src []byte) error {
	v.isSet = true
