...
// checks if the BroadcastRoundUpdate200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastRoundUpdate200Response{}

// BroadcastRoundUpdate200Response struct for BroadcastRoundUpdate200Response
type BroadcastRoundUpdate200Response struct {
	...
	Games []BroadcastRoundUpdate200ResponseGamesInner `json:"games"`
	Group *BroadcastTourGet200ResponseGroup `json:"group,omitempty"`
	...
	Photos map[string]BroadcastsOfficial200ResponsePhotosValue `json:"photos"`
}

type _BroadcastRoundUpdate200Response BroadcastRoundUpdate200Response
...
func NewBroadcastRoundUpdate200Response(round BroadcastsOfficial200ResponseRoundsInner, tour BroadcastsOfficial200ResponseTour, study BroadcastRoundCreate200ResponseStudy, games []BroadcastRoundUpdate200ResponseGamesInner, photos map[string]BroadcastsOfficial200ResponsePhotosValue) *BroadcastRoundUpdate200Response {
	this := BroadcastRoundUpdate200Response{}
	this.Round = round
	this.Tour = tour
	this.Study = study
	this.Games = games
...
func (o *BroadcastRoundUpdate200Response) GetGames() []BroadcastRoundUpdate200ResponseGamesInner {
	if o == nil {
		var ret []BroadcastRoundUpdate200ResponseGamesInner
		return ret
	}
...
func (o *BroadcastRoundUpdate200Response) GetGroup() BroadcastTourGet200ResponseGroup {
	if o == nil || IsNil(o.Group) {
		var ret BroadcastTourGet200ResponseGroup
		return ret
	}
	return *o.Group
}
...
// and a boolean to check if the value has been set.
func (o *BroadcastRoundUpdate200Response) GetGroupOk() (*BroadcastTourGet200ResponseGroup, bool) {
	if o == nil || IsNil(o.Group) {
		return nil, false
	}
	return o.Group, true
...
// SetGroup gets a reference to the given BroadcastTourGet200ResponseGroup and assigns it to the Group field.
func (o *BroadcastRoundUpdate200Response) SetGroup(v BroadcastTourGet200ResponseGroup) {
	o.Group = &v
}
...
func (o BroadcastRoundUpdate200Response) MarshalJSON() ([]byte, error) {
...
func (o BroadcastRoundUpdate200Response) ToMap() (map[string]interface{}, error) {
...
func (o *BroadcastRoundUpdate200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varBroadcastRoundUpdate200Response := _BroadcastRoundUpdate200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBroadcastRoundUpdate200Response)

	if err != nil {
		return err
	}

	*o = BroadcastRoundUpdate200Response(varBroadcastRoundUpdate200Response)

	return err
}

type NullableBroadcastRoundUpdate200Response struct {
	value *BroadcastRoundUpdate200Response
	isSet bool
}

func (v NullableBroadcastRoundUpdate200Response) Get() *BroadcastRoundUpdate200Response {
	return v.value
}

func (v *NullableBroadcastRoundUpdate200Response) Set(val *BroadcastRoundUpdate200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastRoundUpdate200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastRoundUpdate200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastRoundUpdate200Response(val *BroadcastRoundUpdate200Response) *NullableBroadcastRoundUpdate200Response {
	return &NullableBroadcastRoundUpdate200Response{value: val, isSet: true}
}

func (v NullableBroadcastRoundUpdate200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastRoundUpdate200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
