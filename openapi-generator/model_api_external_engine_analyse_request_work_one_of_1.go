...
// checks if the ApiExternalEngineAnalyseRequestWorkOneOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiExternalEngineAnalyseRequestWorkOneOf1{}

// ApiExternalEngineAnalyseRequestWorkOneOf1 struct for ApiExternalEngineAnalyseRequestWorkOneOf1
type ApiExternalEngineAnalyseRequestWorkOneOf1 struct {
...
type _ApiExternalEngineAnalyseRequestWorkOneOf1 ApiExternalEngineAnalyseRequestWorkOneOf1
...
func NewApiExternalEngineAnalyseRequestWorkOneOf1(depth int32, sessionId string, threads int32, hash int32, multiPv int32, variant string, initialFen string, moves []string) *ApiExternalEngineAnalyseRequestWorkOneOf1 {
	this := ApiExternalEngineAnalyseRequestWorkOneOf1{}
	this.Depth = depth
...
func (o ApiExternalEngineAnalyseRequestWorkOneOf1) MarshalJSON() ([]byte, error) {
...
func (o ApiExternalEngineAnalyseRequestWorkOneOf1) ToMap() (map[string]interface{}, error) {
...
func (o *ApiExternalEngineAnalyseRequestWorkOneOf1) UnmarshalJSON(data []byte) (err error) {
	...
	varApiExternalEngineAnalyseRequestWorkOneOf1 := _ApiExternalEngineAnalyseRequestWorkOneOf1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiExternalEngineAnalyseRequestWorkOneOf1)

	if err != nil {
		return err
	}

	*o = ApiExternalEngineAnalyseRequestWorkOneOf1(varApiExternalEngineAnalyseRequestWorkOneOf1)

	return err
}

type NullableApiExternalEngineAnalyseRequestWorkOneOf1 struct {
	value *ApiExternalEngineAnalyseRequestWorkOneOf1
	isSet bool
}

func (v NullableApiExternalEngineAnalyseRequestWorkOneOf1) Get() *ApiExternalEngineAnalyseRequestWorkOneOf1 {
	return v.value
}

func (v *NullableApiExternalEngineAnalyseRequestWorkOneOf1) Set(val *ApiExternalEngineAnalyseRequestWorkOneOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableApiExternalEngineAnalyseRequestWorkOneOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableApiExternalEngineAnalyseRequestWorkOneOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiExternalEngineAnalyseRequestWorkOneOf1(val *ApiExternalEngineAnalyseRequestWorkOneOf1) *NullableApiExternalEngineAnalyseRequestWorkOneOf1 {
	return &NullableApiExternalEngineAnalyseRequestWorkOneOf1{value: val, isSet: true}
}

func (v NullableApiExternalEngineAnalyseRequestWorkOneOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiExternalEngineAnalyseRequestWorkOneOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
