...
// checks if the ApiStreamEvent200ResponseOneOf2ChallengeChallenger type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiStreamEvent200ResponseOneOf2ChallengeChallenger{}

// ApiStreamEvent200ResponseOneOf2ChallengeChallenger struct for ApiStreamEvent200ResponseOneOf2ChallengeChallenger
type ApiStreamEvent200ResponseOneOf2ChallengeChallenger struct {
	Id string `json:"id"`
...
type _ApiStreamEvent200ResponseOneOf2ChallengeChallenger ApiStreamEvent200ResponseOneOf2ChallengeChallenger
...
func NewApiStreamEvent200ResponseOneOf2ChallengeChallenger(id string, name string) *ApiStreamEvent200ResponseOneOf2ChallengeChallenger {
	this := ApiStreamEvent200ResponseOneOf2ChallengeChallenger{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o *ApiStreamEvent200ResponseOneOf2ChallengeChallenger) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o ApiStreamEvent200ResponseOneOf2ChallengeChallenger) MarshalJSON() ([]byte, error) {
...
func (o ApiStreamEvent200ResponseOneOf2ChallengeChallenger) ToMap() (map[string]interface{}, error) {
...
func (o *ApiStreamEvent200ResponseOneOf2ChallengeChallenger) UnmarshalJSON(data []byte) (err error) {
	...
	varApiStreamEvent200ResponseOneOf2ChallengeChallenger := _ApiStreamEvent200ResponseOneOf2ChallengeChallenger{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiStreamEvent200ResponseOneOf2ChallengeChallenger)

	if err != nil {
		return err
	}

	*o = ApiStreamEvent200ResponseOneOf2ChallengeChallenger(varApiStreamEvent200ResponseOneOf2ChallengeChallenger)

	return err
}

type NullableApiStreamEvent200ResponseOneOf2ChallengeChallenger struct {
	value *ApiStreamEvent200ResponseOneOf2ChallengeChallenger
	isSet bool
}

func (v NullableApiStreamEvent200ResponseOneOf2ChallengeChallenger) Get() *ApiStreamEvent200ResponseOneOf2ChallengeChallenger {
	return v.value
}

func (v *NullableApiStreamEvent200ResponseOneOf2ChallengeChallenger) Set(val *ApiStreamEvent200ResponseOneOf2ChallengeChallenger) {
	v.value = val
	v.isSet = true
}

func (v NullableApiStreamEvent200ResponseOneOf2ChallengeChallenger) IsSet() bool {
	return v.isSet
}

func (v *NullableApiStreamEvent200ResponseOneOf2ChallengeChallenger) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiStreamEvent200ResponseOneOf2ChallengeChallenger(val *ApiStreamEvent200ResponseOneOf2ChallengeChallenger) *NullableApiStreamEvent200ResponseOneOf2ChallengeChallenger {
	return &NullableApiStreamEvent200ResponseOneOf2ChallengeChallenger{value: val, isSet: true}
}

func (v NullableApiStreamEvent200ResponseOneOf2ChallengeChallenger) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiStreamEvent200ResponseOneOf2ChallengeChallenger) UnmarshalJSON(src []byte) error {
	v.isSet = true
