...
// checks if the TeamRequestWithUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamRequestWithUser{}
...
type _TeamRequestWithUser TeamRequestWithUser

// NewTeamRequestWithUser instantiates a new TeamRequestWithUser object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTeamRequestWithUser(request TeamRequest, user User) *TeamRequestWithUser {
...
func (o TeamRequestWithUser) ToMap() (map[string]interface{}, error) {
...
func (o *TeamRequestWithUser) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamRequestWithUser := _TeamRequestWithUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTeamRequestWithUser)

	if err != nil {
		return err
	}

	*o = TeamRequestWithUser(varTeamRequestWithUser)
