...
// checks if the GamePgn200ResponseOneOfPlayersWhite type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GamePgn200ResponseOneOfPlayersWhite{}

// GamePgn200ResponseOneOfPlayersWhite struct for GamePgn200ResponseOneOfPlayersWhite
type GamePgn200ResponseOneOfPlayersWhite struct {
...
type _GamePgn200ResponseOneOfPlayersWhite GamePgn200ResponseOneOfPlayersWhite
...
func NewGamePgn200ResponseOneOfPlayersWhite(user ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId, rating int32) *GamePgn200ResponseOneOfPlayersWhite {
	this := GamePgn200ResponseOneOfPlayersWhite{}
	this.User = user
	this.Rating = rating
	return &this
}
...
func (o GamePgn200ResponseOneOfPlayersWhite) MarshalJSON() ([]byte, error) {
...
func (o GamePgn200ResponseOneOfPlayersWhite) ToMap() (map[string]interface{}, error) {
...
func (o *GamePgn200ResponseOneOfPlayersWhite) UnmarshalJSON(data []byte) (err error) {
	...
	varGamePgn200ResponseOneOfPlayersWhite := _GamePgn200ResponseOneOfPlayersWhite{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGamePgn200ResponseOneOfPlayersWhite)

	if err != nil {
		return err
	}

	*o = GamePgn200ResponseOneOfPlayersWhite(varGamePgn200ResponseOneOfPlayersWhite)

	return err
}

type NullableGamePgn200ResponseOneOfPlayersWhite struct {
	value *GamePgn200ResponseOneOfPlayersWhite
	isSet bool
}

func (v NullableGamePgn200ResponseOneOfPlayersWhite) Get() *GamePgn200ResponseOneOfPlayersWhite {
	return v.value
}

func (v *NullableGamePgn200ResponseOneOfPlayersWhite) Set(val *GamePgn200ResponseOneOfPlayersWhite) {
	v.value = val
	v.isSet = true
}

func (v NullableGamePgn200ResponseOneOfPlayersWhite) IsSet() bool {
	return v.isSet
}

func (v *NullableGamePgn200ResponseOneOfPlayersWhite) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGamePgn200ResponseOneOfPlayersWhite(val *GamePgn200ResponseOneOfPlayersWhite) *NullableGamePgn200ResponseOneOfPlayersWhite {
	return &NullableGamePgn200ResponseOneOfPlayersWhite{value: val, isSet: true}
}

func (v NullableGamePgn200ResponseOneOfPlayersWhite) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGamePgn200ResponseOneOfPlayersWhite) UnmarshalJSON(src []byte) error {
	v.isSet = true
