...
// checks if the OpeningExplorerMasters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerMasters{}

// OpeningExplorerMasters struct for OpeningExplorerMasters
type OpeningExplorerMasters struct {
	...
	Moves []OpeningExplorerMastersMovesInner `json:"moves"`
	TopGames []OpeningExplorerMastersTopGamesInner `json:"topGames"`
}

type _OpeningExplorerMasters OpeningExplorerMasters
...
func (o *OpeningExplorerMasters) GetMoves() []OpeningExplorerMastersMovesInner {
	if o == nil {
		var ret []OpeningExplorerMastersMovesInner
		return ret
	}
...
func (o *OpeningExplorerMasters) GetTopGames() []OpeningExplorerMastersTopGamesInner {
	if o == nil {
		var ret []OpeningExplorerMastersTopGamesInner
		return ret
	}
...
func (o OpeningExplorerMasters) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerMasters) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerMasters) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerMasters := _OpeningExplorerMasters{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerMasters)

	if err != nil {
		return err
	}

	*o = OpeningExplorerMasters(varOpeningExplorerMasters)

	return err
}

type NullableOpeningExplorerMasters struct {
	value *OpeningExplorerMasters
	isSet bool
}

func (v NullableOpeningExplorerMasters) Get() *OpeningExplorerMasters {
	return v.value
}

func (v *NullableOpeningExplorerMasters) Set(val *OpeningExplorerMasters) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerMasters) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerMasters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerMasters(val *OpeningExplorerMasters) *NullableOpeningExplorerMasters {
	return &NullableOpeningExplorerMasters{value: val, isSet: true}
}

func (v NullableOpeningExplorerMasters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerMasters) UnmarshalJSON(src []byte) error {
	v.isSet = true
