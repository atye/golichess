...
// checks if the ApiStreamEvent200ResponseOneOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiStreamEvent200ResponseOneOf2{}

// ApiStreamEvent200ResponseOneOf2 struct for ApiStreamEvent200ResponseOneOf2
type ApiStreamEvent200ResponseOneOf2 struct {
	Type string `json:"type"`
	Challenge ApiStreamEvent200ResponseOneOf2Challenge `json:"challenge"`
	Compat *ApiStreamEvent200ResponseOneOfGameCompat `json:"compat,omitempty"`
}

type _ApiStreamEvent200ResponseOneOf2 ApiStreamEvent200ResponseOneOf2
...
func NewApiStreamEvent200ResponseOneOf2(type_ string, challenge ApiStreamEvent200ResponseOneOf2Challenge) *ApiStreamEvent200ResponseOneOf2 {
	this := ApiStreamEvent200ResponseOneOf2{}
	this.Type = type_
...
func (o *ApiStreamEvent200ResponseOneOf2) GetChallenge() ApiStreamEvent200ResponseOneOf2Challenge {
	if o == nil {
		var ret ApiStreamEvent200ResponseOneOf2Challenge
		return ret
	}
...
func (o ApiStreamEvent200ResponseOneOf2) MarshalJSON() ([]byte, error) {
...
func (o ApiStreamEvent200ResponseOneOf2) ToMap() (map[string]interface{}, error) {
...
func (o *ApiStreamEvent200ResponseOneOf2) UnmarshalJSON(data []byte) (err error) {
	...
	varApiStreamEvent200ResponseOneOf2 := _ApiStreamEvent200ResponseOneOf2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiStreamEvent200ResponseOneOf2)

	if err != nil {
		return err
	}

	*o = ApiStreamEvent200ResponseOneOf2(varApiStreamEvent200ResponseOneOf2)

	return err
}

type NullableApiStreamEvent200ResponseOneOf2 struct {
	value *ApiStreamEvent200ResponseOneOf2
	isSet bool
}

func (v NullableApiStreamEvent200ResponseOneOf2) Get() *ApiStreamEvent200ResponseOneOf2 {
	return v.value
}

func (v *NullableApiStreamEvent200ResponseOneOf2) Set(val *ApiStreamEvent200ResponseOneOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableApiStreamEvent200ResponseOneOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableApiStreamEvent200ResponseOneOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiStreamEvent200ResponseOneOf2(val *ApiStreamEvent200ResponseOneOf2) *NullableApiStreamEvent200ResponseOneOf2 {
	return &NullableApiStreamEvent200ResponseOneOf2{value: val, isSet: true}
}

func (v NullableApiStreamEvent200ResponseOneOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiStreamEvent200ResponseOneOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
