...
// checks if the ChatLineEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChatLineEvent{}
...
type _ChatLineEvent ChatLineEvent
...
func (o ChatLineEvent) ToMap() (map[string]interface{}, error) {
...
func (o *ChatLineEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varChatLineEvent := _ChatLineEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChatLineEvent)

	if err != nil {
		return err
	}

	*o = ChatLineEvent(varChatLineEvent)
