...
// checks if the OpeningExplorerLichess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerLichess{}

// OpeningExplorerLichess struct for OpeningExplorerLichess
type OpeningExplorerLichess struct {
	...
	Moves []OpeningExplorerLichessMovesInner `json:"moves"`
	TopGames []OpeningExplorerLichessTopGamesInner `json:"topGames"`
	RecentGames []OpeningExplorerLichessTopGamesInner `json:"recentGames,omitempty"`
	History []OpeningExplorerLichessHistoryInner `json:"history,omitempty"`
}

type _OpeningExplorerLichess OpeningExplorerLichess
...
func (o *OpeningExplorerLichess) GetMoves() []OpeningExplorerLichessMovesInner {
	if o == nil {
		var ret []OpeningExplorerLichessMovesInner
		return ret
	}
...
func (o *OpeningExplorerLichess) GetTopGames() []OpeningExplorerLichessTopGamesInner {
	if o == nil {
		var ret []OpeningExplorerLichessTopGamesInner
		return ret
	}
...
// SetRecentGames gets a reference to the given []OpeningExplorerLichessTopGamesInner and assigns it to the RecentGames field.
...
func (o *OpeningExplorerLichess) GetHistory() []OpeningExplorerLichessHistoryInner {
	if o == nil || IsNil(o.History) {
		var ret []OpeningExplorerLichessHistoryInner
		return ret
	}
	return o.History
}
...
// SetHistory gets a reference to the given []OpeningExplorerLichessHistoryInner and assigns it to the History field.
func (o *OpeningExplorerLichess) SetHistory(v []OpeningExplorerLichessHistoryInner) {
	o.History = v
}

func (o OpeningExplorerLichess) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerLichess) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerLichess) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerLichess := _OpeningExplorerLichess{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerLichess)

	if err != nil {
		return err
	}

	*o = OpeningExplorerLichess(varOpeningExplorerLichess)

	return err
}

type NullableOpeningExplorerLichess struct {
	value *OpeningExplorerLichess
	isSet bool
}

func (v NullableOpeningExplorerLichess) Get() *OpeningExplorerLichess {
	return v.value
}

func (v *NullableOpeningExplorerLichess) Set(val *OpeningExplorerLichess) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerLichess) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerLichess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerLichess(val *OpeningExplorerLichess) *NullableOpeningExplorerLichess {
	return &NullableOpeningExplorerLichess{value: val, isSet: true}
}

func (v NullableOpeningExplorerLichess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerLichess) UnmarshalJSON(src []byte) error {
	v.isSet = true
