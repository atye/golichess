...
// checks if the GameFullEventClock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameFullEventClock{}

// GameFullEventClock struct for GameFullEventClock
...
func (o GameFullEventClock) MarshalJSON() ([]byte, error) {
...
func (o GameFullEventClock) ToMap() (map[string]interface{}, error) {
...
type NullableGameFullEventClock struct {
	value *GameFullEventClock
	isSet bool
}

func (v NullableGameFullEventClock) Get() *GameFullEventClock {
	return v.value
}

func (v *NullableGameFullEventClock) Set(val *GameFullEventClock) {
	v.value = val
	v.isSet = true
}

func (v NullableGameFullEventClock) IsSet() bool {
	return v.isSet
}

func (v *NullableGameFullEventClock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGameFullEventClock(val *GameFullEventClock) *NullableGameFullEventClock {
	return &NullableGameFullEventClock{value: val, isSet: true}
}

func (v NullableGameFullEventClock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGameFullEventClock) UnmarshalJSON(src []byte) error {
	v.isSet = true
