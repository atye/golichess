...
// checks if the OpeningExplorerLichessMovesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerLichessMovesInner{}

// OpeningExplorerLichessMovesInner struct for OpeningExplorerLichessMovesInner
type OpeningExplorerLichessMovesInner struct {
	Uci string `json:"uci"`
	San string `json:"san"`
	...
	Game NullableOpeningExplorerLichessGame `json:"game"`
	Opening NullableOpeningExplorerOpening `json:"opening"`
}

type _OpeningExplorerLichessMovesInner OpeningExplorerLichessMovesInner
...
func NewOpeningExplorerLichessMovesInner(uci string, san string, averageRating int32, white int32, draws int32, black int32, game NullableOpeningExplorerLichessGame, opening NullableOpeningExplorerOpening) *OpeningExplorerLichessMovesInner {
	this := OpeningExplorerLichessMovesInner{}
	this.Uci = uci
	this.San = san
...
// If the value is explicit nil, the zero value for OpeningExplorerLichessGame will be returned
func (o *OpeningExplorerLichessMovesInner) GetGame() OpeningExplorerLichessGame {
	if o == nil || o.Game.Get() == nil {
		var ret OpeningExplorerLichessGame
		return ret
	}
...
func (o OpeningExplorerLichessMovesInner) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerLichessMovesInner) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerLichessMovesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerLichessMovesInner := _OpeningExplorerLichessMovesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerLichessMovesInner)

	if err != nil {
		return err
	}

	*o = OpeningExplorerLichessMovesInner(varOpeningExplorerLichessMovesInner)

	return err
}

type NullableOpeningExplorerLichessMovesInner struct {
	value *OpeningExplorerLichessMovesInner
	isSet bool
}

func (v NullableOpeningExplorerLichessMovesInner) Get() *OpeningExplorerLichessMovesInner {
	return v.value
}

func (v *NullableOpeningExplorerLichessMovesInner) Set(val *OpeningExplorerLichessMovesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerLichessMovesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerLichessMovesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerLichessMovesInner(val *OpeningExplorerLichessMovesInner) *NullableOpeningExplorerLichessMovesInner {
	return &NullableOpeningExplorerLichessMovesInner{value: val, isSet: true}
}

func (v NullableOpeningExplorerLichessMovesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerLichessMovesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
