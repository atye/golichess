...
// checks if the TablebaseStandard200ResponseMovesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TablebaseStandard200ResponseMovesInner{}

// TablebaseStandard200ResponseMovesInner struct for TablebaseStandard200ResponseMovesInner
type TablebaseStandard200ResponseMovesInner struct {
	Uci string `json:"uci"`
	San string `json:"san"`
...
type _TablebaseStandard200ResponseMovesInner TablebaseStandard200ResponseMovesInner
...
func NewTablebaseStandard200ResponseMovesInner(uci string, san string, category string) *TablebaseStandard200ResponseMovesInner {
	this := TablebaseStandard200ResponseMovesInner{}
	this.Uci = uci
	this.San = san
...
func (o *TablebaseStandard200ResponseMovesInner) SetDtzNil() {
	o.Dtz.Set(nil)
}
...
func (o *TablebaseStandard200ResponseMovesInner) SetPreciseDtzNil() {
...
func (o *TablebaseStandard200ResponseMovesInner) SetDtcNil() {
	o.Dtc.Set(nil)
}
...
func (o *TablebaseStandard200ResponseMovesInner) SetDtmNil() {
	o.Dtm.Set(nil)
}
...
func (o *TablebaseStandard200ResponseMovesInner) SetDtwNil() {
	o.Dtw.Set(nil)
}
...
func (o TablebaseStandard200ResponseMovesInner) MarshalJSON() ([]byte, error) {
...
func (o TablebaseStandard200ResponseMovesInner) ToMap() (map[string]interface{}, error) {
...
func (o *TablebaseStandard200ResponseMovesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varTablebaseStandard200ResponseMovesInner := _TablebaseStandard200ResponseMovesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTablebaseStandard200ResponseMovesInner)

	if err != nil {
		return err
	}

	*o = TablebaseStandard200ResponseMovesInner(varTablebaseStandard200ResponseMovesInner)

	return err
}

type NullableTablebaseStandard200ResponseMovesInner struct {
	value *TablebaseStandard200ResponseMovesInner
	isSet bool
}

func (v NullableTablebaseStandard200ResponseMovesInner) Get() *TablebaseStandard200ResponseMovesInner {
	return v.value
}

func (v *NullableTablebaseStandard200ResponseMovesInner) Set(val *TablebaseStandard200ResponseMovesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTablebaseStandard200ResponseMovesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTablebaseStandard200ResponseMovesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTablebaseStandard200ResponseMovesInner(val *TablebaseStandard200ResponseMovesInner) *NullableTablebaseStandard200ResponseMovesInner {
	return &NullableTablebaseStandard200ResponseMovesInner{value: val, isSet: true}
}

func (v NullableTablebaseStandard200ResponseMovesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTablebaseStandard200ResponseMovesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
