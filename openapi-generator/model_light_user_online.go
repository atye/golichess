...
// checks if the LightUserOnline type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LightUserOnline{}

// LightUserOnline struct for LightUserOnline
...
type _LightUserOnline LightUserOnline
...
func (o LightUserOnline) MarshalJSON() ([]byte, error) {
...
func (o LightUserOnline) ToMap() (map[string]interface{}, error) {
...
func (o *LightUserOnline) UnmarshalJSON(data []byte) (err error) {
	...
	varLightUserOnline := _LightUserOnline{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLightUserOnline)

	if err != nil {
		return err
	}

	*o = LightUserOnline(varLightUserOnline)

	return err
}

type NullableLightUserOnline struct {
	value *LightUserOnline
	isSet bool
}

func (v NullableLightUserOnline) Get() *LightUserOnline {
	return v.value
}

func (v *NullableLightUserOnline) Set(val *LightUserOnline) {
	v.value = val
	v.isSet = true
}

func (v NullableLightUserOnline) IsSet() bool {
	return v.isSet
}

func (v *NullableLightUserOnline) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLightUserOnline(val *LightUserOnline) *NullableLightUserOnline {
	return &NullableLightUserOnline{value: val, isSet: true}
}

func (v NullableLightUserOnline) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLightUserOnline) UnmarshalJSON(src []byte) error {
	v.isSet = true
