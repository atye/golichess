...
// checks if the ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser{}

// ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser struct for ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser
type ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser struct {
	Id string `json:"id"`
...
type _ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser
...
func NewApiUserCurrentGame200ResponseOneOfPlayersWhiteUser(id string, name string) *ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser {
	this := ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser) MarshalJSON() ([]byte, error) {
...
func (o ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser) ToMap() (map[string]interface{}, error) {
...
func (o *ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser) UnmarshalJSON(data []byte) (err error) {
	...
	varApiUserCurrentGame200ResponseOneOfPlayersWhiteUser := _ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiUserCurrentGame200ResponseOneOfPlayersWhiteUser)

	if err != nil {
		return err
	}

	*o = ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser(varApiUserCurrentGame200ResponseOneOfPlayersWhiteUser)

	return err
}

type NullableApiUserCurrentGame200ResponseOneOfPlayersWhiteUser struct {
	value *ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser
	isSet bool
}

func (v NullableApiUserCurrentGame200ResponseOneOfPlayersWhiteUser) Get() *ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser {
	return v.value
}

func (v *NullableApiUserCurrentGame200ResponseOneOfPlayersWhiteUser) Set(val *ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser) {
	v.value = val
	v.isSet = true
}

func (v NullableApiUserCurrentGame200ResponseOneOfPlayersWhiteUser) IsSet() bool {
	return v.isSet
}

func (v *NullableApiUserCurrentGame200ResponseOneOfPlayersWhiteUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiUserCurrentGame200ResponseOneOfPlayersWhiteUser(val *ApiUserCurrentGame200ResponseOneOfPlayersWhiteUser) *NullableApiUserCurrentGame200ResponseOneOfPlayersWhiteUser {
	return &NullableApiUserCurrentGame200ResponseOneOfPlayersWhiteUser{value: val, isSet: true}
}

func (v NullableApiUserCurrentGame200ResponseOneOfPlayersWhiteUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiUserCurrentGame200ResponseOneOfPlayersWhiteUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
