...
// checks if the ChallengeDeclinedEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChallengeDeclinedEvent{}
...
type _ChallengeDeclinedEvent ChallengeDeclinedEvent
...
func (o ChallengeDeclinedEvent) ToMap() (map[string]interface{}, error) {
...
func (o *ChallengeDeclinedEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varChallengeDeclinedEvent := _ChallengeDeclinedEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChallengeDeclinedEvent)

	if err != nil {
		return err
	}

	*o = ChallengeDeclinedEvent(varChallengeDeclinedEvent)
