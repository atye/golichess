...
type MessagingAPI interface {
	...
	@param username
	@return MessagingAPIInboxUsernameRequest
	*/
...
type MessagingAPIInboxUsernameRequest struct {
	ctx context.Context
...
func (r MessagingAPIInboxUsernameRequest) Text(text string) MessagingAPIInboxUsernameRequest {
	r.text = &text
	return r
}
...
Send a private message to another player.
 ...
 @return MessagingAPIInboxUsernameRequest
*/
func (a *MessagingAPIService) InboxUsername(ctx context.Context, username string) MessagingAPIInboxUsernameRequest {
	return MessagingAPIInboxUsernameRequest{
		ApiService: a,
		ctx: ctx,
		username: username,
