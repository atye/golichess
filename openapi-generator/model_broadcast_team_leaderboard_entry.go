...
// checks if the BroadcastTeamLeaderboardEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastTeamLeaderboardEntry{}

// BroadcastTeamLeaderboardEntry struct for BroadcastTeamLeaderboardEntry
type BroadcastTeamLeaderboardEntry struct {
	...
	Matches []BroadcastTeamPOVMatchEntry `json:"matches"`
	// Players who have played for the team and their overall score
	Players []BroadcastPlayerEntry `json:"players"`
}

type _BroadcastTeamLeaderboardEntry BroadcastTeamLeaderboardEntry
...
func NewBroadcastTeamLeaderboardEntry(name string, mp float32, gp float32, matches []BroadcastTeamPOVMatchEntry, players []BroadcastPlayerEntry) *BroadcastTeamLeaderboardEntry {
	this := BroadcastTeamLeaderboardEntry{}
	this.Name = name
	this.Mp = mp
	this.Gp = gp
...
func (o *BroadcastTeamLeaderboardEntry) GetMatches() []BroadcastTeamPOVMatchEntry {
	if o == nil {
		var ret []BroadcastTeamPOVMatchEntry
		return ret
	}
...
func (o BroadcastTeamLeaderboardEntry) MarshalJSON() ([]byte, error) {
...
func (o BroadcastTeamLeaderboardEntry) ToMap() (map[string]interface{}, error) {
...
func (o *BroadcastTeamLeaderboardEntry) UnmarshalJSON(data []byte) (err error) {
	...
	varBroadcastTeamLeaderboardEntry := _BroadcastTeamLeaderboardEntry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBroadcastTeamLeaderboardEntry)

	if err != nil {
		return err
	}

	*o = BroadcastTeamLeaderboardEntry(varBroadcastTeamLeaderboardEntry)

	return err
}

type NullableBroadcastTeamLeaderboardEntry struct {
	value *BroadcastTeamLeaderboardEntry
	isSet bool
}

func (v NullableBroadcastTeamLeaderboardEntry) Get() *BroadcastTeamLeaderboardEntry {
	return v.value
}

func (v *NullableBroadcastTeamLeaderboardEntry) Set(val *BroadcastTeamLeaderboardEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastTeamLeaderboardEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastTeamLeaderboardEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastTeamLeaderboardEntry(val *BroadcastTeamLeaderboardEntry) *NullableBroadcastTeamLeaderboardEntry {
	return &NullableBroadcastTeamLeaderboardEntry{value: val, isSet: true}
}

func (v NullableBroadcastTeamLeaderboardEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastTeamLeaderboardEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true
