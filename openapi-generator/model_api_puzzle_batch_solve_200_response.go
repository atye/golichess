...
// checks if the ApiPuzzleBatchSolve200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiPuzzleBatchSolve200Response{}

// ApiPuzzleBatchSolve200Response struct for ApiPuzzleBatchSolve200Response
type ApiPuzzleBatchSolve200Response struct {
	Puzzles []ApiPuzzleId200Response `json:"puzzles,omitempty"`
	Glicko *ApiUserPerf200ResponsePerfGlicko `json:"glicko,omitempty"`
	Rounds []ApiPuzzleBatchSolve200ResponseRoundsInner `json:"rounds,omitempty"`
}
...
func NewApiPuzzleBatchSolve200Response() *ApiPuzzleBatchSolve200Response {
	this := ApiPuzzleBatchSolve200Response{}
	return &this
}
...
func (o *ApiPuzzleBatchSolve200Response) GetPuzzles() []ApiPuzzleId200Response {
	if o == nil || IsNil(o.Puzzles) {
		var ret []ApiPuzzleId200Response
		return ret
	}
	return o.Puzzles
}
...
// SetPuzzles gets a reference to the given []ApiPuzzleId200Response and assigns it to the Puzzles field.
...
func (o *ApiPuzzleBatchSolve200Response) GetRounds() []ApiPuzzleBatchSolve200ResponseRoundsInner {
	if o == nil || IsNil(o.Rounds) {
		var ret []ApiPuzzleBatchSolve200ResponseRoundsInner
		return ret
	}
	return o.Rounds
}
...
// SetRounds gets a reference to the given []ApiPuzzleBatchSolve200ResponseRoundsInner and assigns it to the Rounds field.
func (o *ApiPuzzleBatchSolve200Response) SetRounds(v []ApiPuzzleBatchSolve200ResponseRoundsInner) {
	o.Rounds = v
}

func (o ApiPuzzleBatchSolve200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiPuzzleBatchSolve200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiPuzzleBatchSolve200Response struct {
	value *ApiPuzzleBatchSolve200Response
	isSet bool
}

func (v NullableApiPuzzleBatchSolve200Response) Get() *ApiPuzzleBatchSolve200Response {
	return v.value
}

func (v *NullableApiPuzzleBatchSolve200Response) Set(val *ApiPuzzleBatchSolve200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiPuzzleBatchSolve200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiPuzzleBatchSolve200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiPuzzleBatchSolve200Response(val *ApiPuzzleBatchSolve200Response) *NullableApiPuzzleBatchSolve200Response {
	return &NullableApiPuzzleBatchSolve200Response{value: val, isSet: true}
}

func (v NullableApiPuzzleBatchSolve200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiPuzzleBatchSolve200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
