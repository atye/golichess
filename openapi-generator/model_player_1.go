...
// checks if the Player1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Player1{}

// Player1 struct for Player1
type Player1 struct {
	Id string `json:"id"`
...
type _Player1 Player1

// NewPlayer1 instantiates a new Player1 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPlayer1(id string, username string, rating int32) *Player1 {
	this := Player1{}
	this.Id = id
...
// NewPlayer1WithDefaults instantiates a new Player1 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPlayer1WithDefaults() *Player1 {
	this := Player1{}
	return &this
}

// GetId returns the Id field value
func (o *Player1) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *Player1) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *Player1) SetId(v string) {
	o.Id = v
}

// GetUsername returns the Username field value
func (o *Player1) GetUsername() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Player1) GetUsernameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Player1) SetUsername(v string) {
	o.Username = v
}

// GetRating returns the Rating field value
func (o *Player1) GetRating() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Player1) GetRatingOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *Player1) GetRatingDiffOk() (*int32, bool) {
	if o == nil || IsNil(o.RatingDiff) {
		return nil, false
	}
...
func (o *Player1) HasRatingDiff() bool {
	if o != nil && !IsNil(o.RatingDiff) {
		return true
	}
...
func (o *Player1) SetRatingDiff(v int32) {
	o.RatingDiff = &v
}

func (o Player1) MarshalJSON() ([]byte, error) {
...
func (o Player1) ToMap() (map[string]interface{}, error) {
...
func (o *Player1) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varPlayer1)

	if err != nil {
		return err
	}

	*o = Player1(varPlayer1)

	return err
}

type NullablePlayer1 struct {
	value *Player1
	isSet bool
}

func (v NullablePlayer1) Get() *Player1 {
	return v.value
}

func (v *NullablePlayer1) Set(val *Player1) {
	v.value = val
	v.isSet = true
}

func (v NullablePlayer1) IsSet() bool {
	return v.isSet
}

func (v *NullablePlayer1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlayer1(val *Player1) *NullablePlayer1 {
	return &NullablePlayer1{value: val, isSet: true}
}

func (v NullablePlayer1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlayer1) UnmarshalJSON(src []byte) error {
	v.isSet = true
