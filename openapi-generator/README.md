...
[Read about the Lichess API authentication methods and code examples](https://github.com/lichess-org/api-demo/blob/master/example/README.md)
...
- [NodeJS example](https://github.com/lichess-org/api-demo/tree/master/example/oauth-personal-token)
...
- [Minimal client-side example](https://github.com/lichess-org/api-demo/tree/master/example/oauth-app)
...
*BroadcastsAPI* | [**BroadcastStreamTourPgn**](docs/BroadcastsAPI.md#broadcaststreamtourpgn) | **Get** /api/stream/broadcast/tour/{broadcastTourId}.pgn | Stream ongoing broadcast rounds of a tournament as PGN
...
*GamesAPI* | [**BookmarkToggle**](docs/GamesAPI.md#bookmarktoggle) | **Post** /bookmark/{gameId} | Bookmark a game
*GamesAPI* | [**GameChatGet**](docs/GamesAPI.md#gamechatget) | **Get** /api/game/{gameId}/chat | Fetch the spectator game chat
...
*TeamsAPI* | [**TeamIdPmAll**](docs/TeamsAPI.md#teamidpmall) | **Post** /team/{teamId}/pm-all | Send a team update
...
*TeamsAPI* | [**TeamUpdates**](docs/TeamsAPI.md#teamupdates) | **Get** /team/updates | Get updates from your teams
*TeamsAPI* | [**TeamUpdatesByTeamId**](docs/TeamsAPI.md#teamupdatesbyteamid) | **Get** /team/updates/{teamId} | Get updates from one of your teams
...
## Documentation For Models
 ...
 - [AnonymousOpponent](docs/AnonymousOpponent.md)
 ...
 - [BulkPairingList200Response](docs/BulkPairingList200Response.md)
 ...
 - [GameJsonArenaTour](docs/GameJsonArenaTour.md)
 - [GameJsonClock](docs/GameJsonClock.md)
 - [GameJsonDivision](docs/GameJsonDivision.md)
 - [GameJsonSwissTour](docs/GameJsonSwissTour.md)
 ...
 - [GamePlayerAi](docs/GamePlayerAi.md)
 - [GamePlayerAiAnalysis](docs/GamePlayerAiAnalysis.md)
 - [GamePlayerUser](docs/GamePlayerUser.md)
 - [GamePlayerUserAnalysis](docs/GamePlayerUserAnalysis.md)
 - [GamePlayerUserAnalysisPhases](docs/GamePlayerUserAnalysisPhases.md)
 - [GamePlayers](docs/GamePlayers.md)
 - [GamePlayersWhite](docs/GamePlayersWhite.md)
 ...
 - [SpectatorGameChat](docs/SpectatorGameChat.md)
 - [SpectatorGameChatLinesInner](docs/SpectatorGameChatLinesInner.md)
 - [Speed](docs/Speed.md)
 ...
 - [TeamUpdateMsg](docs/TeamUpdateMsg.md)
 - [TeamUpdates](docs/TeamUpdates.md)
 - [TeamUpdatesByTeamInner](docs/TeamUpdatesByTeamInner.md)
 - [TeamUpdatesOfTeam](docs/TeamUpdatesOfTeam.md)
 - [TeamUpdatesPager](docs/TeamUpdatesPager.md)
...
- **Scopes**: 
 ...
 - **note:write**: Write notes on other players
