...
// checks if the ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId{}

// ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId struct for ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId
type ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId struct {
	Id string `json:"id"`
...
type _ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId
...
func NewApiUserPerf200ResponseStatWorstLossesResultsInnerOpId(id string, name string) *ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId {
	this := ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId) MarshalJSON() ([]byte, error) {
...
func (o ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId) ToMap() (map[string]interface{}, error) {
...
func (o *ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId) UnmarshalJSON(data []byte) (err error) {
	...
	varApiUserPerf200ResponseStatWorstLossesResultsInnerOpId := _ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiUserPerf200ResponseStatWorstLossesResultsInnerOpId)

	if err != nil {
		return err
	}

	*o = ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId(varApiUserPerf200ResponseStatWorstLossesResultsInnerOpId)

	return err
}

type NullableApiUserPerf200ResponseStatWorstLossesResultsInnerOpId struct {
	value *ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId
	isSet bool
}

func (v NullableApiUserPerf200ResponseStatWorstLossesResultsInnerOpId) Get() *ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId {
	return v.value
}

func (v *NullableApiUserPerf200ResponseStatWorstLossesResultsInnerOpId) Set(val *ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId) {
	v.value = val
	v.isSet = true
}

func (v NullableApiUserPerf200ResponseStatWorstLossesResultsInnerOpId) IsSet() bool {
	return v.isSet
}

func (v *NullableApiUserPerf200ResponseStatWorstLossesResultsInnerOpId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiUserPerf200ResponseStatWorstLossesResultsInnerOpId(val *ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId) *NullableApiUserPerf200ResponseStatWorstLossesResultsInnerOpId {
	return &NullableApiUserPerf200ResponseStatWorstLossesResultsInnerOpId{value: val, isSet: true}
}

func (v NullableApiUserPerf200ResponseStatWorstLossesResultsInnerOpId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiUserPerf200ResponseStatWorstLossesResultsInnerOpId) UnmarshalJSON(src []byte) error {
	v.isSet = true
