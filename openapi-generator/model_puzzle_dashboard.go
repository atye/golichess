...
// checks if the PuzzleDashboard type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PuzzleDashboard{}

// PuzzleDashboard struct for PuzzleDashboard
...
type _PuzzleDashboard PuzzleDashboard
...
func (o *PuzzleDashboard) GetThemes() map[string]PuzzleDashboardThemesValue {
	if o == nil {
		var ret map[string]PuzzleDashboardThemesValue
		return ret
	}
...
func (o *PuzzleDashboard) GetThemesOk() (map[string]PuzzleDashboardThemesValue, bool) {
	if o == nil {
		return map[string]PuzzleDashboardThemesValue{}, false
	}
...
func (o PuzzleDashboard) MarshalJSON() ([]byte, error) {
...
func (o PuzzleDashboard) ToMap() (map[string]interface{}, error) {
...
func (o *PuzzleDashboard) UnmarshalJSON(data []byte) (err error) {
	...
	varPuzzleDashboard := _PuzzleDashboard{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPuzzleDashboard)

	if err != nil {
		return err
	}

	*o = PuzzleDashboard(varPuzzleDashboard)

	return err
}

type NullablePuzzleDashboard struct {
	value *PuzzleDashboard
	isSet bool
}

func (v NullablePuzzleDashboard) Get() *PuzzleDashboard {
	return v.value
}

func (v *NullablePuzzleDashboard) Set(val *PuzzleDashboard) {
	v.value = val
	v.isSet = true
}

func (v NullablePuzzleDashboard) IsSet() bool {
	return v.isSet
}

func (v *NullablePuzzleDashboard) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePuzzleDashboard(val *PuzzleDashboard) *NullablePuzzleDashboard {
	return &NullablePuzzleDashboard{value: val, isSet: true}
}

func (v NullablePuzzleDashboard) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePuzzleDashboard) UnmarshalJSON(src []byte) error {
	v.isSet = true
