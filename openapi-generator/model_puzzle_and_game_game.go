...
// checks if the PuzzleAndGameGame type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PuzzleAndGameGame{}

// PuzzleAndGameGame struct for PuzzleAndGameGame
type PuzzleAndGameGame struct {
	Clock string `json:"clock"`
	Id string `json:"id"`
	Perf PuzzleAndGameGamePerf `json:"perf"`
	Pgn string `json:"pgn"`
	Players []PuzzleAndGameGamePlayersInner `json:"players"`
	Rated bool `json:"rated"`
}

type _PuzzleAndGameGame PuzzleAndGameGame
...
func (o *PuzzleAndGameGame) GetPlayers() []PuzzleAndGameGamePlayersInner {
	if o == nil {
		var ret []PuzzleAndGameGamePlayersInner
		return ret
	}
...
func (o PuzzleAndGameGame) MarshalJSON() ([]byte, error) {
...
func (o PuzzleAndGameGame) ToMap() (map[string]interface{}, error) {
...
func (o *PuzzleAndGameGame) UnmarshalJSON(data []byte) (err error) {
	...
	varPuzzleAndGameGame := _PuzzleAndGameGame{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPuzzleAndGameGame)

	if err != nil {
		return err
	}

	*o = PuzzleAndGameGame(varPuzzleAndGameGame)

	return err
}

type NullablePuzzleAndGameGame struct {
	value *PuzzleAndGameGame
	isSet bool
}

func (v NullablePuzzleAndGameGame) Get() *PuzzleAndGameGame {
	return v.value
}

func (v *NullablePuzzleAndGameGame) Set(val *PuzzleAndGameGame) {
	v.value = val
	v.isSet = true
}

func (v NullablePuzzleAndGameGame) IsSet() bool {
	return v.isSet
}

func (v *NullablePuzzleAndGameGame) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePuzzleAndGameGame(val *PuzzleAndGameGame) *NullablePuzzleAndGameGame {
	return &NullablePuzzleAndGameGame{value: val, isSet: true}
}

func (v NullablePuzzleAndGameGame) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePuzzleAndGameGame) UnmarshalJSON(src []byte) error {
	v.isSet = true
