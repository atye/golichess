...
type BulkPairing struct {
	...
	StartClocksAt NullableInt32 `json:"startClocksAt"`
...
func (o *BulkPairing) GetStartClocksAt() int32 {
	if o == nil || o.StartClocksAt.Get() == nil {
		var ret int32
		return ret
	}

	return *o.StartClocksAt.Get()
}
...
func (o BulkPairing) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["startClocksAt"] = o.StartClocksAt.Get()
