...
// checks if the ChallengeDeclinedJson type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChallengeDeclinedJson{}

// ChallengeDeclinedJson struct for ChallengeDeclinedJson
...
type _ChallengeDeclinedJson ChallengeDeclinedJson
...
func (o ChallengeDeclinedJson) MarshalJSON() ([]byte, error) {
...
func (o ChallengeDeclinedJson) ToMap() (map[string]interface{}, error) {
...
func (o *ChallengeDeclinedJson) UnmarshalJSON(data []byte) (err error) {
	...
	varChallengeDeclinedJson := _ChallengeDeclinedJson{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChallengeDeclinedJson)

	if err != nil {
		return err
	}

	*o = ChallengeDeclinedJson(varChallengeDeclinedJson)

	return err
}

type NullableChallengeDeclinedJson struct {
	value *ChallengeDeclinedJson
	isSet bool
}

func (v NullableChallengeDeclinedJson) Get() *ChallengeDeclinedJson {
	return v.value
}

func (v *NullableChallengeDeclinedJson) Set(val *ChallengeDeclinedJson) {
	v.value = val
	v.isSet = true
}

func (v NullableChallengeDeclinedJson) IsSet() bool {
	return v.isSet
}

func (v *NullableChallengeDeclinedJson) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChallengeDeclinedJson(val *ChallengeDeclinedJson) *NullableChallengeDeclinedJson {
	return &NullableChallengeDeclinedJson{value: val, isSet: true}
}

func (v NullableChallengeDeclinedJson) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChallengeDeclinedJson) UnmarshalJSON(src []byte) error {
	v.isSet = true
