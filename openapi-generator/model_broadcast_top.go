...
// checks if the BroadcastTop type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastTop{}

// BroadcastTop struct for BroadcastTop
...
// SetActive gets a reference to the given []BroadcastWithLastRound and assigns it to the Active field.
...
// SetUpcoming gets a reference to the given []BroadcastWithLastRound and assigns it to the Upcoming field.
// Deprecated
...
// SetPast gets a reference to the given BroadcastTopPast and assigns it to the Past field.
func (o *BroadcastTop) SetPast(v BroadcastTopPast) {
	o.Past = &v
}

func (o BroadcastTop) MarshalJSON() ([]byte, error) {
...
func (o BroadcastTop) ToMap() (map[string]interface{}, error) {
...
type NullableBroadcastTop struct {
	value *BroadcastTop
	isSet bool
}

func (v NullableBroadcastTop) Get() *BroadcastTop {
	return v.value
}

func (v *NullableBroadcastTop) Set(val *BroadcastTop) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastTop) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastTop) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastTop(val *BroadcastTop) *NullableBroadcastTop {
	return &NullableBroadcastTop{value: val, isSet: true}
}

func (v NullableBroadcastTop) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastTop) UnmarshalJSON(src []byte) error {
	v.isSet = true
