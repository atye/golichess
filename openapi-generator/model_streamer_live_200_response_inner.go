...
// checks if the StreamerLive200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StreamerLive200ResponseInner{}

// StreamerLive200ResponseInner struct for StreamerLive200ResponseInner
type StreamerLive200ResponseInner struct {
	Id string `json:"id"`
	...
	Stream *StreamerLive200ResponseInnerAllOfStream `json:"stream,omitempty"`
	Streamer *StreamerLive200ResponseInnerAllOfStreamer `json:"streamer,omitempty"`
}

type _StreamerLive200ResponseInner StreamerLive200ResponseInner
...
func NewStreamerLive200ResponseInner(id string, name string) *StreamerLive200ResponseInner {
	this := StreamerLive200ResponseInner{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o *StreamerLive200ResponseInner) GetStream() StreamerLive200ResponseInnerAllOfStream {
	if o == nil || IsNil(o.Stream) {
		var ret StreamerLive200ResponseInnerAllOfStream
		return ret
	}
	return *o.Stream
}
...
// SetStream gets a reference to the given StreamerLive200ResponseInnerAllOfStream and assigns it to the Stream field.
...
func (o *StreamerLive200ResponseInner) GetStreamer() StreamerLive200ResponseInnerAllOfStreamer {
	if o == nil || IsNil(o.Streamer) {
		var ret StreamerLive200ResponseInnerAllOfStreamer
		return ret
	}
	return *o.Streamer
}
...
// SetStreamer gets a reference to the given StreamerLive200ResponseInnerAllOfStreamer and assigns it to the Streamer field.
func (o *StreamerLive200ResponseInner) SetStreamer(v StreamerLive200ResponseInnerAllOfStreamer) {
	o.Streamer = &v
}

func (o StreamerLive200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o StreamerLive200ResponseInner) ToMap() (map[string]interface{}, error) {
...
func (o *StreamerLive200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	varStreamerLive200ResponseInner := _StreamerLive200ResponseInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStreamerLive200ResponseInner)

	if err != nil {
		return err
	}

	*o = StreamerLive200ResponseInner(varStreamerLive200ResponseInner)

	return err
}

type NullableStreamerLive200ResponseInner struct {
	value *StreamerLive200ResponseInner
	isSet bool
}

func (v NullableStreamerLive200ResponseInner) Get() *StreamerLive200ResponseInner {
	return v.value
}

func (v *NullableStreamerLive200ResponseInner) Set(val *StreamerLive200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableStreamerLive200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableStreamerLive200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStreamerLive200ResponseInner(val *StreamerLive200ResponseInner) *NullableStreamerLive200ResponseInner {
	return &NullableStreamerLive200ResponseInner{value: val, isSet: true}
}

func (v NullableStreamerLive200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStreamerLive200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
