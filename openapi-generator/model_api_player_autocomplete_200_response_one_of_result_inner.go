...
// checks if the ApiPlayerAutocomplete200ResponseOneOfResultInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiPlayerAutocomplete200ResponseOneOfResultInner{}

// ApiPlayerAutocomplete200ResponseOneOfResultInner struct for ApiPlayerAutocomplete200ResponseOneOfResultInner
type ApiPlayerAutocomplete200ResponseOneOfResultInner struct {
	Id string `json:"id"`
...
type _ApiPlayerAutocomplete200ResponseOneOfResultInner ApiPlayerAutocomplete200ResponseOneOfResultInner
...
func NewApiPlayerAutocomplete200ResponseOneOfResultInner(id string, name string) *ApiPlayerAutocomplete200ResponseOneOfResultInner {
	this := ApiPlayerAutocomplete200ResponseOneOfResultInner{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o ApiPlayerAutocomplete200ResponseOneOfResultInner) MarshalJSON() ([]byte, error) {
...
func (o ApiPlayerAutocomplete200ResponseOneOfResultInner) ToMap() (map[string]interface{}, error) {
...
func (o *ApiPlayerAutocomplete200ResponseOneOfResultInner) UnmarshalJSON(data []byte) (err error) {
	...
	varApiPlayerAutocomplete200ResponseOneOfResultInner := _ApiPlayerAutocomplete200ResponseOneOfResultInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiPlayerAutocomplete200ResponseOneOfResultInner)

	if err != nil {
		return err
	}

	*o = ApiPlayerAutocomplete200ResponseOneOfResultInner(varApiPlayerAutocomplete200ResponseOneOfResultInner)

	return err
}

type NullableApiPlayerAutocomplete200ResponseOneOfResultInner struct {
	value *ApiPlayerAutocomplete200ResponseOneOfResultInner
	isSet bool
}

func (v NullableApiPlayerAutocomplete200ResponseOneOfResultInner) Get() *ApiPlayerAutocomplete200ResponseOneOfResultInner {
	return v.value
}

func (v *NullableApiPlayerAutocomplete200ResponseOneOfResultInner) Set(val *ApiPlayerAutocomplete200ResponseOneOfResultInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiPlayerAutocomplete200ResponseOneOfResultInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiPlayerAutocomplete200ResponseOneOfResultInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiPlayerAutocomplete200ResponseOneOfResultInner(val *ApiPlayerAutocomplete200ResponseOneOfResultInner) *NullableApiPlayerAutocomplete200ResponseOneOfResultInner {
	return &NullableApiPlayerAutocomplete200ResponseOneOfResultInner{value: val, isSet: true}
}

func (v NullableApiPlayerAutocomplete200ResponseOneOfResultInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiPlayerAutocomplete200ResponseOneOfResultInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
