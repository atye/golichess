...
// checks if the ExternalEngineWorkOneOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalEngineWorkOneOf1{}

// ExternalEngineWorkOneOf1 struct for ExternalEngineWorkOneOf1
type ExternalEngineWorkOneOf1 struct {
...
type _ExternalEngineWorkOneOf1 ExternalEngineWorkOneOf1
...
func (o ExternalEngineWorkOneOf1) MarshalJSON() ([]byte, error) {
...
func (o ExternalEngineWorkOneOf1) ToMap() (map[string]interface{}, error) {
...
func (o *ExternalEngineWorkOneOf1) UnmarshalJSON(data []byte) (err error) {
	...
	varExternalEngineWorkOneOf1 := _ExternalEngineWorkOneOf1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExternalEngineWorkOneOf1)

	if err != nil {
		return err
	}

	*o = ExternalEngineWorkOneOf1(varExternalEngineWorkOneOf1)

	return err
}

type NullableExternalEngineWorkOneOf1 struct {
	value *ExternalEngineWorkOneOf1
	isSet bool
}

func (v NullableExternalEngineWorkOneOf1) Get() *ExternalEngineWorkOneOf1 {
	return v.value
}

func (v *NullableExternalEngineWorkOneOf1) Set(val *ExternalEngineWorkOneOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalEngineWorkOneOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalEngineWorkOneOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalEngineWorkOneOf1(val *ExternalEngineWorkOneOf1) *NullableExternalEngineWorkOneOf1 {
	return &NullableExternalEngineWorkOneOf1{value: val, isSet: true}
}

func (v NullableExternalEngineWorkOneOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalEngineWorkOneOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
