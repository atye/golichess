...
// checks if the SwissUnauthorisedEdit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SwissUnauthorisedEdit{}
...
func (o *SwissUnauthorisedEdit) GetError() string {
...
func (o *SwissUnauthorisedEdit) GetErrorOk() (*string, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *SwissUnauthorisedEdit) SetError(v string) {
	o.Error = &v
}
...
func (o SwissUnauthorisedEdit) ToMap() (map[string]interface{}, error) {
