...
// checks if the FeaturedPlayersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeaturedPlayersInner{}
...
type _FeaturedPlayersInner FeaturedPlayersInner
...
func (o FeaturedPlayersInner) MarshalJSON() ([]byte, error) {
...
func (o *FeaturedPlayersInner) UnmarshalJSON(data []byte) (err error) {
	...
	varFeaturedPlayersInner := _FeaturedPlayersInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFeaturedPlayersInner)

	if err != nil {
		return err
	}

	*o = FeaturedPlayersInner(varFeaturedPlayersInner)

	return err
}

type NullableFeaturedPlayersInner struct {
	value *FeaturedPlayersInner
	isSet bool
}

func (v NullableFeaturedPlayersInner) Get() *FeaturedPlayersInner {
	return v.value
}

func (v *NullableFeaturedPlayersInner) Set(val *FeaturedPlayersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFeaturedPlayersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFeaturedPlayersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeaturedPlayersInner(val *FeaturedPlayersInner) *NullableFeaturedPlayersInner {
	return &NullableFeaturedPlayersInner{value: val, isSet: true}
}

func (v NullableFeaturedPlayersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeaturedPlayersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
