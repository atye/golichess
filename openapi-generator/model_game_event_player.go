...
// checks if the GameEventPlayer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameEventPlayer{}
...
type _GameEventPlayer GameEventPlayer
...
func (o *GameEventPlayer) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o GameEventPlayer) ToMap() (map[string]interface{}, error) {
...
func (o *GameEventPlayer) UnmarshalJSON(data []byte) (err error) {
	...
	varGameEventPlayer := _GameEventPlayer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameEventPlayer)

	if err != nil {
		return err
	}

	*o = GameEventPlayer(varGameEventPlayer)
