...
// checks if the BroadcastRoundGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastRoundGet200Response{}

// BroadcastRoundGet200Response struct for BroadcastRoundGet200Response
type BroadcastRoundGet200Response struct {
	...
	Games []BroadcastRoundGet200ResponseGamesInner `json:"games"`
...
type _BroadcastRoundGet200Response BroadcastRoundGet200Response
...
func NewBroadcastRoundGet200Response(round BroadcastsOfficial200ResponseRoundsInner, tour BroadcastsOfficial200ResponseTour, study BroadcastRoundCreate200ResponseStudy, games []BroadcastRoundGet200ResponseGamesInner, photos map[string]BroadcastsOfficial200ResponsePhotosValue) *BroadcastRoundGet200Response {
	this := BroadcastRoundGet200Response{}
	this.Round = round
	this.Tour = tour
	this.Study = study
	this.Games = games
...
func (o *BroadcastRoundGet200Response) GetGames() []BroadcastRoundGet200ResponseGamesInner {
	if o == nil {
		var ret []BroadcastRoundGet200ResponseGamesInner
		return ret
	}
...
func (o *BroadcastRoundGet200Response) GetGroup() BroadcastTourGet200ResponseGroup {
...
// and a boolean to check if the value has been set.
func (o *BroadcastRoundGet200Response) GetGroupOk() (*BroadcastTourGet200ResponseGroup, bool) {
	if o == nil || IsNil(o.Group) {
		return nil, false
	}
	return o.Group, true
...
func (o *BroadcastRoundGet200Response) SetGroup(v BroadcastTourGet200ResponseGroup) {
	o.Group = &v
}
...
func (o BroadcastRoundGet200Response) MarshalJSON() ([]byte, error) {
...
func (o BroadcastRoundGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *BroadcastRoundGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varBroadcastRoundGet200Response := _BroadcastRoundGet200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBroadcastRoundGet200Response)

	if err != nil {
		return err
	}

	*o = BroadcastRoundGet200Response(varBroadcastRoundGet200Response)

	return err
}

type NullableBroadcastRoundGet200Response struct {
	value *BroadcastRoundGet200Response
	isSet bool
}

func (v NullableBroadcastRoundGet200Response) Get() *BroadcastRoundGet200Response {
	return v.value
}

func (v *NullableBroadcastRoundGet200Response) Set(val *BroadcastRoundGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastRoundGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastRoundGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastRoundGet200Response(val *BroadcastRoundGet200Response) *NullableBroadcastRoundGet200Response {
	return &NullableBroadcastRoundGet200Response{value: val, isSet: true}
}

func (v NullableBroadcastRoundGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastRoundGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
