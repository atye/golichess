...
// checks if the OpeningExplorerLichessGame type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerLichessGame{}

// OpeningExplorerLichessGame struct for OpeningExplorerLichessGame
type OpeningExplorerLichessGame struct {
	Id string `json:"id"`
	Winner NullableGameColor `json:"winner"`
...
type _OpeningExplorerLichessGame OpeningExplorerLichessGame
...
func NewOpeningExplorerLichessGame(id string, winner NullableGameColor, white OpeningExplorerGamePlayer, black OpeningExplorerGamePlayer, year float32, month NullableString) *OpeningExplorerLichessGame {
	this := OpeningExplorerLichessGame{}
	this.Id = id
	this.Winner = winner
	this.White = white
	this.Black = black
...
// If the value is explicit nil, the zero value for GameColor will be returned
...
func (o OpeningExplorerLichessGame) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerLichessGame) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerLichessGame) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerLichessGame := _OpeningExplorerLichessGame{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerLichessGame)

	if err != nil {
		return err
	}

	*o = OpeningExplorerLichessGame(varOpeningExplorerLichessGame)

	return err
}

type NullableOpeningExplorerLichessGame struct {
	value *OpeningExplorerLichessGame
	isSet bool
}

func (v NullableOpeningExplorerLichessGame) Get() *OpeningExplorerLichessGame {
	return v.value
}

func (v *NullableOpeningExplorerLichessGame) Set(val *OpeningExplorerLichessGame) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerLichessGame) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerLichessGame) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerLichessGame(val *OpeningExplorerLichessGame) *NullableOpeningExplorerLichessGame {
	return &NullableOpeningExplorerLichessGame{value: val, isSet: true}
}

func (v NullableOpeningExplorerLichessGame) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerLichessGame) UnmarshalJSON(src []byte) error {
	v.isSet = true
