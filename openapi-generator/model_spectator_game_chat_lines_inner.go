...
// checks if the SpectatorGameChatLinesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpectatorGameChatLinesInner{}

// SpectatorGameChatLinesInner struct for SpectatorGameChatLinesInner
type SpectatorGameChatLinesInner struct {
	Text string `json:"text"`
	User string `json:"user"`
}

type _SpectatorGameChatLinesInner SpectatorGameChatLinesInner
...
func NewSpectatorGameChatLinesInner(text string, user string) *SpectatorGameChatLinesInner {
	this := SpectatorGameChatLinesInner{}
	this.Text = text
	this.User = user
	return &this
}
...
func (o SpectatorGameChatLinesInner) MarshalJSON() ([]byte, error) {
...
func (o SpectatorGameChatLinesInner) ToMap() (map[string]interface{}, error) {
...
func (o *SpectatorGameChatLinesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varSpectatorGameChatLinesInner := _SpectatorGameChatLinesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSpectatorGameChatLinesInner)

	if err != nil {
		return err
	}

	*o = SpectatorGameChatLinesInner(varSpectatorGameChatLinesInner)

	return err
}

type NullableSpectatorGameChatLinesInner struct {
	value *SpectatorGameChatLinesInner
	isSet bool
}

func (v NullableSpectatorGameChatLinesInner) Get() *SpectatorGameChatLinesInner {
	return v.value
}

func (v *NullableSpectatorGameChatLinesInner) Set(val *SpectatorGameChatLinesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSpectatorGameChatLinesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSpectatorGameChatLinesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpectatorGameChatLinesInner(val *SpectatorGameChatLinesInner) *NullableSpectatorGameChatLinesInner {
	return &NullableSpectatorGameChatLinesInner{value: val, isSet: true}
}

func (v NullableSpectatorGameChatLinesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpectatorGameChatLinesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
