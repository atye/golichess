...
// checks if the BroadcastGameEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastGameEntry{}

// BroadcastGameEntry struct for BroadcastGameEntry
...
type _BroadcastGameEntry BroadcastGameEntry
...
func (o *BroadcastGameEntry) GetOpponent() BroadcastPlayerWithFed {
	if o == nil {
		var ret BroadcastPlayerWithFed
		return ret
	}
...
func (o BroadcastGameEntry) MarshalJSON() ([]byte, error) {
...
func (o BroadcastGameEntry) ToMap() (map[string]interface{}, error) {
...
func (o *BroadcastGameEntry) UnmarshalJSON(data []byte) (err error) {
	...
	varBroadcastGameEntry := _BroadcastGameEntry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBroadcastGameEntry)

	if err != nil {
		return err
	}

	*o = BroadcastGameEntry(varBroadcastGameEntry)

	return err
}

type NullableBroadcastGameEntry struct {
	value *BroadcastGameEntry
	isSet bool
}

func (v NullableBroadcastGameEntry) Get() *BroadcastGameEntry {
	return v.value
}

func (v *NullableBroadcastGameEntry) Set(val *BroadcastGameEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastGameEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastGameEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastGameEntry(val *BroadcastGameEntry) *NullableBroadcastGameEntry {
	return &NullableBroadcastGameEntry{value: val, isSet: true}
}

func (v NullableBroadcastGameEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastGameEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true
