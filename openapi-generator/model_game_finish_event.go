...
// checks if the GameFinishEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameFinishEvent{}
...
type _GameFinishEvent GameFinishEvent

// NewGameFinishEvent instantiates a new GameFinishEvent object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGameFinishEvent(type_ string, game GameEventInfo) *GameFinishEvent {
...
func (o *GameFinishEvent) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *GameFinishEvent) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *GameFinishEvent) SetType(v string) {
	o.Type = v
}
...
func (o GameFinishEvent) ToMap() (map[string]interface{}, error) {
...
func (o *GameFinishEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varGameFinishEvent := _GameFinishEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameFinishEvent)

	if err != nil {
		return err
	}

	*o = GameFinishEvent(varGameFinishEvent)
