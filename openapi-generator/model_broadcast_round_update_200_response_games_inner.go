...
// checks if the BroadcastRoundUpdate200ResponseGamesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastRoundUpdate200ResponseGamesInner{}

// BroadcastRoundUpdate200ResponseGamesInner struct for BroadcastRoundUpdate200ResponseGamesInner
type BroadcastRoundUpdate200ResponseGamesInner struct {
	Id string `json:"id"`
	Name string `json:"name"`
	Fen *string `json:"fen,omitempty"`
	Players []BroadcastRoundUpdate200ResponseGamesInnerPlayersInner `json:"players,omitempty"`
...
type _BroadcastRoundUpdate200ResponseGamesInner BroadcastRoundUpdate200ResponseGamesInner
...
func NewBroadcastRoundUpdate200ResponseGamesInner(id string, name string) *BroadcastRoundUpdate200ResponseGamesInner {
	this := BroadcastRoundUpdate200ResponseGamesInner{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o *BroadcastRoundUpdate200ResponseGamesInner) GetPlayers() []BroadcastRoundUpdate200ResponseGamesInnerPlayersInner {
	if o == nil || IsNil(o.Players) {
		var ret []BroadcastRoundUpdate200ResponseGamesInnerPlayersInner
		return ret
	}
	return o.Players
}
...
// SetPlayers gets a reference to the given []BroadcastRoundUpdate200ResponseGamesInnerPlayersInner and assigns it to the Players field.
...
func (o BroadcastRoundUpdate200ResponseGamesInner) MarshalJSON() ([]byte, error) {
...
func (o BroadcastRoundUpdate200ResponseGamesInner) ToMap() (map[string]interface{}, error) {
...
func (o *BroadcastRoundUpdate200ResponseGamesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varBroadcastRoundUpdate200ResponseGamesInner := _BroadcastRoundUpdate200ResponseGamesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBroadcastRoundUpdate200ResponseGamesInner)

	if err != nil {
		return err
	}

	*o = BroadcastRoundUpdate200ResponseGamesInner(varBroadcastRoundUpdate200ResponseGamesInner)

	return err
}

type NullableBroadcastRoundUpdate200ResponseGamesInner struct {
	value *BroadcastRoundUpdate200ResponseGamesInner
	isSet bool
}

func (v NullableBroadcastRoundUpdate200ResponseGamesInner) Get() *BroadcastRoundUpdate200ResponseGamesInner {
	return v.value
}

func (v *NullableBroadcastRoundUpdate200ResponseGamesInner) Set(val *BroadcastRoundUpdate200ResponseGamesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastRoundUpdate200ResponseGamesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastRoundUpdate200ResponseGamesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastRoundUpdate200ResponseGamesInner(val *BroadcastRoundUpdate200ResponseGamesInner) *NullableBroadcastRoundUpdate200ResponseGamesInner {
	return &NullableBroadcastRoundUpdate200ResponseGamesInner{value: val, isSet: true}
}

func (v NullableBroadcastRoundUpdate200ResponseGamesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastRoundUpdate200ResponseGamesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
