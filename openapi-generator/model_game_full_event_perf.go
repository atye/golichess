...
// checks if the GameFullEventPerf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GameFullEventPerf{}
...
func (o *GameFullEventPerf) GetName() string {
...
func (o *GameFullEventPerf) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *GameFullEventPerf) SetName(v string) {
	o.Name = &v
}
...
func (o GameFullEventPerf) ToMap() (map[string]interface{}, error) {
