...
// checks if the UserStreamer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserStreamer{}

// UserStreamer struct for UserStreamer
type UserStreamer struct {
	Twitch *UserStreamerTwitch `json:"twitch,omitempty"`
	Youtube *UserStreamerYoutube `json:"youtube,omitempty"`
}
...
// SetTwitch gets a reference to the given UserStreamerTwitch and assigns it to the Twitch field.
...
// SetYoutube gets a reference to the given UserStreamerYoutube and assigns it to the Youtube field.
func (o *UserStreamer) SetYoutube(v UserStreamerYoutube) {
	o.Youtube = &v
}

func (o UserStreamer) MarshalJSON() ([]byte, error) {
...
func (o UserStreamer) ToMap() (map[string]interface{}, error) {
...
type NullableUserStreamer struct {
	value *UserStreamer
	isSet bool
}

func (v NullableUserStreamer) Get() *UserStreamer {
	return v.value
}

func (v *NullableUserStreamer) Set(val *UserStreamer) {
	v.value = val
	v.isSet = true
}

func (v NullableUserStreamer) IsSet() bool {
	return v.isSet
}

func (v *NullableUserStreamer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserStreamer(val *UserStreamer) *NullableUserStreamer {
	return &NullableUserStreamer{value: val, isSet: true}
}

func (v NullableUserStreamer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserStreamer) UnmarshalJSON(src []byte) error {
	v.isSet = true
