...
// checks if the PuzzleBatchSelect type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PuzzleBatchSelect{}

// PuzzleBatchSelect struct for PuzzleBatchSelect
...
func (o PuzzleBatchSelect) MarshalJSON() ([]byte, error) {
...
func (o PuzzleBatchSelect) ToMap() (map[string]interface{}, error) {
...
type NullablePuzzleBatchSelect struct {
	value *PuzzleBatchSelect
	isSet bool
}

func (v NullablePuzzleBatchSelect) Get() *PuzzleBatchSelect {
	return v.value
}

func (v *NullablePuzzleBatchSelect) Set(val *PuzzleBatchSelect) {
	v.value = val
	v.isSet = true
}

func (v NullablePuzzleBatchSelect) IsSet() bool {
	return v.isSet
}

func (v *NullablePuzzleBatchSelect) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePuzzleBatchSelect(val *PuzzleBatchSelect) *NullablePuzzleBatchSelect {
	return &NullablePuzzleBatchSelect{value: val, isSet: true}
}

func (v NullablePuzzleBatchSelect) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePuzzleBatchSelect) UnmarshalJSON(src []byte) error {
	v.isSet = true
