...
// checks if the StudyImportPgnChapters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StudyImportPgnChapters{}

// StudyImportPgnChapters struct for StudyImportPgnChapters
type StudyImportPgnChapters struct {
	Chapters []StudyImportPgnChaptersChaptersInner `json:"chapters,omitempty"`
...
func (o *StudyImportPgnChapters) GetChapters() []StudyImportPgnChaptersChaptersInner {
	if o == nil || IsNil(o.Chapters) {
		var ret []StudyImportPgnChaptersChaptersInner
		return ret
	}
	return o.Chapters
}
...
// SetChapters gets a reference to the given []StudyImportPgnChaptersChaptersInner and assigns it to the Chapters field.
...
func (o *StudyImportPgnChapters) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o StudyImportPgnChapters) MarshalJSON() ([]byte, error) {
...
func (o StudyImportPgnChapters) ToMap() (map[string]interface{}, error) {
...
type NullableStudyImportPgnChapters struct {
	value *StudyImportPgnChapters
	isSet bool
}

func (v NullableStudyImportPgnChapters) Get() *StudyImportPgnChapters {
	return v.value
}

func (v *NullableStudyImportPgnChapters) Set(val *StudyImportPgnChapters) {
	v.value = val
	v.isSet = true
}

func (v NullableStudyImportPgnChapters) IsSet() bool {
	return v.isSet
}

func (v *NullableStudyImportPgnChapters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStudyImportPgnChapters(val *StudyImportPgnChapters) *NullableStudyImportPgnChapters {
	return &NullableStudyImportPgnChapters{value: val, isSet: true}
}

func (v NullableStudyImportPgnChapters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStudyImportPgnChapters) UnmarshalJSON(src []byte) error {
	v.isSet = true
