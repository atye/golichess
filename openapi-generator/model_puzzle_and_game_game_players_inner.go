...
// checks if the PuzzleAndGameGamePlayersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PuzzleAndGameGamePlayersInner{}

// PuzzleAndGameGamePlayersInner struct for PuzzleAndGameGamePlayersInner
type PuzzleAndGameGamePlayersInner struct {
...
type _PuzzleAndGameGamePlayersInner PuzzleAndGameGamePlayersInner
...
func NewPuzzleAndGameGamePlayersInner(color GameColor, id string, name string, rating int32) *PuzzleAndGameGamePlayersInner {
	this := PuzzleAndGameGamePlayersInner{}
	this.Color = color
	this.Id = id
	this.Name = name
	this.Rating = rating
...
func (o PuzzleAndGameGamePlayersInner) MarshalJSON() ([]byte, error) {
...
func (o PuzzleAndGameGamePlayersInner) ToMap() (map[string]interface{}, error) {
...
func (o *PuzzleAndGameGamePlayersInner) UnmarshalJSON(data []byte) (err error) {
	...
	varPuzzleAndGameGamePlayersInner := _PuzzleAndGameGamePlayersInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPuzzleAndGameGamePlayersInner)

	if err != nil {
		return err
	}

	*o = PuzzleAndGameGamePlayersInner(varPuzzleAndGameGamePlayersInner)

	return err
}

type NullablePuzzleAndGameGamePlayersInner struct {
	value *PuzzleAndGameGamePlayersInner
	isSet bool
}

func (v NullablePuzzleAndGameGamePlayersInner) Get() *PuzzleAndGameGamePlayersInner {
	return v.value
}

func (v *NullablePuzzleAndGameGamePlayersInner) Set(val *PuzzleAndGameGamePlayersInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePuzzleAndGameGamePlayersInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePuzzleAndGameGamePlayersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePuzzleAndGameGamePlayersInner(val *PuzzleAndGameGamePlayersInner) *NullablePuzzleAndGameGamePlayersInner {
	return &NullablePuzzleAndGameGamePlayersInner{value: val, isSet: true}
}

func (v NullablePuzzleAndGameGamePlayersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePuzzleAndGameGamePlayersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
