...
// checks if the GamePlayers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GamePlayers{}

// GamePlayers struct for GamePlayers
type GamePlayers struct {
	White GamePlayersWhite `json:"white"`
	Black GamePlayersWhite `json:"black"`
}

type _GamePlayers GamePlayers
...
func (o GamePlayers) MarshalJSON() ([]byte, error) {
...
func (o GamePlayers) ToMap() (map[string]interface{}, error) {
...
func (o *GamePlayers) UnmarshalJSON(data []byte) (err error) {
	...
	varGamePlayers := _GamePlayers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGamePlayers)

	if err != nil {
		return err
	}

	*o = GamePlayers(varGamePlayers)

	return err
}

type NullableGamePlayers struct {
	value *GamePlayers
	isSet bool
}

func (v NullableGamePlayers) Get() *GamePlayers {
	return v.value
}

func (v *NullableGamePlayers) Set(val *GamePlayers) {
	v.value = val
	v.isSet = true
}

func (v NullableGamePlayers) IsSet() bool {
	return v.isSet
}

func (v *NullableGamePlayers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGamePlayers(val *GamePlayers) *NullableGamePlayers {
	return &NullableGamePlayers{value: val, isSet: true}
}

func (v NullableGamePlayers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGamePlayers) UnmarshalJSON(src []byte) error {
	v.isSet = true
