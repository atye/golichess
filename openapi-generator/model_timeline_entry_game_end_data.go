...
// checks if the TimelineEntryGameEndData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimelineEntryGameEndData{}

// TimelineEntryGameEndData struct for TimelineEntryGameEndData
...
type _TimelineEntryGameEndData TimelineEntryGameEndData
...
func (o TimelineEntryGameEndData) MarshalJSON() ([]byte, error) {
...
func (o TimelineEntryGameEndData) ToMap() (map[string]interface{}, error) {
...
func (o *TimelineEntryGameEndData) UnmarshalJSON(data []byte) (err error) {
	...
	varTimelineEntryGameEndData := _TimelineEntryGameEndData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTimelineEntryGameEndData)

	if err != nil {
		return err
	}

	*o = TimelineEntryGameEndData(varTimelineEntryGameEndData)

	return err
}

type NullableTimelineEntryGameEndData struct {
	value *TimelineEntryGameEndData
	isSet bool
}

func (v NullableTimelineEntryGameEndData) Get() *TimelineEntryGameEndData {
	return v.value
}

func (v *NullableTimelineEntryGameEndData) Set(val *TimelineEntryGameEndData) {
	v.value = val
	v.isSet = true
}

func (v NullableTimelineEntryGameEndData) IsSet() bool {
	return v.isSet
}

func (v *NullableTimelineEntryGameEndData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimelineEntryGameEndData(val *TimelineEntryGameEndData) *NullableTimelineEntryGameEndData {
	return &NullableTimelineEntryGameEndData{value: val, isSet: true}
}

func (v NullableTimelineEntryGameEndData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimelineEntryGameEndData) UnmarshalJSON(src []byte) error {
	v.isSet = true
