...
// checks if the OpponentGoneEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpponentGoneEvent{}

// OpponentGoneEvent struct for OpponentGoneEvent
...
type _OpponentGoneEvent OpponentGoneEvent
...
func (o OpponentGoneEvent) MarshalJSON() ([]byte, error) {
...
func (o OpponentGoneEvent) ToMap() (map[string]interface{}, error) {
...
func (o *OpponentGoneEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varOpponentGoneEvent := _OpponentGoneEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpponentGoneEvent)

	if err != nil {
		return err
	}

	*o = OpponentGoneEvent(varOpponentGoneEvent)

	return err
}

type NullableOpponentGoneEvent struct {
	value *OpponentGoneEvent
	isSet bool
}

func (v NullableOpponentGoneEvent) Get() *OpponentGoneEvent {
	return v.value
}

func (v *NullableOpponentGoneEvent) Set(val *OpponentGoneEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableOpponentGoneEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableOpponentGoneEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpponentGoneEvent(val *OpponentGoneEvent) *NullableOpponentGoneEvent {
	return &NullableOpponentGoneEvent{value: val, isSet: true}
}

func (v NullableOpponentGoneEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpponentGoneEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
