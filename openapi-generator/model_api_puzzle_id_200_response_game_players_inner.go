...
// checks if the ApiPuzzleId200ResponseGamePlayersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiPuzzleId200ResponseGamePlayersInner{}

// ApiPuzzleId200ResponseGamePlayersInner struct for ApiPuzzleId200ResponseGamePlayersInner
type ApiPuzzleId200ResponseGamePlayersInner struct {
...
type _ApiPuzzleId200ResponseGamePlayersInner ApiPuzzleId200ResponseGamePlayersInner
...
func NewApiPuzzleId200ResponseGamePlayersInner(color string, id string, name string, rating int32) *ApiPuzzleId200ResponseGamePlayersInner {
	this := ApiPuzzleId200ResponseGamePlayersInner{}
	this.Color = color
	this.Id = id
	this.Name = name
	this.Rating = rating
...
func (o ApiPuzzleId200ResponseGamePlayersInner) MarshalJSON() ([]byte, error) {
...
func (o ApiPuzzleId200ResponseGamePlayersInner) ToMap() (map[string]interface{}, error) {
...
func (o *ApiPuzzleId200ResponseGamePlayersInner) UnmarshalJSON(data []byte) (err error) {
	...
	varApiPuzzleId200ResponseGamePlayersInner := _ApiPuzzleId200ResponseGamePlayersInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiPuzzleId200ResponseGamePlayersInner)

	if err != nil {
		return err
	}

	*o = ApiPuzzleId200ResponseGamePlayersInner(varApiPuzzleId200ResponseGamePlayersInner)

	return err
}

type NullableApiPuzzleId200ResponseGamePlayersInner struct {
	value *ApiPuzzleId200ResponseGamePlayersInner
	isSet bool
}

func (v NullableApiPuzzleId200ResponseGamePlayersInner) Get() *ApiPuzzleId200ResponseGamePlayersInner {
	return v.value
}

func (v *NullableApiPuzzleId200ResponseGamePlayersInner) Set(val *ApiPuzzleId200ResponseGamePlayersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiPuzzleId200ResponseGamePlayersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiPuzzleId200ResponseGamePlayersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiPuzzleId200ResponseGamePlayersInner(val *ApiPuzzleId200ResponseGamePlayersInner) *NullableApiPuzzleId200ResponseGamePlayersInner {
	return &NullableApiPuzzleId200ResponseGamePlayersInner{value: val, isSet: true}
}

func (v NullableApiPuzzleId200ResponseGamePlayersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiPuzzleId200ResponseGamePlayersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
