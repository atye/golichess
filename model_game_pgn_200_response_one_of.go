...
// checks if the GamePgn200ResponseOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GamePgn200ResponseOneOf{}

// GamePgn200ResponseOneOf struct for GamePgn200ResponseOneOf
type GamePgn200ResponseOneOf struct {
	Id string `json:"id"`
	...
	Players GamePgn200ResponseOneOfPlayers `json:"players"`
...
type _GamePgn200ResponseOneOf GamePgn200ResponseOneOf
...
func (o *GamePgn200ResponseOneOf) SetWinnerNil() {
	o.Winner.Set(nil)
}
...
func (o GamePgn200ResponseOneOf) MarshalJSON() ([]byte, error) {
...
func (o GamePgn200ResponseOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *GamePgn200ResponseOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varGamePgn200ResponseOneOf := _GamePgn200ResponseOneOf{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGamePgn200ResponseOneOf)

	if err != nil {
		return err
	}

	*o = GamePgn200ResponseOneOf(varGamePgn200ResponseOneOf)

	return err
}

type NullableGamePgn200ResponseOneOf struct {
	value *GamePgn200ResponseOneOf
	isSet bool
}

func (v NullableGamePgn200ResponseOneOf) Get() *GamePgn200ResponseOneOf {
	return v.value
}

func (v *NullableGamePgn200ResponseOneOf) Set(val *GamePgn200ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableGamePgn200ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableGamePgn200ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGamePgn200ResponseOneOf(val *GamePgn200ResponseOneOf) *NullableGamePgn200ResponseOneOf {
	return &NullableGamePgn200ResponseOneOf{value: val, isSet: true}
}

func (v NullableGamePgn200ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGamePgn200ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
