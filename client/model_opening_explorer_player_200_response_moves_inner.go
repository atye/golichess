...
// checks if the OpeningExplorerPlayer200ResponseMovesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerPlayer200ResponseMovesInner{}

// OpeningExplorerPlayer200ResponseMovesInner struct for OpeningExplorerPlayer200ResponseMovesInner
type OpeningExplorerPlayer200ResponseMovesInner struct {
	Uci string `json:"uci"`
	San string `json:"san"`
	...
	Game NullableOpeningExplorerPlayer200ResponseMovesInnerGame `json:"game"`
	Opening NullableOpeningExplorerMaster200ResponseOpening `json:"opening"`
}

type _OpeningExplorerPlayer200ResponseMovesInner OpeningExplorerPlayer200ResponseMovesInner
...
func NewOpeningExplorerPlayer200ResponseMovesInner(uci string, san string, averageOpponentRating int32, performance int32, white int32, draws int32, black int32, game NullableOpeningExplorerPlayer200ResponseMovesInnerGame, opening NullableOpeningExplorerMaster200ResponseOpening) *OpeningExplorerPlayer200ResponseMovesInner {
	this := OpeningExplorerPlayer200ResponseMovesInner{}
	this.Uci = uci
	this.San = san
...
// If the value is explicit nil, the zero value for OpeningExplorerPlayer200ResponseMovesInnerGame will be returned
func (o *OpeningExplorerPlayer200ResponseMovesInner) GetGame() OpeningExplorerPlayer200ResponseMovesInnerGame {
	if o == nil || o.Game.Get() == nil {
		var ret OpeningExplorerPlayer200ResponseMovesInnerGame
		return ret
	}
...
func (o OpeningExplorerPlayer200ResponseMovesInner) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerPlayer200ResponseMovesInner) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerPlayer200ResponseMovesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerPlayer200ResponseMovesInner := _OpeningExplorerPlayer200ResponseMovesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerPlayer200ResponseMovesInner)

	if err != nil {
		return err
	}

	*o = OpeningExplorerPlayer200ResponseMovesInner(varOpeningExplorerPlayer200ResponseMovesInner)

	return err
}

type NullableOpeningExplorerPlayer200ResponseMovesInner struct {
	value *OpeningExplorerPlayer200ResponseMovesInner
	isSet bool
}

func (v NullableOpeningExplorerPlayer200ResponseMovesInner) Get() *OpeningExplorerPlayer200ResponseMovesInner {
	return v.value
}

func (v *NullableOpeningExplorerPlayer200ResponseMovesInner) Set(val *OpeningExplorerPlayer200ResponseMovesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerPlayer200ResponseMovesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerPlayer200ResponseMovesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerPlayer200ResponseMovesInner(val *OpeningExplorerPlayer200ResponseMovesInner) *NullableOpeningExplorerPlayer200ResponseMovesInner {
	return &NullableOpeningExplorerPlayer200ResponseMovesInner{value: val, isSet: true}
}

func (v NullableOpeningExplorerPlayer200ResponseMovesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerPlayer200ResponseMovesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
