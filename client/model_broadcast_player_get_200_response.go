...
// checks if the BroadcastPlayerGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BroadcastPlayerGet200Response{}

// BroadcastPlayerGet200Response struct for BroadcastPlayerGet200Response
type BroadcastPlayerGet200Response struct {
	...
	Fide *BroadcastPlayerGet200ResponseAllOfFide `json:"fide,omitempty"`
	// List of games played by the player in the broadcast tournament
	Games []BroadcastPlayerGet200ResponseAllOfGamesInner `json:"games,omitempty"`
}

type _BroadcastPlayerGet200Response BroadcastPlayerGet200Response
...
func NewBroadcastPlayerGet200Response(name string) *BroadcastPlayerGet200Response {
	this := BroadcastPlayerGet200Response{}
	this.Name = name
	return &this
}
...
func (o *BroadcastPlayerGet200Response) GetFide() BroadcastPlayerGet200ResponseAllOfFide {
	if o == nil || IsNil(o.Fide) {
		var ret BroadcastPlayerGet200ResponseAllOfFide
		return ret
	}
	return *o.Fide
}
...
// SetFide gets a reference to the given BroadcastPlayerGet200ResponseAllOfFide and assigns it to the Fide field.
...
func (o *BroadcastPlayerGet200Response) GetGames() []BroadcastPlayerGet200ResponseAllOfGamesInner {
	if o == nil || IsNil(o.Games) {
		var ret []BroadcastPlayerGet200ResponseAllOfGamesInner
		return ret
	}
	return o.Games
}
...
// SetGames gets a reference to the given []BroadcastPlayerGet200ResponseAllOfGamesInner and assigns it to the Games field.
func (o *BroadcastPlayerGet200Response) SetGames(v []BroadcastPlayerGet200ResponseAllOfGamesInner) {
	o.Games = v
}

func (o BroadcastPlayerGet200Response) MarshalJSON() ([]byte, error) {
...
func (o BroadcastPlayerGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *BroadcastPlayerGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varBroadcastPlayerGet200Response := _BroadcastPlayerGet200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBroadcastPlayerGet200Response)

	if err != nil {
		return err
	}

	*o = BroadcastPlayerGet200Response(varBroadcastPlayerGet200Response)

	return err
}

type NullableBroadcastPlayerGet200Response struct {
	value *BroadcastPlayerGet200Response
	isSet bool
}

func (v NullableBroadcastPlayerGet200Response) Get() *BroadcastPlayerGet200Response {
	return v.value
}

func (v *NullableBroadcastPlayerGet200Response) Set(val *BroadcastPlayerGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBroadcastPlayerGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBroadcastPlayerGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBroadcastPlayerGet200Response(val *BroadcastPlayerGet200Response) *NullableBroadcastPlayerGet200Response {
	return &NullableBroadcastPlayerGet200Response{value: val, isSet: true}
}

func (v NullableBroadcastPlayerGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBroadcastPlayerGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
