...
// checks if the GamePgn200ResponseOneOfAnalysisInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GamePgn200ResponseOneOfAnalysisInner{}

// GamePgn200ResponseOneOfAnalysisInner struct for GamePgn200ResponseOneOfAnalysisInner
type GamePgn200ResponseOneOfAnalysisInner struct {
	...
	Judgment *GamePgn200ResponseOneOfAnalysisInnerJudgment `json:"judgment,omitempty"`
}
...
func NewGamePgn200ResponseOneOfAnalysisInner() *GamePgn200ResponseOneOfAnalysisInner {
	this := GamePgn200ResponseOneOfAnalysisInner{}
	return &this
}
...
func (o *GamePgn200ResponseOneOfAnalysisInner) GetJudgment() GamePgn200ResponseOneOfAnalysisInnerJudgment {
	if o == nil || IsNil(o.Judgment) {
		var ret GamePgn200ResponseOneOfAnalysisInnerJudgment
		return ret
	}
	return *o.Judgment
}
...
// SetJudgment gets a reference to the given GamePgn200ResponseOneOfAnalysisInnerJudgment and assigns it to the Judgment field.
func (o *GamePgn200ResponseOneOfAnalysisInner) SetJudgment(v GamePgn200ResponseOneOfAnalysisInnerJudgment) {
	o.Judgment = &v
}

func (o GamePgn200ResponseOneOfAnalysisInner) MarshalJSON() ([]byte, error) {
...
func (o GamePgn200ResponseOneOfAnalysisInner) ToMap() (map[string]interface{}, error) {
...
type NullableGamePgn200ResponseOneOfAnalysisInner struct {
	value *GamePgn200ResponseOneOfAnalysisInner
	isSet bool
}

func (v NullableGamePgn200ResponseOneOfAnalysisInner) Get() *GamePgn200ResponseOneOfAnalysisInner {
	return v.value
}

func (v *NullableGamePgn200ResponseOneOfAnalysisInner) Set(val *GamePgn200ResponseOneOfAnalysisInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGamePgn200ResponseOneOfAnalysisInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGamePgn200ResponseOneOfAnalysisInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGamePgn200ResponseOneOfAnalysisInner(val *GamePgn200ResponseOneOfAnalysisInner) *NullableGamePgn200ResponseOneOfAnalysisInner {
	return &NullableGamePgn200ResponseOneOfAnalysisInner{value: val, isSet: true}
}

func (v NullableGamePgn200ResponseOneOfAnalysisInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGamePgn200ResponseOneOfAnalysisInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
