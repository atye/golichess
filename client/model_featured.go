...
func (o *Featured) UnmarshalJSON(data []byte) (err error) {
	...
	varFeatured := _Featured{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFeatured)

	if err != nil {
		return err
	}

	*o = Featured(varFeatured)

	return err
}

type NullableFeatured struct {
	value *Featured
	isSet bool
}

func (v NullableFeatured) Get() *Featured {
	return v.value
}

func (v *NullableFeatured) Set(val *Featured) {
	v.value = val
	v.isSet = true
}

func (v NullableFeatured) IsSet() bool {
	return v.isSet
}

func (v *NullableFeatured) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeatured(val *Featured) *NullableFeatured {
	return &NullableFeatured{value: val, isSet: true}
}

func (v NullableFeatured) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeatured) UnmarshalJSON(src []byte) error {
	v.isSet = true
