...
// checks if the ApiStreamEvent200ResponseOneOf2ChallengeDestUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiStreamEvent200ResponseOneOf2ChallengeDestUser{}

// ApiStreamEvent200ResponseOneOf2ChallengeDestUser struct for ApiStreamEvent200ResponseOneOf2ChallengeDestUser
type ApiStreamEvent200ResponseOneOf2ChallengeDestUser struct {
	Id string `json:"id"`
...
type _ApiStreamEvent200ResponseOneOf2ChallengeDestUser ApiStreamEvent200ResponseOneOf2ChallengeDestUser
...
func NewApiStreamEvent200ResponseOneOf2ChallengeDestUser(id string, name string) *ApiStreamEvent200ResponseOneOf2ChallengeDestUser {
	this := ApiStreamEvent200ResponseOneOf2ChallengeDestUser{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o ApiStreamEvent200ResponseOneOf2ChallengeDestUser) MarshalJSON() ([]byte, error) {
...
func (o ApiStreamEvent200ResponseOneOf2ChallengeDestUser) ToMap() (map[string]interface{}, error) {
...
func (o *ApiStreamEvent200ResponseOneOf2ChallengeDestUser) UnmarshalJSON(data []byte) (err error) {
	...
	varApiStreamEvent200ResponseOneOf2ChallengeDestUser := _ApiStreamEvent200ResponseOneOf2ChallengeDestUser{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiStreamEvent200ResponseOneOf2ChallengeDestUser)

	if err != nil {
		return err
	}

	*o = ApiStreamEvent200ResponseOneOf2ChallengeDestUser(varApiStreamEvent200ResponseOneOf2ChallengeDestUser)

	return err
}

type NullableApiStreamEvent200ResponseOneOf2ChallengeDestUser struct {
	value *ApiStreamEvent200ResponseOneOf2ChallengeDestUser
	isSet bool
}

func (v NullableApiStreamEvent200ResponseOneOf2ChallengeDestUser) Get() *ApiStreamEvent200ResponseOneOf2ChallengeDestUser {
	return v.value
}

func (v *NullableApiStreamEvent200ResponseOneOf2ChallengeDestUser) Set(val *ApiStreamEvent200ResponseOneOf2ChallengeDestUser) {
	v.value = val
	v.isSet = true
}

func (v NullableApiStreamEvent200ResponseOneOf2ChallengeDestUser) IsSet() bool {
	return v.isSet
}

func (v *NullableApiStreamEvent200ResponseOneOf2ChallengeDestUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiStreamEvent200ResponseOneOf2ChallengeDestUser(val *ApiStreamEvent200ResponseOneOf2ChallengeDestUser) *NullableApiStreamEvent200ResponseOneOf2ChallengeDestUser {
	return &NullableApiStreamEvent200ResponseOneOf2ChallengeDestUser{value: val, isSet: true}
}

func (v NullableApiStreamEvent200ResponseOneOf2ChallengeDestUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiStreamEvent200ResponseOneOf2ChallengeDestUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
