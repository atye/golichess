...
// checks if the OpeningExplorerMaster200ResponseMovesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerMaster200ResponseMovesInner{}

// OpeningExplorerMaster200ResponseMovesInner struct for OpeningExplorerMaster200ResponseMovesInner
type OpeningExplorerMaster200ResponseMovesInner struct {
	Uci string `json:"uci"`
	San string `json:"san"`
	...
	Game NullableOpeningExplorerMaster200ResponseMovesInnerGame `json:"game"`
	Opening NullableOpeningExplorerMaster200ResponseOpening `json:"opening"`
}

type _OpeningExplorerMaster200ResponseMovesInner OpeningExplorerMaster200ResponseMovesInner
...
func NewOpeningExplorerMaster200ResponseMovesInner(uci string, san string, averageRating int32, white int32, draws int32, black int32, game NullableOpeningExplorerMaster200ResponseMovesInnerGame, opening NullableOpeningExplorerMaster200ResponseOpening) *OpeningExplorerMaster200ResponseMovesInner {
	this := OpeningExplorerMaster200ResponseMovesInner{}
	this.Uci = uci
	this.San = san
...
// If the value is explicit nil, the zero value for OpeningExplorerMaster200ResponseMovesInnerGame will be returned
func (o *OpeningExplorerMaster200ResponseMovesInner) GetGame() OpeningExplorerMaster200ResponseMovesInnerGame {
	if o == nil || o.Game.Get() == nil {
		var ret OpeningExplorerMaster200ResponseMovesInnerGame
		return ret
	}
...
func (o OpeningExplorerMaster200ResponseMovesInner) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerMaster200ResponseMovesInner) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerMaster200ResponseMovesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerMaster200ResponseMovesInner := _OpeningExplorerMaster200ResponseMovesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerMaster200ResponseMovesInner)

	if err != nil {
		return err
	}

	*o = OpeningExplorerMaster200ResponseMovesInner(varOpeningExplorerMaster200ResponseMovesInner)

	return err
}

type NullableOpeningExplorerMaster200ResponseMovesInner struct {
	value *OpeningExplorerMaster200ResponseMovesInner
	isSet bool
}

func (v NullableOpeningExplorerMaster200ResponseMovesInner) Get() *OpeningExplorerMaster200ResponseMovesInner {
	return v.value
}

func (v *NullableOpeningExplorerMaster200ResponseMovesInner) Set(val *OpeningExplorerMaster200ResponseMovesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerMaster200ResponseMovesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerMaster200ResponseMovesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerMaster200ResponseMovesInner(val *OpeningExplorerMaster200ResponseMovesInner) *NullableOpeningExplorerMaster200ResponseMovesInner {
	return &NullableOpeningExplorerMaster200ResponseMovesInner{value: val, isSet: true}
}

func (v NullableOpeningExplorerMaster200ResponseMovesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerMaster200ResponseMovesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
