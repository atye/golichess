...
// checks if the ApiUser200ResponseAllOfProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiUser200ResponseAllOfProfile{}

// ApiUser200ResponseAllOfProfile struct for ApiUser200ResponseAllOfProfile
type ApiUser200ResponseAllOfProfile struct {
...
func NewApiUser200ResponseAllOfProfile() *ApiUser200ResponseAllOfProfile {
	this := ApiUser200ResponseAllOfProfile{}
	return &this
}
...
func (o ApiUser200ResponseAllOfProfile) MarshalJSON() ([]byte, error) {
...
func (o ApiUser200ResponseAllOfProfile) ToMap() (map[string]interface{}, error) {
...
type NullableApiUser200ResponseAllOfProfile struct {
	value *ApiUser200ResponseAllOfProfile
	isSet bool
}

func (v NullableApiUser200ResponseAllOfProfile) Get() *ApiUser200ResponseAllOfProfile {
	return v.value
}

func (v *NullableApiUser200ResponseAllOfProfile) Set(val *ApiUser200ResponseAllOfProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableApiUser200ResponseAllOfProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableApiUser200ResponseAllOfProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiUser200ResponseAllOfProfile(val *ApiUser200ResponseAllOfProfile) *NullableApiUser200ResponseAllOfProfile {
	return &NullableApiUser200ResponseAllOfProfile{value: val, isSet: true}
}

func (v NullableApiUser200ResponseAllOfProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiUser200ResponseAllOfProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
