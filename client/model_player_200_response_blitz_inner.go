...
// checks if the Player200ResponseBlitzInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Player200ResponseBlitzInner{}

// Player200ResponseBlitzInner struct for Player200ResponseBlitzInner
type Player200ResponseBlitzInner struct {
	Id string `json:"id"`
...
type _Player200ResponseBlitzInner Player200ResponseBlitzInner
...
func NewPlayer200ResponseBlitzInner(id string, username string) *Player200ResponseBlitzInner {
	this := Player200ResponseBlitzInner{}
	this.Id = id
...
func (o Player200ResponseBlitzInner) MarshalJSON() ([]byte, error) {
...
func (o Player200ResponseBlitzInner) ToMap() (map[string]interface{}, error) {
...
func (o *Player200ResponseBlitzInner) UnmarshalJSON(data []byte) (err error) {
	...
	varPlayer200ResponseBlitzInner := _Player200ResponseBlitzInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPlayer200ResponseBlitzInner)

	if err != nil {
		return err
	}

	*o = Player200ResponseBlitzInner(varPlayer200ResponseBlitzInner)

	return err
}

type NullablePlayer200ResponseBlitzInner struct {
	value *Player200ResponseBlitzInner
	isSet bool
}

func (v NullablePlayer200ResponseBlitzInner) Get() *Player200ResponseBlitzInner {
	return v.value
}

func (v *NullablePlayer200ResponseBlitzInner) Set(val *Player200ResponseBlitzInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePlayer200ResponseBlitzInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePlayer200ResponseBlitzInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlayer200ResponseBlitzInner(val *Player200ResponseBlitzInner) *NullablePlayer200ResponseBlitzInner {
	return &NullablePlayer200ResponseBlitzInner{value: val, isSet: true}
}

func (v NullablePlayer200ResponseBlitzInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlayer200ResponseBlitzInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
