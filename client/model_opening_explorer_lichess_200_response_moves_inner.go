...
// checks if the OpeningExplorerLichess200ResponseMovesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerLichess200ResponseMovesInner{}

// OpeningExplorerLichess200ResponseMovesInner struct for OpeningExplorerLichess200ResponseMovesInner
type OpeningExplorerLichess200ResponseMovesInner struct {
	Uci string `json:"uci"`
	San string `json:"san"`
	...
	Game NullableOpeningExplorerLichess200ResponseMovesInnerGame `json:"game"`
	Opening NullableOpeningExplorerMaster200ResponseOpening `json:"opening"`
}

type _OpeningExplorerLichess200ResponseMovesInner OpeningExplorerLichess200ResponseMovesInner
...
func NewOpeningExplorerLichess200ResponseMovesInner(uci string, san string, averageRating int32, white int32, draws int32, black int32, game NullableOpeningExplorerLichess200ResponseMovesInnerGame, opening NullableOpeningExplorerMaster200ResponseOpening) *OpeningExplorerLichess200ResponseMovesInner {
	this := OpeningExplorerLichess200ResponseMovesInner{}
	this.Uci = uci
	this.San = san
...
// If the value is explicit nil, the zero value for OpeningExplorerLichess200ResponseMovesInnerGame will be returned
func (o *OpeningExplorerLichess200ResponseMovesInner) GetGame() OpeningExplorerLichess200ResponseMovesInnerGame {
	if o == nil || o.Game.Get() == nil {
		var ret OpeningExplorerLichess200ResponseMovesInnerGame
		return ret
	}
...
func (o OpeningExplorerLichess200ResponseMovesInner) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerLichess200ResponseMovesInner) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerLichess200ResponseMovesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerLichess200ResponseMovesInner := _OpeningExplorerLichess200ResponseMovesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerLichess200ResponseMovesInner)

	if err != nil {
		return err
	}

	*o = OpeningExplorerLichess200ResponseMovesInner(varOpeningExplorerLichess200ResponseMovesInner)

	return err
}

type NullableOpeningExplorerLichess200ResponseMovesInner struct {
	value *OpeningExplorerLichess200ResponseMovesInner
	isSet bool
}

func (v NullableOpeningExplorerLichess200ResponseMovesInner) Get() *OpeningExplorerLichess200ResponseMovesInner {
	return v.value
}

func (v *NullableOpeningExplorerLichess200ResponseMovesInner) Set(val *OpeningExplorerLichess200ResponseMovesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerLichess200ResponseMovesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerLichess200ResponseMovesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerLichess200ResponseMovesInner(val *OpeningExplorerLichess200ResponseMovesInner) *NullableOpeningExplorerLichess200ResponseMovesInner {
	return &NullableOpeningExplorerLichess200ResponseMovesInner{value: val, isSet: true}
}

func (v NullableOpeningExplorerLichess200ResponseMovesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerLichess200ResponseMovesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
