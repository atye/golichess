...
// checks if the ApiUser200ResponseAllOfPerfsChess960 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiUser200ResponseAllOfPerfsChess960{}

// ApiUser200ResponseAllOfPerfsChess960 struct for ApiUser200ResponseAllOfPerfsChess960
type ApiUser200ResponseAllOfPerfsChess960 struct {
...
type _ApiUser200ResponseAllOfPerfsChess960 ApiUser200ResponseAllOfPerfsChess960
...
func NewApiUser200ResponseAllOfPerfsChess960(games int32, rating int32, rd int32, prog int32) *ApiUser200ResponseAllOfPerfsChess960 {
	this := ApiUser200ResponseAllOfPerfsChess960{}
	this.Games = games
	this.Rating = rating
	this.Rd = rd
	this.Prog = prog
...
func (o ApiUser200ResponseAllOfPerfsChess960) MarshalJSON() ([]byte, error) {
...
func (o ApiUser200ResponseAllOfPerfsChess960) ToMap() (map[string]interface{}, error) {
...
func (o *ApiUser200ResponseAllOfPerfsChess960) UnmarshalJSON(data []byte) (err error) {
	...
	varApiUser200ResponseAllOfPerfsChess960 := _ApiUser200ResponseAllOfPerfsChess960{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiUser200ResponseAllOfPerfsChess960)

	if err != nil {
		return err
	}

	*o = ApiUser200ResponseAllOfPerfsChess960(varApiUser200ResponseAllOfPerfsChess960)

	return err
}

type NullableApiUser200ResponseAllOfPerfsChess960 struct {
	value *ApiUser200ResponseAllOfPerfsChess960
	isSet bool
}

func (v NullableApiUser200ResponseAllOfPerfsChess960) Get() *ApiUser200ResponseAllOfPerfsChess960 {
	return v.value
}

func (v *NullableApiUser200ResponseAllOfPerfsChess960) Set(val *ApiUser200ResponseAllOfPerfsChess960) {
	v.value = val
	v.isSet = true
}

func (v NullableApiUser200ResponseAllOfPerfsChess960) IsSet() bool {
	return v.isSet
}

func (v *NullableApiUser200ResponseAllOfPerfsChess960) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiUser200ResponseAllOfPerfsChess960(val *ApiUser200ResponseAllOfPerfsChess960) *NullableApiUser200ResponseAllOfPerfsChess960 {
	return &NullableApiUser200ResponseAllOfPerfsChess960{value: val, isSet: true}
}

func (v NullableApiUser200ResponseAllOfPerfsChess960) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiUser200ResponseAllOfPerfsChess960) UnmarshalJSON(src []byte) error {
	v.isSet = true
