...
// checks if the ApiUser200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiUser200Response{}

// ApiUser200Response struct for ApiUser200Response
type ApiUser200Response struct {
	Id string `json:"id"`
...
type _ApiUser200Response ApiUser200Response
...
func (o *ApiUser200Response) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o ApiUser200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiUser200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ApiUser200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varApiUser200Response := _ApiUser200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiUser200Response)

	if err != nil {
		return err
	}

	*o = ApiUser200Response(varApiUser200Response)

	return err
}

type NullableApiUser200Response struct {
	value *ApiUser200Response
	isSet bool
}

func (v NullableApiUser200Response) Get() *ApiUser200Response {
	return v.value
}

func (v *NullableApiUser200Response) Set(val *ApiUser200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiUser200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiUser200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiUser200Response(val *ApiUser200Response) *NullableApiUser200Response {
	return &NullableApiUser200Response{value: val, isSet: true}
}

func (v NullableApiUser200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiUser200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
