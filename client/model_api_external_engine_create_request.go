...
// checks if the ApiExternalEngineCreateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiExternalEngineCreateRequest{}

// ApiExternalEngineCreateRequest struct for ApiExternalEngineCreateRequest
type ApiExternalEngineCreateRequest struct {
...
type _ApiExternalEngineCreateRequest ApiExternalEngineCreateRequest
...
func NewApiExternalEngineCreateRequest(name string, maxThreads int32, maxHash int32, providerSecret string) *ApiExternalEngineCreateRequest {
	this := ApiExternalEngineCreateRequest{}
	this.Name = name
...
func (o ApiExternalEngineCreateRequest) MarshalJSON() ([]byte, error) {
...
func (o ApiExternalEngineCreateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ApiExternalEngineCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varApiExternalEngineCreateRequest := _ApiExternalEngineCreateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiExternalEngineCreateRequest)

	if err != nil {
		return err
	}

	*o = ApiExternalEngineCreateRequest(varApiExternalEngineCreateRequest)

	return err
}

type NullableApiExternalEngineCreateRequest struct {
	value *ApiExternalEngineCreateRequest
	isSet bool
}

func (v NullableApiExternalEngineCreateRequest) Get() *ApiExternalEngineCreateRequest {
	return v.value
}

func (v *NullableApiExternalEngineCreateRequest) Set(val *ApiExternalEngineCreateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableApiExternalEngineCreateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableApiExternalEngineCreateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiExternalEngineCreateRequest(val *ApiExternalEngineCreateRequest) *NullableApiExternalEngineCreateRequest {
	return &NullableApiExternalEngineCreateRequest{value: val, isSet: true}
}

func (v NullableApiExternalEngineCreateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiExternalEngineCreateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
