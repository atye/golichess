...
// checks if the RacerGet200ResponsePlayersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RacerGet200ResponsePlayersInner{}

// RacerGet200ResponsePlayersInner struct for RacerGet200ResponsePlayersInner
type RacerGet200ResponsePlayersInner struct {
	// Player username
...
type _RacerGet200ResponsePlayersInner RacerGet200ResponsePlayersInner
...
func NewRacerGet200ResponsePlayersInner(name string, score int32) *RacerGet200ResponsePlayersInner {
	this := RacerGet200ResponsePlayersInner{}
	this.Name = name
	this.Score = score
	return &this
}
...
func (o RacerGet200ResponsePlayersInner) MarshalJSON() ([]byte, error) {
...
func (o RacerGet200ResponsePlayersInner) ToMap() (map[string]interface{}, error) {
...
func (o *RacerGet200ResponsePlayersInner) UnmarshalJSON(data []byte) (err error) {
	...
	varRacerGet200ResponsePlayersInner := _RacerGet200ResponsePlayersInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRacerGet200ResponsePlayersInner)

	if err != nil {
		return err
	}

	*o = RacerGet200ResponsePlayersInner(varRacerGet200ResponsePlayersInner)

	return err
}

type NullableRacerGet200ResponsePlayersInner struct {
	value *RacerGet200ResponsePlayersInner
	isSet bool
}

func (v NullableRacerGet200ResponsePlayersInner) Get() *RacerGet200ResponsePlayersInner {
	return v.value
}

func (v *NullableRacerGet200ResponsePlayersInner) Set(val *RacerGet200ResponsePlayersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableRacerGet200ResponsePlayersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableRacerGet200ResponsePlayersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRacerGet200ResponsePlayersInner(val *RacerGet200ResponsePlayersInner) *NullableRacerGet200ResponsePlayersInner {
	return &NullableRacerGet200ResponsePlayersInner{value: val, isSet: true}
}

func (v NullableRacerGet200ResponsePlayersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRacerGet200ResponsePlayersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
