...
// checks if the OpeningExplorerPlayer200ResponseRecentGamesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerPlayer200ResponseRecentGamesInner{}

// OpeningExplorerPlayer200ResponseRecentGamesInner struct for OpeningExplorerPlayer200ResponseRecentGamesInner
type OpeningExplorerPlayer200ResponseRecentGamesInner struct {
	Uci string `json:"uci"`
	Id string `json:"id"`
...
type _OpeningExplorerPlayer200ResponseRecentGamesInner OpeningExplorerPlayer200ResponseRecentGamesInner
...
func NewOpeningExplorerPlayer200ResponseRecentGamesInner(uci string, id string, winner NullableString, speed string, mode string, white OpeningExplorerMaster200ResponseMovesInnerGameWhite, black OpeningExplorerMaster200ResponseMovesInnerGameWhite, year int32, month string) *OpeningExplorerPlayer200ResponseRecentGamesInner {
	this := OpeningExplorerPlayer200ResponseRecentGamesInner{}
	this.Uci = uci
	this.Id = id
	this.Winner = winner
	this.Speed = speed
...
func (o OpeningExplorerPlayer200ResponseRecentGamesInner) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerPlayer200ResponseRecentGamesInner) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerPlayer200ResponseRecentGamesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerPlayer200ResponseRecentGamesInner := _OpeningExplorerPlayer200ResponseRecentGamesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerPlayer200ResponseRecentGamesInner)

	if err != nil {
		return err
	}

	*o = OpeningExplorerPlayer200ResponseRecentGamesInner(varOpeningExplorerPlayer200ResponseRecentGamesInner)

	return err
}

type NullableOpeningExplorerPlayer200ResponseRecentGamesInner struct {
	value *OpeningExplorerPlayer200ResponseRecentGamesInner
	isSet bool
}

func (v NullableOpeningExplorerPlayer200ResponseRecentGamesInner) Get() *OpeningExplorerPlayer200ResponseRecentGamesInner {
	return v.value
}

func (v *NullableOpeningExplorerPlayer200ResponseRecentGamesInner) Set(val *OpeningExplorerPlayer200ResponseRecentGamesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerPlayer200ResponseRecentGamesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerPlayer200ResponseRecentGamesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerPlayer200ResponseRecentGamesInner(val *OpeningExplorerPlayer200ResponseRecentGamesInner) *NullableOpeningExplorerPlayer200ResponseRecentGamesInner {
	return &NullableOpeningExplorerPlayer200ResponseRecentGamesInner{value: val, isSet: true}
}

func (v NullableOpeningExplorerPlayer200ResponseRecentGamesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerPlayer200ResponseRecentGamesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
