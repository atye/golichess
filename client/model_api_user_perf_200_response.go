...
// checks if the ApiUserPerf200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiUserPerf200Response{}

// ApiUserPerf200Response struct for ApiUserPerf200Response
type ApiUserPerf200Response struct {
	User ApiUserPerf200ResponseUser `json:"user"`
	Perf ApiUserPerf200ResponsePerf `json:"perf"`
	Rank NullableInt32 `json:"rank"`
	Percentile float32 `json:"percentile"`
	Stat ApiUserPerf200ResponseStat `json:"stat"`
}

type _ApiUserPerf200Response ApiUserPerf200Response
...
func (o *ApiUserPerf200Response) GetUser() ApiUserPerf200ResponseUser {
	if o == nil {
		var ret ApiUserPerf200ResponseUser
		return ret
	}
...
func (o *ApiUserPerf200Response) GetPerf() ApiUserPerf200ResponsePerf {
	if o == nil {
		var ret ApiUserPerf200ResponsePerf
		return ret
	}
...
func (o *ApiUserPerf200Response) GetStat() ApiUserPerf200ResponseStat {
	if o == nil {
		var ret ApiUserPerf200ResponseStat
		return ret
	}
...
func (o ApiUserPerf200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiUserPerf200Response) ToMap() (map[string]interface{}, error) {
...
func (o *ApiUserPerf200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varApiUserPerf200Response := _ApiUserPerf200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiUserPerf200Response)

	if err != nil {
		return err
	}

	*o = ApiUserPerf200Response(varApiUserPerf200Response)

	return err
}

type NullableApiUserPerf200Response struct {
	value *ApiUserPerf200Response
	isSet bool
}

func (v NullableApiUserPerf200Response) Get() *ApiUserPerf200Response {
	return v.value
}

func (v *NullableApiUserPerf200Response) Set(val *ApiUserPerf200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiUserPerf200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiUserPerf200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiUserPerf200Response(val *ApiUserPerf200Response) *NullableApiUserPerf200Response {
	return &NullableApiUserPerf200Response{value: val, isSet: true}
}

func (v NullableApiUserPerf200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiUserPerf200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
