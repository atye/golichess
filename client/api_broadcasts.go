...
This endpoint accepts the same form data as the [web form](https://lichess.org/broadcast/new).
	...
	*/
	...
	//  @return BroadcastsOfficial200Response
	BroadcastTourGetExecute(r BroadcastsAPIBroadcastTourGetRequest) (*BroadcastsOfficial200Response, *http.Response, error)
...
func (r BroadcastsAPIBroadcastTourGetRequest) Execute() (*BroadcastsOfficial200Response, *http.Response, error) {
...
// Execute executes the request
//  @return BroadcastsOfficial200Response
func (a *BroadcastsAPIService) BroadcastTourGetExecute(r BroadcastsAPIBroadcastTourGetRequest) (*BroadcastsOfficial200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
