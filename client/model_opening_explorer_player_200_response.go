...
// checks if the OpeningExplorerPlayer200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerPlayer200Response{}

// OpeningExplorerPlayer200Response struct for OpeningExplorerPlayer200Response
type OpeningExplorerPlayer200Response struct {
	...
	Moves []OpeningExplorerPlayer200ResponseMovesInner `json:"moves"`
	RecentGames []OpeningExplorerPlayer200ResponseRecentGamesInner `json:"recentGames"`
}

type _OpeningExplorerPlayer200Response OpeningExplorerPlayer200Response
...
func NewOpeningExplorerPlayer200Response(opening NullableOpeningExplorerMaster200ResponseOpening, queuePosition int32, white int32, draws int32, black int32, moves []OpeningExplorerPlayer200ResponseMovesInner, recentGames []OpeningExplorerPlayer200ResponseRecentGamesInner) *OpeningExplorerPlayer200Response {
	this := OpeningExplorerPlayer200Response{}
...
func (o *OpeningExplorerPlayer200Response) GetMoves() []OpeningExplorerPlayer200ResponseMovesInner {
	if o == nil {
		var ret []OpeningExplorerPlayer200ResponseMovesInner
		return ret
	}
...
func (o *OpeningExplorerPlayer200Response) GetRecentGames() []OpeningExplorerPlayer200ResponseRecentGamesInner {
	if o == nil {
		var ret []OpeningExplorerPlayer200ResponseRecentGamesInner
		return ret
	}
...
func (o OpeningExplorerPlayer200Response) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerPlayer200Response) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerPlayer200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerPlayer200Response := _OpeningExplorerPlayer200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerPlayer200Response)

	if err != nil {
		return err
	}

	*o = OpeningExplorerPlayer200Response(varOpeningExplorerPlayer200Response)

	return err
}

type NullableOpeningExplorerPlayer200Response struct {
	value *OpeningExplorerPlayer200Response
	isSet bool
}

func (v NullableOpeningExplorerPlayer200Response) Get() *OpeningExplorerPlayer200Response {
	return v.value
}

func (v *NullableOpeningExplorerPlayer200Response) Set(val *OpeningExplorerPlayer200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerPlayer200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerPlayer200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerPlayer200Response(val *OpeningExplorerPlayer200Response) *NullableOpeningExplorerPlayer200Response {
	return &NullableOpeningExplorerPlayer200Response{value: val, isSet: true}
}

func (v NullableOpeningExplorerPlayer200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerPlayer200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
