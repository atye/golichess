...
// checks if the OpeningExplorerLichess200ResponseTopGamesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpeningExplorerLichess200ResponseTopGamesInner{}

// OpeningExplorerLichess200ResponseTopGamesInner struct for OpeningExplorerLichess200ResponseTopGamesInner
type OpeningExplorerLichess200ResponseTopGamesInner struct {
	Uci string `json:"uci"`
	Id string `json:"id"`
...
type _OpeningExplorerLichess200ResponseTopGamesInner OpeningExplorerLichess200ResponseTopGamesInner
...
func NewOpeningExplorerLichess200ResponseTopGamesInner(uci string, id string, winner NullableString, white OpeningExplorerMaster200ResponseMovesInnerGameWhite, black OpeningExplorerMaster200ResponseMovesInnerGameWhite, year float32, month NullableString) *OpeningExplorerLichess200ResponseTopGamesInner {
	this := OpeningExplorerLichess200ResponseTopGamesInner{}
	this.Uci = uci
	this.Id = id
	this.Winner = winner
	this.White = white
...
func (o OpeningExplorerLichess200ResponseTopGamesInner) MarshalJSON() ([]byte, error) {
...
func (o OpeningExplorerLichess200ResponseTopGamesInner) ToMap() (map[string]interface{}, error) {
...
func (o *OpeningExplorerLichess200ResponseTopGamesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varOpeningExplorerLichess200ResponseTopGamesInner := _OpeningExplorerLichess200ResponseTopGamesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpeningExplorerLichess200ResponseTopGamesInner)

	if err != nil {
		return err
	}

	*o = OpeningExplorerLichess200ResponseTopGamesInner(varOpeningExplorerLichess200ResponseTopGamesInner)

	return err
}

type NullableOpeningExplorerLichess200ResponseTopGamesInner struct {
	value *OpeningExplorerLichess200ResponseTopGamesInner
	isSet bool
}

func (v NullableOpeningExplorerLichess200ResponseTopGamesInner) Get() *OpeningExplorerLichess200ResponseTopGamesInner {
	return v.value
}

func (v *NullableOpeningExplorerLichess200ResponseTopGamesInner) Set(val *OpeningExplorerLichess200ResponseTopGamesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOpeningExplorerLichess200ResponseTopGamesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOpeningExplorerLichess200ResponseTopGamesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpeningExplorerLichess200ResponseTopGamesInner(val *OpeningExplorerLichess200ResponseTopGamesInner) *NullableOpeningExplorerLichess200ResponseTopGamesInner {
	return &NullableOpeningExplorerLichess200ResponseTopGamesInner{value: val, isSet: true}
}

func (v NullableOpeningExplorerLichess200ResponseTopGamesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpeningExplorerLichess200ResponseTopGamesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
