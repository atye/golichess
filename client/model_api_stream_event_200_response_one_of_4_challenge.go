...
// checks if the ApiStreamEvent200ResponseOneOf4Challenge type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiStreamEvent200ResponseOneOf4Challenge{}

// ApiStreamEvent200ResponseOneOf4Challenge struct for ApiStreamEvent200ResponseOneOf4Challenge
type ApiStreamEvent200ResponseOneOf4Challenge struct {
	Id string `json:"id"`
	Url string `json:"url"`
...
type _ApiStreamEvent200ResponseOneOf4Challenge ApiStreamEvent200ResponseOneOf4Challenge
...
func NewApiStreamEvent200ResponseOneOf4Challenge(id string, url string, status string, challenger ApiStreamEvent200ResponseOneOf3ChallengeChallenger, destUser NullableApiStreamEvent200ResponseOneOf2ChallengeDestUser, variant ApiAccountPlaying200ResponseNowPlayingInnerVariant, rated bool, speed string, timeControl ApiStreamEvent200ResponseOneOf2ChallengeTimeControl, color string, perf ApiStreamEvent200ResponseOneOf2ChallengePerf, declineReason string, declineReasonKey string) *ApiStreamEvent200ResponseOneOf4Challenge {
	this := ApiStreamEvent200ResponseOneOf4Challenge{}
	this.Id = id
	this.Url = url
	this.Status = status
...
// GetDeclineReasonKey returns the DeclineReasonKey field value
func (o *ApiStreamEvent200ResponseOneOf4Challenge) GetDeclineReasonKey() string {
	...
	return o.DeclineReasonKey
}

// GetDeclineReasonKeyOk returns a tuple with the DeclineReasonKey field value
// and a boolean to check if the value has been set.
func (o *ApiStreamEvent200ResponseOneOf4Challenge) GetDeclineReasonKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DeclineReasonKey, true
}

// SetDeclineReasonKey sets field value
func (o *ApiStreamEvent200ResponseOneOf4Challenge) SetDeclineReasonKey(v string) {
	o.DeclineReasonKey = v
}

func (o ApiStreamEvent200ResponseOneOf4Challenge) MarshalJSON() ([]byte, error) {
...
func (o ApiStreamEvent200ResponseOneOf4Challenge) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["declineReasonKey"] = o.DeclineReasonKey
	return toSerialize, nil
}

func (o *ApiStreamEvent200ResponseOneOf4Challenge) UnmarshalJSON(data []byte) (err error) {
	...
	varApiStreamEvent200ResponseOneOf4Challenge := _ApiStreamEvent200ResponseOneOf4Challenge{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiStreamEvent200ResponseOneOf4Challenge)

	if err != nil {
		return err
	}

	*o = ApiStreamEvent200ResponseOneOf4Challenge(varApiStreamEvent200ResponseOneOf4Challenge)

	return err
}

type NullableApiStreamEvent200ResponseOneOf4Challenge struct {
	value *ApiStreamEvent200ResponseOneOf4Challenge
	isSet bool
}

func (v NullableApiStreamEvent200ResponseOneOf4Challenge) Get() *ApiStreamEvent200ResponseOneOf4Challenge {
	return v.value
}

func (v *NullableApiStreamEvent200ResponseOneOf4Challenge) Set(val *ApiStreamEvent200ResponseOneOf4Challenge) {
	v.value = val
	v.isSet = true
}

func (v NullableApiStreamEvent200ResponseOneOf4Challenge) IsSet() bool {
	return v.isSet
}

func (v *NullableApiStreamEvent200ResponseOneOf4Challenge) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiStreamEvent200ResponseOneOf4Challenge(val *ApiStreamEvent200ResponseOneOf4Challenge) *NullableApiStreamEvent200ResponseOneOf4Challenge {
	return &NullableApiStreamEvent200ResponseOneOf4Challenge{value: val, isSet: true}
}

func (v NullableApiStreamEvent200ResponseOneOf4Challenge) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiStreamEvent200ResponseOneOf4Challenge) UnmarshalJSON(src []byte) error {
	v.isSet = true
