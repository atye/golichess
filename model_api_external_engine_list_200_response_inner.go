...
// checks if the ApiExternalEngineList200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiExternalEngineList200ResponseInner{}

// ApiExternalEngineList200ResponseInner struct for ApiExternalEngineList200ResponseInner
type ApiExternalEngineList200ResponseInner struct {
...
type _ApiExternalEngineList200ResponseInner ApiExternalEngineList200ResponseInner
...
func NewApiExternalEngineList200ResponseInner(id string, name string, clientSecret string, userId string, maxThreads int32, maxHash int32, variants []string) *ApiExternalEngineList200ResponseInner {
	this := ApiExternalEngineList200ResponseInner{}
	this.Id = id
	this.Name = name
...
func (o *ApiExternalEngineList200ResponseInner) SetProviderDataNil() {
...
func (o ApiExternalEngineList200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o ApiExternalEngineList200ResponseInner) ToMap() (map[string]interface{}, error) {
...
func (o *ApiExternalEngineList200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	varApiExternalEngineList200ResponseInner := _ApiExternalEngineList200ResponseInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiExternalEngineList200ResponseInner)

	if err != nil {
		return err
	}

	*o = ApiExternalEngineList200ResponseInner(varApiExternalEngineList200ResponseInner)

	return err
}

type NullableApiExternalEngineList200ResponseInner struct {
	value *ApiExternalEngineList200ResponseInner
	isSet bool
}

func (v NullableApiExternalEngineList200ResponseInner) Get() *ApiExternalEngineList200ResponseInner {
	return v.value
}

func (v *NullableApiExternalEngineList200ResponseInner) Set(val *ApiExternalEngineList200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiExternalEngineList200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiExternalEngineList200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiExternalEngineList200ResponseInner(val *ApiExternalEngineList200ResponseInner) *NullableApiExternalEngineList200ResponseInner {
	return &NullableApiExternalEngineList200ResponseInner{value: val, isSet: true}
}

func (v NullableApiExternalEngineList200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiExternalEngineList200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
