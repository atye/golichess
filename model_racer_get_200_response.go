...
// checks if the RacerGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RacerGet200Response{}

// RacerGet200Response struct for RacerGet200Response
type RacerGet200Response struct {
	// Unique identifier of the puzzle race
	Id string `json:"id"`
	// Owner of the puzzle race
	Owner string `json:"owner"`
	// List of players participating in the race
	Players []RacerGet200ResponsePlayersInner `json:"players"`
	// List of puzzles in the race
	Puzzles []RacerGet200ResponsePuzzlesInner `json:"puzzles"`
	// Timestamp in milliseconds when the race finishes
	FinishesAt int32 `json:"finishesAt"`
	// Timestamp in milliseconds when the race started
	StartsAt int32 `json:"startsAt"`
}

type _RacerGet200Response RacerGet200Response
...
func (o *RacerGet200Response) GetPlayers() []RacerGet200ResponsePlayersInner {
	if o == nil {
		var ret []RacerGet200ResponsePlayersInner
		return ret
	}
...
func (o *RacerGet200Response) GetPuzzles() []RacerGet200ResponsePuzzlesInner {
	if o == nil {
		var ret []RacerGet200ResponsePuzzlesInner
		return ret
	}
...
func (o RacerGet200Response) MarshalJSON() ([]byte, error) {
...
func (o RacerGet200Response) ToMap() (map[string]interface{}, error) {
...
func (o *RacerGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varRacerGet200Response := _RacerGet200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRacerGet200Response)

	if err != nil {
		return err
	}

	*o = RacerGet200Response(varRacerGet200Response)

	return err
}

type NullableRacerGet200Response struct {
	value *RacerGet200Response
	isSet bool
}

func (v NullableRacerGet200Response) Get() *RacerGet200Response {
	return v.value
}

func (v *NullableRacerGet200Response) Set(val *RacerGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableRacerGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableRacerGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRacerGet200Response(val *RacerGet200Response) *NullableRacerGet200Response {
	return &NullableRacerGet200Response{value: val, isSet: true}
}

func (v NullableRacerGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRacerGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
