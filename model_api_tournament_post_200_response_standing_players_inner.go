...
// checks if the ApiTournamentPost200ResponseStandingPlayersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiTournamentPost200ResponseStandingPlayersInner{}

// ApiTournamentPost200ResponseStandingPlayersInner struct for ApiTournamentPost200ResponseStandingPlayersInner
type ApiTournamentPost200ResponseStandingPlayersInner struct {
	...
	Sheet *ApiTournamentPost200ResponseStandingPlayersInnerSheet `json:"sheet,omitempty"`
}
...
func NewApiTournamentPost200ResponseStandingPlayersInner() *ApiTournamentPost200ResponseStandingPlayersInner {
	this := ApiTournamentPost200ResponseStandingPlayersInner{}
	return &this
}
...
func (o *ApiTournamentPost200ResponseStandingPlayersInner) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *ApiTournamentPost200ResponseStandingPlayersInner) GetSheet() ApiTournamentPost200ResponseStandingPlayersInnerSheet {
	if o == nil || IsNil(o.Sheet) {
		var ret ApiTournamentPost200ResponseStandingPlayersInnerSheet
		return ret
	}
	return *o.Sheet
}
...
// SetSheet gets a reference to the given ApiTournamentPost200ResponseStandingPlayersInnerSheet and assigns it to the Sheet field.
func (o *ApiTournamentPost200ResponseStandingPlayersInner) SetSheet(v ApiTournamentPost200ResponseStandingPlayersInnerSheet) {
	o.Sheet = &v
}

func (o ApiTournamentPost200ResponseStandingPlayersInner) MarshalJSON() ([]byte, error) {
...
func (o ApiTournamentPost200ResponseStandingPlayersInner) ToMap() (map[string]interface{}, error) {
...
type NullableApiTournamentPost200ResponseStandingPlayersInner struct {
	value *ApiTournamentPost200ResponseStandingPlayersInner
	isSet bool
}

func (v NullableApiTournamentPost200ResponseStandingPlayersInner) Get() *ApiTournamentPost200ResponseStandingPlayersInner {
	return v.value
}

func (v *NullableApiTournamentPost200ResponseStandingPlayersInner) Set(val *ApiTournamentPost200ResponseStandingPlayersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiTournamentPost200ResponseStandingPlayersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiTournamentPost200ResponseStandingPlayersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiTournamentPost200ResponseStandingPlayersInner(val *ApiTournamentPost200ResponseStandingPlayersInner) *NullableApiTournamentPost200ResponseStandingPlayersInner {
	return &NullableApiTournamentPost200ResponseStandingPlayersInner{value: val, isSet: true}
}

func (v NullableApiTournamentPost200ResponseStandingPlayersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiTournamentPost200ResponseStandingPlayersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
