...
// NewBroadcastTop_past instantiates a new BroadcastTop_past and sets the default values.
func NewBroadcastTop_past()(*BroadcastTop_past) {
    m := &BroadcastTop_past{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateBroadcastTop_pastFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateBroadcastTop_pastFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewBroadcastTop_past(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *BroadcastTop_past) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCurrentPage gets the currentPage property value. The currentPage property
// returns a *int32 when successful
func (m *BroadcastTop_past) GetCurrentPage()(*int32) {
...
func (m *BroadcastTop_past) GetCurrentPageResults()([]BroadcastWithLastRoundable) {
    return m.currentPageResults
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *BroadcastTop_past) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *int32 when successful
func (m *BroadcastTop_past) GetMaxPerPage()(*int32) {
    return m.maxPerPage
}
// GetNextPage gets the nextPage property value. The nextPage property
// returns a *int32 when successful
func (m *BroadcastTop_past) GetNextPage()(*int32) {
    return m.nextPage
}
// GetPreviousPage gets the previousPage property value. The previousPage property
// returns a *int32 when successful
func (m *BroadcastTop_past) GetPreviousPage()(*int32) {
    return m.previousPage
}
// Serialize serializes information the current object
func (m *BroadcastTop_past) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
