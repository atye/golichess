...
// ItemPmAllRequestBuilder builds and executes requests for operations under \team\{teamId}\pm-all
type ItemPmAllRequestBuilder struct {
	i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}

// ItemPmAllRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type ItemPmAllRequestBuilderPostRequestConfiguration struct {
	// Request headers
...
// NewItemPmAllRequestBuilderInternal instantiates a new ItemPmAllRequestBuilder and sets the default values.
func NewItemPmAllRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *ItemPmAllRequestBuilder {
	m := &ItemPmAllRequestBuilder{
		BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/team/{teamId}/pm-all", pathParameters),
	}
	return m
}

// NewItemPmAllRequestBuilder instantiates a new ItemPmAllRequestBuilder and sets the default values.
func NewItemPmAllRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *ItemPmAllRequestBuilder {
...
func (m *ItemPmAllRequestBuilder) WithUrl(rawUrl string) *ItemPmAllRequestBuilder {
	return NewItemPmAllRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter)
}
