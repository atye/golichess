...
// checks if the TeamShow200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamShow200Response{}

// TeamShow200Response struct for TeamShow200Response
type TeamShow200Response struct {
	Id string `json:"id"`
	Name string `json:"name"`
	Description *string `json:"description,omitempty"`
	// See [available flair list and images](https://github.com/lichess-org/lila/tree/master/public/flair)
	Flair *string `json:"flair,omitempty"`
	Leader *ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId `json:"leader,omitempty"`
	Leaders []ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId `json:"leaders,omitempty"`
...
type _TeamShow200Response TeamShow200Response
...
// SetLeader gets a reference to the given ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId and assigns it to the Leader field.
...
// SetLeaders gets a reference to the given []ApiUserPerf200ResponseStatWorstLossesResultsInnerOpId and assigns it to the Leaders field.
...
func (o TeamShow200Response) MarshalJSON() ([]byte, error) {
...
func (o TeamShow200Response) ToMap() (map[string]interface{}, error) {
...
func (o *TeamShow200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamShow200Response := _TeamShow200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTeamShow200Response)

	if err != nil {
		return err
	}

	*o = TeamShow200Response(varTeamShow200Response)

	return err
}

type NullableTeamShow200Response struct {
	value *TeamShow200Response
	isSet bool
}

func (v NullableTeamShow200Response) Get() *TeamShow200Response {
	return v.value
}

func (v *NullableTeamShow200Response) Set(val *TeamShow200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamShow200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamShow200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamShow200Response(val *TeamShow200Response) *NullableTeamShow200Response {
	return &NullableTeamShow200Response{value: val, isSet: true}
}

func (v NullableTeamShow200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamShow200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
