...
// checks if the ApiUsers200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiUsers200ResponseInner{}

// ApiUsers200ResponseInner struct for ApiUsers200ResponseInner
type ApiUsers200ResponseInner struct {
	Id string `json:"id"`
...
type _ApiUsers200ResponseInner ApiUsers200ResponseInner
...
func (o ApiUsers200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o ApiUsers200ResponseInner) ToMap() (map[string]interface{}, error) {
...
func (o *ApiUsers200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	varApiUsers200ResponseInner := _ApiUsers200ResponseInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiUsers200ResponseInner)

	if err != nil {
		return err
	}

	*o = ApiUsers200ResponseInner(varApiUsers200ResponseInner)

	return err
}

type NullableApiUsers200ResponseInner struct {
	value *ApiUsers200ResponseInner
	isSet bool
}

func (v NullableApiUsers200ResponseInner) Get() *ApiUsers200ResponseInner {
	return v.value
}

func (v *NullableApiUsers200ResponseInner) Set(val *ApiUsers200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiUsers200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiUsers200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiUsers200ResponseInner(val *ApiUsers200ResponseInner) *NullableApiUsers200ResponseInner {
	return &NullableApiUsers200ResponseInner{value: val, isSet: true}
}

func (v NullableApiUsers200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiUsers200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
