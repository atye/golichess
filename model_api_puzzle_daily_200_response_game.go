...
// checks if the ApiPuzzleDaily200ResponseGame type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiPuzzleDaily200ResponseGame{}

// ApiPuzzleDaily200ResponseGame struct for ApiPuzzleDaily200ResponseGame
type ApiPuzzleDaily200ResponseGame struct {
	Clock string `json:"clock"`
	Id string `json:"id"`
	Perf ApiPuzzleDaily200ResponseGamePerf `json:"perf"`
	Pgn string `json:"pgn"`
	Players []ApiPuzzleDaily200ResponseGamePlayersInner `json:"players"`
	Rated bool `json:"rated"`
}

type _ApiPuzzleDaily200ResponseGame ApiPuzzleDaily200ResponseGame
...
func NewApiPuzzleDaily200ResponseGame(clock string, id string, perf ApiPuzzleDaily200ResponseGamePerf, pgn string, players []ApiPuzzleDaily200ResponseGamePlayersInner, rated bool) *ApiPuzzleDaily200ResponseGame {
	this := ApiPuzzleDaily200ResponseGame{}
	this.Clock = clock
	this.Id = id
	this.Perf = perf
	this.Pgn = pgn
...
func (o *ApiPuzzleDaily200ResponseGame) GetPerf() ApiPuzzleDaily200ResponseGamePerf {
	if o == nil {
		var ret ApiPuzzleDaily200ResponseGamePerf
		return ret
	}
...
// GetPgn returns the Pgn field value
...
// GetPgnOk returns a tuple with the Pgn field value
// and a boolean to check if the value has been set.
...
func (o *ApiPuzzleDaily200ResponseGame) GetPlayers() []ApiPuzzleDaily200ResponseGamePlayersInner {
	if o == nil {
		var ret []ApiPuzzleDaily200ResponseGamePlayersInner
		return ret
	}
...
func (o ApiPuzzleDaily200ResponseGame) MarshalJSON() ([]byte, error) {
...
func (o ApiPuzzleDaily200ResponseGame) ToMap() (map[string]interface{}, error) {
...
func (o *ApiPuzzleDaily200ResponseGame) UnmarshalJSON(data []byte) (err error) {
	...
	varApiPuzzleDaily200ResponseGame := _ApiPuzzleDaily200ResponseGame{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varApiPuzzleDaily200ResponseGame)

	if err != nil {
		return err
	}

	*o = ApiPuzzleDaily200ResponseGame(varApiPuzzleDaily200ResponseGame)

	return err
}

type NullableApiPuzzleDaily200ResponseGame struct {
	value *ApiPuzzleDaily200ResponseGame
	isSet bool
}

func (v NullableApiPuzzleDaily200ResponseGame) Get() *ApiPuzzleDaily200ResponseGame {
	return v.value
}

func (v *NullableApiPuzzleDaily200ResponseGame) Set(val *ApiPuzzleDaily200ResponseGame) {
	v.value = val
	v.isSet = true
}

func (v NullableApiPuzzleDaily200ResponseGame) IsSet() bool {
	return v.isSet
}

func (v *NullableApiPuzzleDaily200ResponseGame) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiPuzzleDaily200ResponseGame(val *ApiPuzzleDaily200ResponseGame) *NullableApiPuzzleDaily200ResponseGame {
	return &NullableApiPuzzleDaily200ResponseGame{value: val, isSet: true}
}

func (v NullableApiPuzzleDaily200ResponseGame) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiPuzzleDaily200ResponseGame) UnmarshalJSON(src []byte) error {
	v.isSet = true
